...
namespace DotNetNuke.Tests.DNNSelenium.InstallerTests
{
	class InstallerTests : TestBase
	{
		...
		{
			get { return GetTestData(@"InstallerTests\" + Settings.Default.LayoutInstallerDataFile); }
		}

		private IEnumerable InstallerData
		{
			get { return GetTestData(@"InstallerTests\" + Settings.Default.InstallerDataFile); }
		}

		private IEnumerable InstallerLogData
		{
			get { return GetTestData(@"InstallerTests\" + Settings.Default.InstallerLogFile); }
		}
