...
namespace DotNetNuke.Tests.DNNSelenium.CorePages
{
	class ManageUsersPage : BasePage
	{
		...
		public static string PageTitleLabel = "User Accounts";
		public static string PageHeader = "User Accounts";
		...
		public void OpenUsingControlPanel(string baseUrl)
		{
			GoToUrl(baseUrl);
			Trace.WriteLine(BasePage.TraceLevelPage + "Open '" + PageTitleLabel + "' page:");
			SelectMenuOption(BasePage.ControlPanelUsersOption, BasePage.UsersManageUsersOption);
		}
		...
		public void OpenAddNewUserFrameUsingControlPanel(string baseUrl)
		{
			...
			SelectMenuOption(BasePage.ControlPanelUsersOption, BasePage.AddNewUserOption);
		}
