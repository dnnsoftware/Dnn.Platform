...
{
	class HostSiteManagementPage : BasePage
	{
		...
		public static string PageTitleLabel = "Site Management";
		public static string PageHeader = "Site Management";
		...
		public void OpenUsingButtons(string baseUrl)
		{
			...
			WaitAndClick(By.XPath(HostPage.SiteManagementLink));
		}
		...
		public void OpenUsingControlPanel(string baseUrl)
		{
			GoToUrl(baseUrl);
			Trace.WriteLine(BasePage.TraceLevelPage + "Open Host '" + PageTitleLabel + "' page:");
			SelectSubMenuOption(BasePage.ControlPanelHostOption, BasePage.ControlPanelHostCommonSettings, BasePage.HostSiteManagementOption);
		}
