...
namespace DotNetNuke.Tests.DNNSelenium.CorePages
{
	class BlankPage : BasePage
	{
		...
		public void OpenAddNewPageFrameUsingControlPanel(string baseUrl)
		{
			...
			SelectMenuOption(BasePage.ControlPanelPagesOption, BasePage.PagesAddNewPageOption);
		}
		...
		public void OpenCopyPageFrameUsingControlPanel(string baseUrl)
		{
			...
			SelectMenuOption(BasePage.ControlPanelPagesOption, BasePage.PagesCopyPageOption);
		}

		/*public void OpenPageDetailsTab()
		{
			Trace.WriteLine(BasePage.TraceLevelPage + "Click on 'Page Details' Tab:");
			FindElement(By.XPath(BasePage.SearchButton)).ScrollIntoView().WaitTillVisible();
			Click(By.XPath(PageDetailsFrameTab));
		}*/

		public void OpenCopyPageTab()
		{
			Trace.WriteLine(BasePage.TraceLevelPage + "Click on 'Copy Page' Tab:");
			FindElement(By.XPath(BasePage.SearchButton)).ScrollIntoView().WaitTillVisible();
			Click(By.XPath(CopyPageFrameTab));
		}
		...
		public void DeletePage(string pageName)
		{
			...
			SelectMenuOption(BasePage.ControlPanelEditPageOption, BasePage.DeletePageOption);
