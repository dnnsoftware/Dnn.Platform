...
{
	class HostExtensionsPage : ExtensionsPage
	{
		...
		public void OpenUsingButtons(string baseUrl)
		{
			...
			WaitAndClick(By.XPath(HostPage.ExtensionsLink));
		}
		...
		public void OpenUsingControlPanel(string baseUrl)
		{
			GoToUrl(baseUrl);
			Trace.WriteLine(BasePage.TraceLevelPage + "Open Host '" + PageTitleLabel + "' page:");
			SelectSubMenuOption(BasePage.ControlPanelHostOption, BasePage.ControlPanelHostCommonSettings, BasePage.HostExtensionsOption);
		}
