...
{
	class AdminPageManagementPage : BasePage
	{
		public AdminPageManagementPage(IWebDriver driver) : base(driver) { }

		public static string AdminPageManagementUrl = "/Admin/Pages";

		public static string PageTitleLabel = "Page Management";
		public static string PageHeader = "Page Management";
		...
		public void OpenUsingButtons(string baseUrl)
		{
			...
			WaitAndClick(By.XPath(AdminPage.PageManagementLink));
		}
		...
		public void OpenUsingControlPanel(string baseUrl)
		{
			GoToUrl(baseUrl);
			Trace.WriteLine(BasePage.TraceLevelPage + "Open Admin '" + PageTitleLabel + "' page:");
			SelectSubMenuOption(BasePage.ControlPanelAdminOption, BasePage.ControlPanelAdminCommonSettings, BasePage.AdminPageManagementOption);
		}
		...
		/*public void ClickOnUpdateButton()
		{
			...
			FindElement(By.XPath(UpdatePageButton)).ScrollIntoView().WaitTillVisible().Click();
		}*/
