...
{
	class HostSuperUserAccountsPage : BasePage
	{
		...
		public static string PageTitleLabel = "SuperUser Accounts";
		public static string PageHeader = "SuperUser Accounts";
		...
		public void OpenUsingButtons(string baseUrl)
		{
			...
			WaitAndClick(By.XPath(HostPage.SuperUsersAccountsLink));
		}
		...
		public void OpenUsingControlPanel(string baseUrl)
		{
			GoToUrl(baseUrl);
			Trace.WriteLine(BasePage.TraceLevelPage + "Open Host '" + PageTitleLabel + "' page:");
			SelectSubMenuOption(BasePage.ControlPanelHostOption, BasePage.ControlPanelHostAdvancedSettings, BasePage.HostSuperuserAccountsOption);
		}
