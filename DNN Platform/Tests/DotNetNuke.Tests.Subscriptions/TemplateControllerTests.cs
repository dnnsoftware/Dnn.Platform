...
namespace DotNetNuke.Subscriptions.Tests
{
    ...
    public class TemplateControllerTests
    {
        ...
        private Mock<TemplateControllerImpl> _mockTemplateController;
        ...
        public void SetUp()
        {
            ...
            _mockTemplateController = new Mock<TemplateControllerImpl>(_mockDataService.Object);
        ...
        [Test]
        public void TEmplateControllerImpl_Default_Constructor_Does_Not_Throw()
        {
            Assert.DoesNotThrow(() => new TemplateControllerImpl());
        }
