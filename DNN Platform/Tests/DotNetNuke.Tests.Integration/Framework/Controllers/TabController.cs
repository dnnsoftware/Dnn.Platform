...
namespace DotNetNuke.Tests.Integration.Framework.Controllers
{
    public static class TabController
    {
        ...
        /// <summary>
        /// Creates tab setting to enable link tracking. Cache is not cleared.
        /// </summary>
        public static void EnableLinkTracking(int tabId)
        {
            SaveTabSetting(tabId, "Evoq_TrackLinks", "true");
        }

        /// <summary>
        /// Delets tab setting for link tracking. Cache is not cleared.
        /// </summary>
        public static void DisableLinkTracking(int tabId)
        {
            DeleteTabSetting(tabId, "Evoq_TrackLinks");
        }
