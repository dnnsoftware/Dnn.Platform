...
namespace DotNetNuke.Tests.Integration.Framework
{
    internal class WebApiConnector : IWebApiConnector, IDisposable
    {
        ...
        const string UploadFileRequestPath = "API/internalservices/Action/fileupload/postfile";
        const string ActivityStreamUploadFilePath = "API/DNNCorp/ActivityStream/Action/FileUpload/UploadFile";
