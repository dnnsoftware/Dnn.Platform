...
namespace DNNSelenium.Platform.P1
{
	[TestFixture]
	[Category("P1")]
	public class P1ZModules : Common.Tests.P1.P1ZModules
	{
		...
		[TestCase("Home/P1Modules/Page26", "MemberDirectoryModule", "ContentPane")]
		[TestCase("Home/P1Modules/Page27", "MessageCenterModule", "ContentPane")]
		[TestCase("Home/P1Modules/Page29", "NewslettersModule", "ContentPane")]
		[TestCase("Home/P1Modules/Page30", "PagesModule", "ContentPane")]
		[TestCase("Home/P1Modules/Page31", "ProfessionalPreviewModule", "ContentPane")]
		...
		[TestCase("Home/P1Modules/Page64", "ModuleCreator", "ContentPane")]
		...
		[TestCase("Home/P1ModulesDragDrop/Page1", "AccountLoginModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page2", "AccountRegistrationModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page4", "AdvancedSettingsModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page5", "BannersModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page7", "ConfigurationManagerModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page8", "ConsoleModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page9", "ContentListModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page10", "DashboardModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page11", "DDRMenuModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page12", "DigitalAssetManagementModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page15", "ExtensionsModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page17", "GoogleAnalyticsModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page20", "HtmlModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page21", "JournalModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page22", "LanguagesModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page24", "ListsModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page25", "LogViewerModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page26", "MemberDirectoryModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page27", "MessageCenterModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page29", "NewslettersModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page30", "PagesModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page31", "ProfessionalPreviewModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page33", "RazorHostModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page34", "RecycleBinModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page35", "SearchAdminModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page36", "SearchResultsModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page40", "SiteLogModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page41", "SiteWizardModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page42", "SiteMapModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page43", "SkinsModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page44", "SocialGroupsModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page45", "TaxonomyManagerModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page47", "VendorsModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page48", "ViewProfileModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page64", "ModuleCreator", "ContentPane")]
		...
		[TestCase("Home/P1ModulesDragDrop/Page1", "AccountLoginModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page2", "AccountRegistrationModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page4", "AdvancedSettingsModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page5", "BannersModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page7", "ConfigurationManagerModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page8", "ConsoleModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page9", "ContentListModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page10", "DashboardModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page11", "DDRMenuModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page12", "DigitalAssetManagementModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page15", "ExtensionsModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page17", "GoogleAnalyticsModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page20", "HtmlModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page21", "JournalModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page22", "LanguagesModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page24", "ListsModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page25", "LogViewerModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page26", "MemberDirectoryModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page27", "MessageCenterModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page29", "NewslettersModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page30", "PagesModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page31", "ProfessionalPreviewModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page33", "RazorHostModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page34", "RecycleBinModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page35", "SearchAdminModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page36", "SearchResultsModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page40", "SiteLogModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page41", "SiteWizardModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page42", "SiteMapModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page43", "SkinsModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page44", "SocialGroupsModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page45", "TaxonomyManagerModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page47", "VendorsModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page48", "ViewProfileModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page64", "ModuleCreator", "LeftPane")]
		...
		[TestCase("Home/P1ModulesDragDrop/Page60", "HtmlModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page60", "HtmlModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page60", "HtmlModule", "ContentPaneLower")]
		[TestCase("Home/P1ModulesDragDrop/Page60", "HtmlModule", "SideBarPane")]
		[TestCase("Home/P1ModulesDragDrop/Page60", "HtmlModule", "FooterLeftOuterPane")]
		[TestCase("Home/P1ModulesDragDrop/Page60", "HtmlModule", "FooterLeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page60", "HtmlModule", "FooterCenterPane")]
		[TestCase("Home/P1ModulesDragDrop/Page60", "HtmlModule", "FooterRightPane")]
		[TestCase("Home/P1ModulesDragDrop/Page60", "HtmlModule", "FooterRightOuterPane")]
		...
		[TestCase("Home/P1ModulesDragDrop/Page51", "HtmlModule", "ContentPane")]
		[TestCase("Home/P1ModulesDragDrop/Page52", "HtmlModule", "LeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page53", "HtmlModule", "ContentPaneLower")]
		[TestCase("Home/P1ModulesDragDrop/Page54", "HtmlModule", "SideBarPane")]
		[TestCase("Home/P1ModulesDragDrop/Page55", "HtmlModule", "FooterLeftOuterPane")]
		[TestCase("Home/P1ModulesDragDrop/Page56", "HtmlModule", "FooterLeftPane")]
		[TestCase("Home/P1ModulesDragDrop/Page57", "HtmlModule", "FooterCenterPane")]
		[TestCase("Home/P1ModulesDragDrop/Page58", "HtmlModule", "FooterRightPane")]
		[TestCase("Home/P1ModulesDragDrop/Page59", "HtmlModule", "FooterRightOuterPane")]
		...
		[TestCase("Home/P1Modules/Page62")]
		...
		[TestCase("Home/P1Modules/Page62", "Terrible Cycles, Inc.")]
		...
		[TestCase("Home/P1Modules/Page63")]
		...
		[TestCase("Home/P1Modules/Page63", "Awesome Cycles, Inc.")]
