...
namespace DotNetNuke.Tests.Data {
    ...
    internal class DataResources {
        ...
        /// <summary>  Looks up a localized string similar to Data Source={0};Integrated Security=True.</summary>
        internal static string AdminConnectionString {
            get {
                return ResourceManager.GetString("AdminConnectionString", resourceCulture);
            }
        }
        /// <summary>  Looks up a localized string similar to Data Source={0};Integrated Security=True;Initial Catalog={1}.</summary>
        internal static string ConnectionString {
            get {
                return ResourceManager.GetString("ConnectionString", resourceCulture);
            }
        }
        /// <summary>  Looks up a localized string similar to SELECT {0} FROM {1} WHERE {2} = {3}.</summary>
        internal static string GetFieldValue {
            get {
                return ResourceManager.GetString("GetFieldValue", resourceCulture);
            }
        }
        /// <summary>  Looks up a localized string similar to SELECT MAX({1}) FROM {0}.</summary>
        internal static string GetLastAddedRecordID {
            get {
                return ResourceManager.GetString("GetLastAddedRecordID", resourceCulture);
            }
        }
        /// <summary>  Looks up a localized string similar to SELECT COUNT(*) FROM {0} WHERE {1} = {2}.</summary>
        internal static string GetRecordCountByField {
            get {
                return ResourceManager.GetString("GetRecordCountByField", resourceCulture);
            }
        }
        /// <summary>  Looks up a localized string similar to SELECT * FROM {0} WHERE {1} = {2}.</summary>
        internal static string GetRecordsByField {
            get {
                return ResourceManager.GetString("GetRecordsByField", resourceCulture);
            }
        }
        /// <summary>  Looks up a localized string similar to SELECT * FROM {0}.</summary>
        internal static string GetTable {
            get {
                return ResourceManager.GetString("GetTable", resourceCulture);
            }
        }
        /// <summary>  Looks up a localized string similar to SELECT COUNT(*) FROM {0}.</summary>
