if (!DDR.Menu.Providers.DNNMenu) {
  DDRjQuery(function ($) {
    ...
    DDR.Menu.Providers.DNNMenu.prototype =
      new DDR.Menu.Providers.BaseRenderer();
    ...
    DDR.Menu.Providers.DNNMenu.prototype.createRenderedMenu = function (menu) {
      ...
      if (level == 0) {
        ...
        var result = $(
          "<div><table cellspacing='0' cellpadding='0' border='0' /></div>",
    ...
    DDR.Menu.Providers.DNNMenu.prototype.createRenderedItem = function (item) {
      ...
      if (level == 0) {
        ...
        if (item.isBreadcrumb) {
          ...
          nodeLeftHTML =
            me.dnnNavParams.NodeLeftHTMLBreadCrumbRoot || nodeLeftHTML;
          nodeRightHTML =
            me.dnnNavParams.NodeRightHTMLBreadCrumbRoot || nodeRightHTML;
          separatorLeftHTML =
            me.dnnNavParams.SeparatorLeftHTMLBreadCrumb || separatorLeftHTML;
          separatorRightHTML =
            me.dnnNavParams.SeparatorRightHTMLBreadCrumb || separatorRightHTML;
        }
        ...
        if (item.isSelected) {
          ...
          separatorLeftHTML =
            me.dnnNavParams.SeparatorLeftHTMLActive || separatorLeftHTML;
          separatorRightHTML =
            me.dnnNavParams.SeparatorRightHTMLActive || separatorRightHTML;
        }
        ...
        if (item.childMenu && me.dnnNavParams.IndicateChildren)
          result.css({
            "background-image":
              "url(" +
              me.dnnNavParams.PathSystemImage +
              me.dnnNavParams.IndicateChildImageRoot +
              ")",
        ...
        result = $(
          "<tr><td style='position:relative'><span /></td><td style='position:relative'><span /></td><td style='position:relative'/></tr>",
        );
        ...
        if (item.childMenu && me.dnnNavParams.IndicateChildren)
          tdArrow.append(
            $("<img />").attr(
              "src",
              me.dnnNavParams.PathSystemImage +
                me.dnnNavParams.IndicateChildImageSub,
            ),
          );
        ...
        if (item.isBreadcrumb) {
          ...
          nodeLeftHTML =
            me.dnnNavParams.NodeLeftHTMLBreadCrumbSub || nodeLeftHTML;
          nodeRightHTML =
            me.dnnNavParams.NodeRightHTMLBreadCrumbSub || nodeRightHTML;
        }
        ...
        if (nodeLeftHTML) tdImg.prepend($("<span />").append(nodeLeftHTML));
        if (nodeRightHTML) tdArrow.append($("<span />").append(nodeRightHTML));
      }
    ...
    DDR.Menu.Providers.DNNMenu.prototype.menuItemHover = function (item) {
      ...
      if (item.level == 0) {
        item.rendered.setHoverClass(
          "hov " +
            (me.dnnNavParams.CSSNodeHoverRoot ||
              me.dnnNavParams.CSSNodeHover ||
              ""),
        );
      } else {
        item.rendered.setHoverClass(
          "hov " +
            (me.dnnNavParams.CSSNodeHoverSub ||
              me.dnnNavParams.CSSNodeHover ||
              ""),
        );
      }
