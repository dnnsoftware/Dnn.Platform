if (!window.DDR) window.DDR = {};
if (!DDR.Menu) DDR.Menu = {};
if (!DDR.Menu.Providers) DDR.Menu.Providers = {};

DDRjQuery(function ($) {
  DDR.Menu.Providers.BaseRenderer = function () {};

  DDR.Menu.Providers.BaseRenderer.prototype.baseConstructor = function (
    jqContainer,
    dnnNavParams,
  ) {
    var me = this;
    ...
    me.subMenus = me.menus.filter(function (m) {
      return m.level > 0;
    });
    me.rootItems = me.items.filter(function (i) {
      return i.level == 0;
    });
  ...
  DDR.Menu.Providers.BaseRenderer.prototype.mapToRendered = function (jq) {
    return $(
      $.map(jq.get(), function (elt) {
        return $(elt).ddrData().rendered.get(0);
      }),
    );
  };
  ...
  DDR.Menu.Providers.BaseRenderer.prototype.addCovering = function () {
    ...
    var coveringBase = $(
      "<a style='position:absolute;display:block;border:0;padding:0;margin:0;top:0;left:0;bottom:0;right:0;text-decoration:none'><span style='visibility:hidden'/></a>",
    ).css(
      "background",
      $.browser.msie
        ? "url(" + me.dnnNavParams.PathSystemImage + "spacer.gif)"
        : "transparent",
    );
    var overrideDimensions =
      ($.browser.msie && $.browser.version.startsWith("6.")) ||
      !$.support.boxModel;
      ...
      m.childItems.each(function (i) {
        if (i.coveringHere) {
          ...
          i.coveringHere().each(function () {
            ...
            covering
              .attr("href", i.href || "javascript:void(0)")
              .children("span")
              .text(itemText);
  ...
  DDR.Menu.Providers.BaseRenderer.prototype.prepareHideAndShow = function () {
    ...
    me.hideAllMenus = me.menus.filter(function (m) {
      return m.flyout;
    });
  ...
  DDR.Menu.Providers.BaseRenderer.prototype.setItemsHideAndShow = function () {
    ...
    me.items.each(function (i) {
      ...
      if (childMenu && childMenu.flyout) i.showThese[0] = childMenu;
    });
  };
    ...
    me.menus.each(function (menu) {
      if (!menu.flyout) {
        menu.childItems.each(function (i) {
          ...
          i.rendered.hover(
            function () {
              i.hideThese.allRendered().each(function () {
                this.hideMenu();
              });
              i.showThese.allRendered().each(function () {
                this.showMenu();
              });
            },
            function () {},
  ...
  DDR.Menu.Providers.BaseRenderer.prototype.positionMenu = function (menu) {
    if (menu.childItems && menu.childItems.length > 0) {
      ...
      var parentRendered = menu.layout.match(/,menu$/)
        ? parentMenu.rendered
        : parentItem.rendered;
      var r = menu.rendered;
      ...
      if (parentMenu.layout.match(/^horizontal/)) {
        ...
        r.alignElement(
          function () {
            return menu.childItems[0].rendered.getLeft(2);
          },
          parentRendered.getLeft(2),
          function () {
            return r.getTop(1);
          },
          parentRendered.getBottom(1),
        );
        if (r.getRight(3) > windowRight) {
          r.alignHorizontal(function () {
            return r.getRight(3);
          }, windowRight);
        }
        if (r.getBottom(3) > windowBottom) {
          r.alignVertical(function () {
            return r.getBottom(1);
          }, parentRendered.getTop(1));
        ...
        r.alignElement(
          ...
          parentRendered.getRight(1),
          function () {
            return menu.childItems[0].rendered.getTop(2);
          },
          parentRendered.getTop(2),
        );
        if (r.getBottom(3) > windowBottom) {
          r.alignVertical(function () {
            return r.getBottom(3);
          }, windowBottom);
        }
        if (r.getRight(3) > windowRight) {
          r.alignHorizontal(function () {
            return r.getRight(1);
          }, parentRendered.getLeft(1));
  ...
  DDR.Menu.Providers.BaseRenderer.prototype.closeUp = function () {
    var me = this;
    me.hideAllMenus.allRendered().each(function () {
      this.hideMenu();
    });
  };
  ...
  if (!Array.prototype.each)
    Array.prototype.each = function (fn) {
      for (var n = 0; n < this.length; n++) fn(this[n]);
    };
  ...
  $.fn.extend({
    getLeft: function (index) {
      ...
      if (index == 1) result -= DDR.Menu.getCSS(htmlThis, "marginLeft");
      if (index >= 3) result += DDR.Menu.getCSS(htmlThis, "borderLeftWidth");
      if (index >= 4) result += DDR.Menu.getCSS(htmlThis, "paddingLeft");
      return result;
    },
    getTop: function (index) {
      ...
      if (index == 1) result -= DDR.Menu.getCSS(htmlThis, "marginTop");
      if (index >= 3) result += DDR.Menu.getCSS(htmlThis, "borderTopWidth");
      if (index >= 4) result += DDR.Menu.getCSS(htmlThis, "paddingTop");
      return result;
    },
    getRight: function (index) {
      var result = this.getLeft(4) + this.width();
      var htmlThis = this[0];
      if (index < 4) result += DDR.Menu.getCSS(htmlThis, "paddingRight");
      if (index < 3) result += DDR.Menu.getCSS(htmlThis, "borderRightWidth");
      if (index < 2) result += DDR.Menu.getCSS(htmlThis, "marginRight");
      return result;
    },
    getBottom: function (index) {
      var result = this.getTop(4) + this.height();
      var htmlThis = this[0];
      if (index < 4) result += DDR.Menu.getCSS(htmlThis, "paddingBottom");
      if (index < 3) result += DDR.Menu.getCSS(htmlThis, "borderBottomWidth");
      if (index < 2) result += DDR.Menu.getCSS(htmlThis, "marginBottom");
      return result;
    },
    alignElement: function (
      ...
      return this.each(function () {
        ...
        if (prevDisplay != "block") jqThis.css("display", prevDisplay);
    ...
    setContentWidth: function (width) {
      return this.each(function () {
        ...
        jqThis.width(
          $.support.boxModel
            ? width
            : width + jqThis.fullWidth() - jqThis.width(),
        );
      });
    },
    setContentHeight: function (height) {
      return this.each(function () {
        ...
        jqThis.height(
          $.support.boxModel
            ? height
            : height + jqThis.fullHeight() - jqThis.height(),
        );
      });
    },
    ...
    lineUpHorizontal: function (columns) {
      ...
      return this.each(function () {
        ...
        jqThis.alignElement(
          function () {
            return jqThis.getLeft(1);
          },
          left,
          function () {
            return jqThis.getTop(2);
          },
          top,
        );
    ...
    lineUpVertical: function () {
      ...
      return this.each(function () {
        ...
        jqThis.alignElement(
          function () {
            return jqThis.getLeft(2);
          },
          left,
          function () {
            return jqThis.getTop(1);
          },
          top,
        );
        top += jqThis.fullHeight();
    ...
    fitToContent: function () {
      return this.each(function () {
        ...
        jqThis.sizeElement(
          function () {
            return jqThis.getRight(4);
          },
          maxRight,
          function () {
            return jqThis.getBottom(4);
          },
          maxBottom,
        );
        if (prevDisplay != "block") jqThis.css("display", prevDisplay);
        ...
        if (cssClass) {
          ...
          jqThis.hover(
            function () {
              ...
              if (prevClass) jqAlter.removeClass(prevClass);
            },
            function () {
              jqAlter.each(function () {
                if (this.hoverClass) {
    ...
    ddrData: function () {
      if (!this.data("ddrData")) this.data("ddrData", {});
    ...
    setItemData: function (level, parentMenu) {
      this.each(function () {
        ...
        var id = jqThis.attr("nid");
        var path =
          parentMenu.data("ddrData").path +
          parentMenu.data("ddrData").itemIndex++;
    ...
    toDDRObject: function () {
      if (this.data("ddrObject")) return this.data("ddrObject");
    ...
    toDDRObjectArray: function () {
      return $.map(this, function (elt) {
        return $(elt).toDDRObject();
      });
    },
  });
  ...
  DDR.Menu.addTableCell = function (table, tdContents) {
    ...
    if (tr.length == 0) table.append((tr = $("<tr />")));
...
DDR.Menu.registerMenu = function (clientID, dnnNavParams) {
  ...
  DDRjQuery(function ($) {
    ...
    if (rootMenu.children().length > 0) {
      ...
      new DDR.Menu.Providers[dnnNavParams.MenuStyle](
        jqContainer,
        dnnNavParams,
      ).createRootMenu();
