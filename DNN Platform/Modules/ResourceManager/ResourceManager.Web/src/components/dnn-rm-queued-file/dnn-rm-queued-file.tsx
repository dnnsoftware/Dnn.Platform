...
export class DnnRmQueuedFile {
  ...
  private uploadFile() {
    return new Promise<string>((resolve, reject) => {
      ...
      formData.append(
        "isHostPortal",
        state.settings.IsHostPortal ? "true" : "false",
      );
      ...
      const url =
        this.servicesFramework.getServiceRoot("InternalServices") +
        "FileUpload/UploadFromLocal";
        ...
        <div class="container">
          <div class="preview">
            {this.fileUploadResults && this.fileUploadResults.fileIconUrl && (
              <img
                src={this.fileUploadResults.fileIconUrl}
                alt={this.fileUploadResults.fileName}
              />
            )}
          </div>
          <div class="file">
