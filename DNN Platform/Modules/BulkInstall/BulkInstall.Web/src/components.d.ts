...
declare namespace LocalJSX {
  ...
  interface IntrinsicElements {
    ...
    'dnn-bulk-install': Omit<DnnBulkInstall, keyof DnnBulkInstallAttributes> & { [K in keyof DnnBulkInstall & keyof DnnBulkInstallAttributes]?: DnnBulkInstall[K] } & {
      [K in keyof DnnBulkInstall & keyof DnnBulkInstallAttributes as `attr:${K}`]?: DnnBulkInstallAttributes[K];
    } & { [K in keyof DnnBulkInstall & keyof DnnBulkInstallAttributes as `prop:${K}`]?: DnnBulkInstall[K] } & OneOf<
        'moduleId',
        DnnBulkInstall['moduleId'],
        DnnBulkInstallAttributes['moduleId']
      >;
  }
}
