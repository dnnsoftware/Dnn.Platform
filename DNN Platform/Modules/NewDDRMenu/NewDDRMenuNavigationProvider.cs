...
namespace DotNetNuke.Web.NewDDRMenu
{
    ...
    public class NewDDRMenuNavigationProvider : NavigationProvider
    {
        private readonly ILocaliser localiser;
        private NewDDRMenuControl menuControl;

        /// <summary>Initializes a new instance of the <see cref="NewDDRMenuNavigationProvider"/> class.</summary>
        [Obsolete("Deprecated in DotNetNuke 10.0.0. Please use overload with ILocaliser. Scheduled removal in v12.0.0.")]
        public NewDDRMenuNavigationProvider()
            : this(null)
        {
        }
        ...
        public NewDDRMenuNavigationProvider(ILocaliser localiser)
        {
        ...
        {
            this.menuControl = new NewDDRMenuControl(this.localiser) { ID = this.ControlID, EnableViewState = false };
