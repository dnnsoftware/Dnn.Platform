  ...
  window.Subscription = function Subscription(ko, settings, bindingElement) {
    ...
    this.save = function () {
      ...
      var failure = function (xhr, status) {
        ...
        $.dnnAlert({
          ...
          text: localizer
            .getString("SubscribeFailure")
            .replace("{0}", status || that.getString("UnknownError")),
        });
      ...
      that.requestService(
        "Subscriptions/UpdateSystemSubscription",
        "post",
        params,
        success,
        failure,
    ...
    this["delete"] = function (model) {
      ...
      $("<div class='dnnDialog'></div>")
        .html(localizer.getString("UnsubscribeConfirm"))
        .dialog({
          modal: true,
          autoOpen: true,
          ...
          buttons: [
            {
              ...
              click: function () {
                ...
                that.requestService(
                  "Subscriptions/DeleteContentSubscription",
                  "post",
                  params,
                  success,
                  failure,
