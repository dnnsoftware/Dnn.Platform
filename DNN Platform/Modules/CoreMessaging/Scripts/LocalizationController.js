  ...
  window.LocalizationController = function (settings, root) {
    ...
    this.loadTable = function () {
      ...
      var success = function (m) {
        $.each(m.Table, function (index, entry) {
      ...
      var failure = function (m) {
        console.log(
          "Unable to load string translations: " +
      ...
      $.ajax({
        type: "get",
        url:
          root.servicesFramework.getServiceRoot("CoreMessaging") +
          "Subscriptions/GetLocalizationTable",
