      ...
      $(iframe).on("load", function () {
        ...
        try {
          ...
          if (
            ...
            contentDocument.body.innerHTML == "false"
          ) {
  ...
  jQuery.fn.extend({
    center: function (host) {
      ...
      return this.each(function () {
        ...
        var top =
          ($host.height() - $this.outerHeight(true)) / 2 + $host.scrollTop();
        top = top > 0 ? top : 0;
        var left =
          ($host.width() - $this.outerWidth(true)) / 2 + $host.scrollLeft();
        left = left > 0 ? left : 0;
        $this.css({
          position: "absolute",
          margin: 0,
    ...
    quickHighlight: function (highlightColor) {
      ...
      var removeCssPropertyProxy = this.inlineStyle("backgroundColor")
        ? undefined
        : $.proxy(function () {
