...
(function ($, window, document, undefined) {
  ...
  TreeView.prototype = {
    ...
    _createChildrenNodeElement: function (childrenContext, isRoot) {
      ...
      for (var i = 0, count = childrenContext.length; i < count; i++) {
        ...
        if (childContext) {
          ...
          $childNodeElement.append(
            this._createChildrenNodeElement(childContext.children),
          );
    ...
    showTree: function (nodeContext) {
      ...
      this._$treeElement.slideDown({
        duration: 0,
        complete: this._onRedrawHandler,
      });
    },
    ...
    showChildren: function (nodeContext) {
      ...
      var $childrenNodeElement = this._createChildrenNodeElement(
      ...
      $childrenNodeElement.slideDown({
        duration: this.options.expandSpeed,
        easing: this.options.expandEasing,
        complete: this._onShowChildrenHandler,
      });
      return $childrenNodeElement;
    },
    ...
    removeChildren: function (nodeElement) {
      ...
      $(nodeElement)
        ...
        .slideUp(
          ...
          this.options.collapseEasing,
          function () {
            $(this).remove();
            self._onRedraw(nodeContext);
          },
        );
    },
