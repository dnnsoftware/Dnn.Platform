  ...
  $.fn.dnnModuleDragDrop = function (options) {
    ...
    if (allDnnSortableEmpty) {
      ...
      $self.droppable({
        ...
        over: function (event, ui) {
          $(this).append(
            "<div class='dnnDropTarget'><p>" +
              settings.dropTargetText +
              "(" +
        ...
        drop: function (event, ui) {
          ...
          dropItem.remove();
          if (dnn.controlBar) {
            dnn.controlBar.addModule(
              dnn.controlBar.dragdropModule + "",
    ...
    $self.sortable({
      ...
      helper: function (event, ui) {
        var dragTip = $(
          '<div class="dnnDragdropTip ControlBar_DragdropModule"></div>',
        );
        var title = $("span.Head", ui).html();
        if (!title) title = "The Dragging Module";
      ...
      start: function (event, ui) {
        ...
        $dropTarget.append(
          "<p>" + settings.dropTargetText + "(" + modulePaneName + ")" + "</p>",
        );
