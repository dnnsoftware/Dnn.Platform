  ...
  var methods = {
    ...
    showAllToasts: function (msgOptions) {
      ...
      toastItemClose = $("<div></div>")
        .addClass("toast-item-close")
        .prependTo(toastItemInner)
        .html(localSettings.closeText)
        .click(function () {
          $().dnnToastMessage("removeToast", toastItemInner, localSettings);
        });
