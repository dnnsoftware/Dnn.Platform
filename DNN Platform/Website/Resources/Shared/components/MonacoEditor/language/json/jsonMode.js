      ...
      a = (function () {
        ...
        return (
          (e.prototype.findDocumentSymbols = function (e, t, o) {
            ...
            return (
              S && o && o.onResultLimitExceeded && o.onResultLimitExceeded(l),
              C
            );
          }),
          (e.prototype.findDocumentSymbols2 = function (e, t, o) {
                      ...
                      t.properties.forEach(function (t) {
                        ...
                        if (r)
                          if (u > 0) {
                            ...
                            (n.push(c),
                              S.push({ result: c.children, node: r }));
                          } else k = !0;
                      });
                };
              C < S.length;
            ...
            return (
              k && o && o.onResultLimitExceeded && o.onResultLimitExceeded(l),
              x
            );
          }),
