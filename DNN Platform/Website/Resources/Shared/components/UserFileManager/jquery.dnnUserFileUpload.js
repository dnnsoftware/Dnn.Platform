...
(function ($) {
      ...
      $fileupload
        .fileupload({
          ...
          add: function (e, data) {
            ...
            data.context
              .find($(opts.progressFileNameSelector))
  ...
  $.fn.dnnUserFileUpload.defaultOptions = {
    ...
    serverErrorMessage:
      "Unexpected error. This generally happens when the file is too large.", // error message when server returns a 500, 404 or the like
