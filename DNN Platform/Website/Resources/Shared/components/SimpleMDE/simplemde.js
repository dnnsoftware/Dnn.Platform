...
var toolbarBuiltInButtons = {
  ...
  guide: {
    name: "guide",
    action:
      "http://nextstepwebs.github.io/simplemde-markdown-editor/markdown-guide",
...
SimpleMDE.prototype.autosave = function () {
  ...
  if (
    this.options.autosave.unique_id == undefined ||
    this.options.autosave.unique_id == ""
  ) {
    console.log(
      "SimpleMDE: You must set a unique_id to use the autosave feature",
    );
    return;
  }
  ...
  if (this.options.autosave.loaded !== true) {
    if (
      typeof localStorage.getItem(this.options.autosave.unique_id) ==
        "string" &&
      localStorage.getItem(this.options.autosave.unique_id) != ""
    )
