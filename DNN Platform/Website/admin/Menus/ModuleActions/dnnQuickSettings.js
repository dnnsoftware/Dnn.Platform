(function ($) {
  ...
  $.fn.dnnQuickSettings = function (options) {
    ...
    var throwErrorWhenInvalidPromise = function checkPromiseHandler(
      promise,
      callbackName,
    ) {
      ...
      if (typeof promise.done !== "function") {
        throw (
          "The '" +
          callbackName +
          "' callback should return a promise with a valid 'done' function."
        );
      }
    };
  ...
  $.fn.dnnQuickSettings.quickSettingsDispatcher = (function () {
    ...
    addSubcriber = function addSubcriberHandler(moduleId, eventType, callback) {
      if (!EVENT_TYPES[eventType]) {
        throw (
          "QuickSettingsDispatcher - Subcritions to event type '" +
          eventType +
          "' not supported."
        );
      }
    ...
    notify = function notifyHandler(moduleId, eventType, params) {
      if (!EVENT_TYPES[eventType]) {
        throw (
          "QuickSettingsDispatcher - Notifications to event type '" +
          eventType +
          "' not supported."
        );
      }
