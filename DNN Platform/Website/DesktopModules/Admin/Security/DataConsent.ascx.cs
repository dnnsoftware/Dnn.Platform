        ...
        protected IHtmlString DataConsentHtml
        {
            get
            {
                var termsUrl = this.PortalSettings.TermsTabId == Null.NullInteger
                    ? Globals.NavigateURL(this.TabId, "Terms")
                    : Globals.NavigateURL(this.PortalSettings.TermsTabId);
                var privacyUrl = this.PortalSettings.PrivacyTabId == Null.NullInteger
                    ? Globals.NavigateURL(this.TabId, "Privacy")
                    : Globals.NavigateURL(this.PortalSettings.PrivacyTabId);
