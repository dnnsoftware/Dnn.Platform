...
<div class="dnnForm dnnRegistrationForm" id="RegistrationForm" runat="server">
    <div class="dnnFormItem dnnRegistrationFormItemMessage">
        <div class="dnnFormMessage dnnFormInfo dnnRegistrationFormMessage"><asp:label id="userHelpLabel" runat="server" ViewStateMode="Disabled" /></div>
    </div>
    <br/>
    <div class="dnnFormItem dnnRegistrationFormItemSocial dnnClear">
...
<script type="text/javascript">
    $(function () {
        $('.dnnFormItem .dnnLabel').each(function () {
            var next = $(this).next();
            if (next.hasClass('dnnFormRequired dnnRegistrationFormRequired'))
                $(this).find('span').addClass('dnnFormRequired dnnRegistrationFormRequired');
        });
