...
Sys.WebForms.BeginRequestEventArgs =
  function Sys$WebForms$BeginRequestEventArgs(request, postBackElement) {
...
Sys.WebForms.EndRequestEventArgs = function Sys$WebForms$EndRequestEventArgs(
  error,
  dataItems,
  response,
) {
...
Sys.WebForms.InitializeRequestEventArgs =
  function Sys$WebForms$InitializeRequestEventArgs(request, postBackElement) {
    var e = Function._validateParams(arguments, [
      { name: "request", type: Sys.Net.WebRequest },
      { name: "postBackElement", domElement: true },
    ]);
...
Sys.WebForms.PageLoadedEventArgs = function Sys$WebForms$PageLoadedEventArgs(
  panelsUpdated,
  panelsCreated,
  dataItems,
) {
...
Sys.WebForms.PageLoadingEventArgs = function Sys$WebForms$PageLoadingEventArgs(
  panelsUpdating,
  panelsDeleting,
  dataItems,
) {
...
function Sys$WebForms$PageRequestManager$_createPageRequestManagerParserError(
  parserErrorMessage,
) {
  var displayMessage =
...
function Sys$WebForms$PageRequestManager$_createPostBackSettings(
  async,
  panelID,
  sourceElement,
) {
...
function Sys$WebForms$PageRequestManager$_convertToClientIDs(
  source,
  destinationIDs,
...
function Sys$WebForms$PageRequestManager$_doPostBack(
  eventTarget,
  eventArgument,
) {
  this._additionalInput = null;
    ...
    if (!postBackElement) {
      if (Array.contains(this._asyncPostBackControlIDs, eventTarget)) {
        this._postBackSettings = this._createPostBackSettings(
          true,
          this._scriptManagerID + "|" + eventTarget,
          null,
        );
      } else {
...
function Sys$WebForms$PageRequestManager$_getPageLoadingEventArgs() {
  ...
  for (var i = 0; i < oldIDs.length; i++) {
    if (
      Array.indexOf(refreshedIDs, oldIDs[i]) === -1 &&
      (Array.indexOf(newIDs, oldIDs[i]) === -1 ||
...
function Sys$WebForms$PageRequestManager$_getPostBackSettings(
  element,
  elementUniqueID,
) {
...
function Sys$WebForms$PageRequestManager$_initializeInternal(
  scriptManagerID,
  formElement,
) {
...
function Sys$WebForms$PageRequestManager$_onFormSubmit(evt) {
  ...
  formBody.append(
    this._scriptManagerID + "=" + this._postBackSettings.panelID + "&",
  );
  ...
  if (handler) {
    var eventArgs = new Sys.WebForms.BeginRequestEventArgs(
      request,
      this._postBackSettings.sourceElement,
    );
    handler(this, eventArgs);
...
function Sys$WebForms$PageRequestManager$_onFormSubmitCompleted(
  sender,
  eventArgs,
) {
  ...
  if (
    ...
    this._childUpdatePanelIDs = childUpdatePanelIDsString.length
  ...
  for (i = 0; i < updatePanelNodes.length; i++) {
    ...
    if (!updatePanelElement) {
      this._endPostBack(
        Error.invalidOperation(
          String.format(Sys.WebForms.Res.PRM_MissingPanel, deltaPanelID),
        ),
        sender,
      );
      return;
...
function Sys$WebForms$PageRequestManager$_registerDisposeScript(
  panelID,
  disposeScript,
) {
...
function Sys$WebForms$PageRequestManager$_updateControls(
  updatePanelIDs,
...
function Sys$WebForms$PageRequestManager$_updatePanel(
  updatePanelElement,
  rendering,
) {
...
Sys.WebForms.PageRequestManager.getInstance =
  function Sys$WebForms$PageRequestManager$getInstance() {
    if (arguments.length !== 0) throw Error.parameterCount();
    return Sys.WebForms.PageRequestManager._instance || null;
  };
Sys.WebForms.PageRequestManager._addArrayElement =
  function Sys$WebForms$PageRequestManager$_addArrayElement(
    arrayName,
    arrayValue,
  ) {
...
Sys.WebForms.PageRequestManager._initialize =
  function Sys$WebForms$PageRequestManager$_initialize(
    scriptManagerID,
    formElement,
  ) {
    ...
    Sys.WebForms.PageRequestManager._instance =
