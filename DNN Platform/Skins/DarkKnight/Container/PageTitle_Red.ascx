...
<div class="c_DNN6 c_DNN6_Header">
    <h1 class="Title Red"><div class="dnnIcon"><dnn:ICON runat="server" /></div><dnn:TITLE runat="server" id="dnnTITLE" /><img src="<%=ContainerPath%>Images/Title-BG-Red.png" class="TitleBar" alt="" /></h1>
