function buttonUp() {
  ...
  ((e = $.trim(e).length),
    ...
    $(".search .searchInputContainer a.dnnSearchBoxClearText").click(
      function () {
        $(".search .searchInputContainer a.dnnSearchBoxClearText").hasClass(
          "dnnShow",
        )
...
$(document).ready(function () {
  ($(".navbar-nav.sm-collapsible .caret").click(function (e) {
    ...
    $('<span class="search-toggle-icon"></span>').insertAfter(
