      ...
      prototype: {
        ...
        itemClick: function (i) {
          ...
          if (this.handleItemEvents(e)) {
            if (this.$root.triggerHandler("click.smapi", e[0]) === !1)
              return !1;
            e.dataSM("href") &&
              e.attr("href", e.dataSM("href")).removeDataSM("href");
            var s = t(i.target).is("span.sub-arrow"),
              o = e.dataSM("sub");
            if (o && !o.is(":visible")) {
              if ((this.itemActivate(e), o.is(":visible")))
        ...
        menuPosition: function (i) {
          ...
          if (
            (T
              ? ((e = I ? f - l - $ : $),
                (a = this.opts.bottomToTopSubMenus ? -c - x : v + x))
              : ((e = I ? $ - l : f - $),
                (a = this.opts.bottomToTopSubMenus ? v - x - c : x)),
        ...
        menuScroll: function (t, i, e) {
          ...
          if (!i && o.velocity) {
            if (((o.velocity *= 0.9), (s = o.velocity), 0.5 > s))
          ...
          if (
            ...
            n &&
              ((o.up && l > o.downEnd) || (!o.up && l < o.upEnd)) &&
              a.eq(o.up ? 1 : 0).show(),
            l == h)
          )
        ...
        menuScrollOver: function (t, i) {
          if (
            n &&
            !/^scroll-(up|down)/.test(i.target.className) &&
          ...
          if (((s = s.originalEvent), e(s))) {
            ...
            if (this.getClosestMenu(o.target) == i[0]) {
              ...
              if (/(start|down)$/i.test(s.type))
                ...
                void 0 !== a.touchY &&
                  (s.timeStamp - a.touchTimestamp < 120 &&
                    a.velocity > 0 &&
                    ((a.velocity *= 0.5),
                    this.menuScrollStop(i),
                    this.menuScroll(i),
