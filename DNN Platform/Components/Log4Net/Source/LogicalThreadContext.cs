...
namespace log4net
{
    ...
    public sealed class LogicalThreadContext
    {
        ...
        {
            LogicalThreadContext.s_properties = new LogicalThreadContextProperties();
            LogicalThreadContext.s_stacks = new ThreadContextStacks(LogicalThreadContext.s_properties);
        }
