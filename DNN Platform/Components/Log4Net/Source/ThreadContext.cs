...
namespace log4net
{
    ...
    public sealed class ThreadContext
	{
        ...
        /// </summary>
        private readonly static ThreadContextStacks s_stacks;
		...
		{
			ThreadContext.s_properties = new ThreadContextProperties();
			ThreadContext.s_stacks = new ThreadContextStacks(ThreadContext.s_properties);
		}
