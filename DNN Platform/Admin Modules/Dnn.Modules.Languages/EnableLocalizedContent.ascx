<%@ Control Language="C#" AutoEventWireup="false" Inherits="Dnn.Modules.Languages.EnableLocalizedContent" Explicit="True" Codebehind="EnableLocalizedContent.ascx.cs" %>
