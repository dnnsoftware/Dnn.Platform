...
/// <summary>Logs events to a local syslog service.</summary>
/// <remarks>
/// <note>
...
public class LocalSyslogAppender : AppenderSkeleton 
{
    ...
    /// <summary>Initializes a new instance of the <see cref="LocalSyslogAppender" /> class.</summary>
    /// <remarks>
    ...
    /// <summary>Close the syslog when the appender is closed</summary>
    /// <remarks>
    /// <para>
    ...
    /// <summary>This appender requires a <see cref="AppenderSkeleton.Layout"/> to be set.</summary>
    ...
    /// <summary>Open connection to system logger.</summary>
    [DllImport("libc")]
    private static extern void openlog(IntPtr ident, int option, SyslogFacility facility);

    /// <summary>Generate a log message.</summary>
    /// <remarks>
    /// <para>
    ...
    /// <summary>Close descriptor used to write to system logger.</summary>
    [DllImport("libc")]
