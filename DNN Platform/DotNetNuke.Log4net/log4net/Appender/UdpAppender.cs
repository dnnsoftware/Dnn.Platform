...
public class UdpAppender : AppenderSkeleton
{
    ...
    public int RemotePort
    {
        ...
        set 
        {
            ...
            {
                throw Util.SystemInfo.CreateArgumentOutOfRangeException("value", (object)value,
    ...
    public override void ActivateOptions()
    {
        ...
        {
            throw Util.SystemInfo.CreateArgumentOutOfRangeException("this.RemotePort", (object)this.RemotePort,
        ...
        {
            throw Util.SystemInfo.CreateArgumentOutOfRangeException("this.LocalPort", (object)this.LocalPort,
