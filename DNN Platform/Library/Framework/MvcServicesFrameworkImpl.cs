namespace DotNetNuke.Web.MvcPipeline.Integration.Framework
{
  ...
  using DotNetNuke.Web.MvcPipeline.Integration.Web.Client.ClientResourceManagement;

  internal class MvcServicesFrameworkImpl : IServicesFramework, IMvcServiceFrameworkInternals
  {
