...
namespace DotNetNuke.Entities.Modules.Actions
{
    ...
    /// <summary>Represents a collection of <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> objects.</summary>
    ...
    public class ModuleActionCollection : CollectionBase
    {
        ...
        /// Initializes a new, empty instance of the <see cref="DotNetNuke.Entities.Modules.Actions.ModuleActionCollection" /> class.
        /// </summary>
        /// <remarks>The default constructor creates an empty collection of <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" />
        ///  objects.</remarks>
        ...
        /// </summary>
        /// <param name="value">A <see cref="DotNetNuke.Entities.Modules.Actions.ModuleActionCollection" /> with which to initialize the collection.</param>
        /// <remarks>This overloaded constructor copies the <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" />s
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleActionCollection"/>
        ///  class containing the specified array of <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> objects.
        /// </summary>
        /// <param name="value">An array of <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> objects
        ...
        /// <summary>
        /// Gets or sets the <see cref="DotNetNuke.Entities.Modules.Actions.ModuleActionCollection" /> at the
        /// specified index in the collection.
        /// <para>
        /// In VB.Net, this property is the indexer for the <see cref="DotNetNuke.Entities.Modules.Actions.ModuleActionCollection" /> class.
        /// </para>
        /// </summary>
        /// <param name="index">The index of the collection to access.</param>
        /// <value>A <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> at each valid index.</value>
        ...
        /// <summary>Add an element of the specified <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> to the end of the collection.</summary>
        /// <param name="value">An object of type <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> to add to the collection.</param>
        /// <returns>The index of the newly added <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" />.</returns>
        ...
        /// clicked.</param>
        /// <returns>The index of the newly added <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" />.</returns>
        /// <remarks>This method creates a new <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> with the specified
        ...
        /// <param name="url">The destination URL to redirect the client browser when this
        /// action is clicked.</param>
        /// <param name="clientScript">Client side script to be run when this action is
        /// clicked.</param>
        /// <param name="useActionEvent">Determines whether client will receive an event
        /// notification.</param>
        /// <param name="secure">The security access level required for access to this action.</param>
        ...
        /// <summary>
        /// Copies the elements of the specified <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" />
        ///  array to the end of the collection.
        /// </summary>
        /// <param name="value">An array of type <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" />
        ...
        /// <summary>
        /// Adds the contents of another <see cref="DotNetNuke.Entities.Modules.Actions.ModuleActionCollection" />
        ///  to the end of the collection.
        /// </summary>
        /// <param name="value">A <see cref="DotNetNuke.Entities.Modules.Actions.ModuleActionCollection" /> containing
        ...
        /// <summary>Gets a value indicating whether the collection contains the specified <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" />.</summary>
        /// <param name="value">The <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> to search for in the collection.</param>
        ...
        /// <summary>
        /// Gets the index in the collection of the specified <see cref="DotNetNuke.Entities.Modules.Actions.ModuleActionCollection" />,
        /// if it exists in the collection.
        /// </summary>
        /// <param name="value">The <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> to locate in the collection.</param>
        /// <returns>The index in the collection of the specified object, if found; otherwise, -1.</returns>
        /// <example> This example tests for the presence of a ModuleAction in the
        /// collection, and retrieves its index if it is found.
        /// <code>
        ///   Dim testModuleAction = New ModuleAction(5, "Edit Action", "Edit")
        ///   Dim itemIndex As Integer = -1
        ...
        /// <summary>
        /// Add an element of the specified <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> to the
        ...
        /// <summary>Remove the specified object of type <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> from the collection.</summary>
        /// <param name="value">An object of type <see cref="DotNetNuke.Entities.Modules.Actions.ModuleAction" /> to remove from the collection.</param>
        /// <example>
        /// <code>
