...
namespace DotNetNuke.Entities.Tabs.TabVersions
{
    ...
    public interface ITabVersionBuilder
    {
        ...
        /// <param name="portalid">Portal ID of the tab.</param>
        /// <param name="tabId">Tab ID whose version will be added.</param>
        /// <param name="createdByUserId">User ID which creates the version.</param>
        /// <returns>TabVersion filled with the new version data.</returns>
        ...
        /// <summary>Get the current published version of the page.</summary>
        ...
        /// <summary>Set up a first version for existing tab with modules. This method is used to create version 1 for pages created when versioning was not enabled.</summary>
