...
public class Host : BaseEntityInfo
{
    ...
    public static bool AllowRichTextModuleTitle => HostController.Instance.GetBoolean("AllowRichTextModuleTitle", false);
    ...
    public static bool AllowOverrideThemeViaQueryString => HostController.Instance.GetBoolean("AllowOverrideThemeViaQueryString", false);
