...
namespace DotNetNuke.Entities.Portals
{
    ...
    public class PortalSettingsController : IPortalSettingsController
    {
        ...
        public virtual void LoadPortalSettings(PortalSettings portalSettings)
        {
            ...
            portalSettings.CspHeader = settings.GetValueOrDefault("CspHeader", "default-src 'self'; script-src 'self';  style-src 'self' 'unsafe-inline'; img-src 'self'; font-src 'self'; object-src 'none'; base-uri 'none'; form-action 'self'; frame-ancestors 'none'; frame-src 'self'; connect-src 'self';");
