...
namespace DotNetNuke.Entities.Modules.Settings
{
    ...
    public partial class SerializationController
    {
        ...
        [Obsolete("Deprecated in 9.8.0. Use Dependency Injection to resolve 'DotNetNuke.Abstractions.ISerializaitonManager' instead. Scheduled for removal in v11.0.0.")]
