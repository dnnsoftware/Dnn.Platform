...
public interface ILocalizationProvider
{
    ...
    /// <param name="addFile">if set to <see langword="true"/> a new file will be created if it is not found.</param>
    /// <param name="addKey">if set to <see langword="true"/> a new key will be created if not found.</param>
