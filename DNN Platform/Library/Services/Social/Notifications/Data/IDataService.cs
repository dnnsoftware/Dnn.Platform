...
namespace DotNetNuke.Services.Social.Notifications.Data
{
    ...
    public interface IDataService
    {
        ...
        /// <param name="notificationTypeActionId">ID of the Notification Type Action to delete.</param>
        ...
        /// <param name="portalId">Portal ID of the user.</param>
        /// <param name="afterNotificationId">ID of the Notification after which get the list of Notifications.</param>
        ...
        /// <summary>Gets a Notification.</summary>
        /// <param name="notificationTypeId">ID of the Notification type of the Notification.</param>
