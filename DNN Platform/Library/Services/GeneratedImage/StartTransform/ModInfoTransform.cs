...
{
    /// <summary>
    /// Module Info ImageTransform class
    /// </summary>
	public class ModInfoTransform : ImageTransform
	{
        ...
        /// </summary>
        public override string UniqueString => base.UniqueString + TabID + "-" + ModuleID;
        ...
        /// <summary>
        /// Processes an input image returing a module info image
        /// </summary>
        ...
        public override Image ProcessImage(Image image)
		{
            ...
            var hc = new HostController();
		    var hostSettings = hc.GetSettingsDictionary();
            Thread.CurrentThread.CurrentCulture = CultureInfo.CreateSpecificCulture(portalSettings.CultureCode);
            
            var mc = new ModuleController();
		    var mi = mc.GetModule(ModuleID, TabID, true);
			...
			using (var objGraphics = Graphics.FromImage(bitmap))
			{
				...
				// Module name
                var rectangle = new Rectangle(x, y, 150, 13);
                ...
                objGraphics.DrawString("ID:"+ ModuleID, medfontbold, new SolidBrush(Color.DarkGreen), rectangle, rightFormat);
