...
namespace DotNetNuke.Services.FileSystem
{
    ...
    public abstract partial class FolderProvider
    {
        ...
        public virtual bool SupportsMappedPaths => false;
        ...
        /// </summary>
        public virtual bool SupportsMoveFile => false;
        ...
        /// </summary>
        public virtual bool SupportsMoveFolder => false;

        /// <summary>Encrypts the setting value.</summary>
        /// <param name="cryptographyProvider">The cryptography provider.</param>
        /// <param name="hostSettings">The host settings.</param>
        /// <param name="settingValue">The setting value.</param>
        /// <returns>The encrypted value, the name of the algorithm used to encrypt it, and the IV generated by that algorithm (or <see langword="null"/> if the algorithm doesn't use an IV).</returns>
        public static (string EncryptedMessage, string Algorithm, string InitializationVector) EncryptValue(ICryptographyProvider cryptographyProvider, IHostSettings hostSettings, string settingValue)
        {
            Requires.NotNull(nameof(cryptographyProvider), cryptographyProvider);
            Requires.NotNull(nameof(hostSettings), hostSettings);
            return cryptographyProvider.EncryptString(settingValue.Trim(), hostSettings.Guid);
        }

        /// <summary>Gets the decrypted value of an encrypted folder mapping setting.</summary>
        /// <remarks>If the value is not set the method returns <see langword="null"/>.</remarks>
        /// <param name="cryptographyProvider">The cryptography provider.</param>
        /// <param name="hostSettings">The host settings.</param>
        /// <param name="folderMappingSettings">Folder mapping settings.</param>
        /// <param name="settingName">Setting name.</param>
        /// <exception cref="ArgumentNullException">the input parameters of the method cannot be <see langword="null"/>.</exception>
        /// <returns>decrypted value.</returns>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", Justification = "Breaking change")]
        public static string GetEncryptedSetting(ICryptographyProvider cryptographyProvider, IHostSettings hostSettings, Hashtable folderMappingSettings, string settingName)
        {
            Requires.NotNull(nameof(cryptographyProvider), cryptographyProvider);
            Requires.NotNull(nameof(hostSettings), hostSettings);
            ...
            var encryptedValue = folderMappingSettings[settingName]?.ToString();
            var algorithmNameKey = GetAlgorithmSettingKey(settingName);
            var initializationVectorKey = GetInitializationVectorSettingKey(settingName);
            if (folderMappingSettings.ContainsKey(algorithmNameKey))
            {
                return cryptographyProvider.DecryptString(
                    encryptedValue,
                    hostSettings.Guid,
                    folderMappingSettings[algorithmNameKey] as string,
                    folderMappingSettings[initializationVectorKey] as string);
            }

#pragma warning disable CS0618 // Type or member is obsolete
            return PortalSecurity.Instance.Decrypt(hostSettings.Guid, encryptedValue);
#pragma warning restore CS0618 // Type or member is obsolete
        }

        /// <summary>Gets the name of a setting to store the name of the encryption algorithm used to encrypt the setting with the given name.</summary>
        /// <param name="settingName">The name of the encrypted setting.</param>
        ...
        public partial string GetEncryptedSetting(Hashtable folderMappingSettings, string settingName)
        {
            Requires.NotNull(nameof(folderMappingSettings), folderMappingSettings);
            Requires.NotNullOrEmpty(nameof(settingName), settingName);
        ...
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", Justification = "Breaking change")]
        [DnnDeprecated(10, 2, 2, "Use static overload taking ICryptographyProvider")]
        public partial string EncryptValue(string settingValue)
        {
