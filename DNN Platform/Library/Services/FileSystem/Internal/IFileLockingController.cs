...
namespace DotNetNuke.Services.FileSystem.Internal
{
    public interface IFileLockingController
    {
        ...
        /// <returns><see langword="true"/> if the file is locked, <see langword="false"/> in otherwise.</returns>
        ...
        /// <returns><see langword="true"/> if the file is out of publish period, <see langword="false"/> in otherwise. In any case, <see langword="true"/> for admin or host users.</returns>
