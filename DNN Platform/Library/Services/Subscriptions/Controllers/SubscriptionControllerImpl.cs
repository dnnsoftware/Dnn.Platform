...
namespace DotNetNuke.Services.Subscriptions.Controllers
{
    public class SubscriptionControllerImpl : ISubscriptionController
    {
        ...
        public SubscriptionControllerImpl(IDataService dataService)
        {
        ...
        public bool IsSubscribed(UserInfo userInfo, SubscriptionType subscriptionType, ContentItem contentItem, string objectKey)
        {
            var subscriber = IsSubscribedToContentActivity(userInfo, contentItem, subscriptionType.SubscriptionTypeId, objectKey, Null.NullInteger);
