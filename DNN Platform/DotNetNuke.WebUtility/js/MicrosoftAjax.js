...
Function._validateParameterCount = function Function$_validateParameterCount(
  params,
  expectedParams,
) {
...
Function._validateParameter = function Function$_validateParameter(
  param,
  expectedParam,
  paramName,
) {
...
Error.argumentOutOfRange = function Error$argumentOutOfRange(
  paramName,
  actualValue,
  message,
) {
...
Error.argumentType = function Error$argumentType(
  paramName,
  actualType,
  expectedType,
  message,
...
Type.prototype.callBaseMethod = function Type$callBaseMethod(
  instance,
  name,
  baseArguments,
) {
...
Type.prototype.implementsInterface = function Type$implementsInterface(
  interfaceType,
) {
...
Type.prototype.initializeBase = function Type$initializeBase(
  instance,
  baseArguments,
) {
  /// <param name="instance"></param>
...
Date._appendPreOrPostMatch = function Date$_appendPreOrPostMatch(
  preMatch,
  strBuilder,
) {
  var quoteCount = 0;
...
Date.prototype._toFormattedString = function Date$_toFormattedString(
  format,
  cultureInfo,
) {
...
Number._parse = function Number$_parse(value, cultureInfo) {
  ...
  var numberFormatRegex = new RegExp(
    "^[+-]?[\\d\\" +
      grpSeparator +
      "]*\\" +
      decSeparator +
...
Number.prototype._toFormattedString = function Number$_toFormattedString(
  format,
  cultureInfo,
) {
  if (!format || format.length === 0 || format === "i") {
...
String._toFormattedString = function String$_toFormattedString(
  useLocale,
  args,
) {
  var result = "";
  ...
  for (var i = 0; ; ) {
    ...
    var argNumber =
      parseInt(colonIndex < 0 ? brace : brace.substring(0, colonIndex)) + 1;
    if (isNaN(argNumber))
...
Sys.PropertyChangedEventArgs = function Sys$PropertyChangedEventArgs(
  propertyName,
) {
...
var $addHandler = (Sys.UI.DomEvent.addHandler =
  function Sys$UI$DomEvent$addHandler(element, eventName, handler) {
...
var $addHandlers = (Sys.UI.DomEvent.addHandlers =
  function Sys$UI$DomEvent$addHandlers(element, events, handlerOwner) {
    /// <param name="element" domElement="true"></param>
...
var $clearHandlers = (Sys.UI.DomEvent.clearHandlers =
  function Sys$UI$DomEvent$clearHandlers(element) {
    /// <param name="element" domElement="true"></param>
    var e = Function._validateParams(arguments, [
      { name: "element", domElement: true },
    ]);
...
var $removeHandler = (Sys.UI.DomEvent.removeHandler =
  function Sys$UI$DomEvent$removeHandler(element, eventName, handler) {
    /// <param name="element" domElement="true"></param>
    /// <param name="eventName" type="String"></param>
    /// <param name="handler" type="Function"></param>
    var e = Function._validateParams(arguments, [
...
Sys._ScriptLoader.isScriptLoaded = function Sys$_ScriptLoader$isScriptLoaded(
  scriptSrc,
) {
  var scriptElement = document.createElement("script");
...
Sys._ScriptLoader.readLoadedScripts =
  function Sys$_ScriptLoader$readLoadedScripts() {
...
Sys._ScriptLoader._clearScript = function Sys$_ScriptLoader$_clearScript(
  scriptElement,
) {
...
Sys._ScriptLoader._getLoadedScripts =
  function Sys$_ScriptLoader$_getLoadedScripts() {
    if (!Sys._ScriptLoader._referencedScripts) {
...
Sys._ScriptLoaderTask = function Sys$_ScriptLoaderTask(
  scriptElement,
  completedCallback,
) {
...
Sys.ApplicationLoadEventArgs = function Sys$ApplicationLoadEventArgs(
  components,
  isPartialLoad,
) {
...
Sys.Net.NetworkRequestEventArgs = function Sys$Net$NetworkRequestEventArgs(
  webRequest,
) {
  /// <param name="webRequest" type="Sys.Net.WebRequest"></param>
  var e = Function._validateParams(arguments, [
...
Sys.Net.WebRequest._resolveUrl = function Sys$Net$WebRequest$_resolveUrl(
  url,
  baseUrl,
) {
...
Sys.Net.WebRequest._createQueryString =
  function Sys$Net$WebRequest$_createQueryString(queryString, encodeMethod) {
    if (!encodeMethod) encodeMethod = encodeURIComponent;
...
Sys.Net.WebRequest._createUrl = function Sys$Net$WebRequest$_createUrl(
  url,
  queryString,
) {
  if (!queryString) {
...
Sys.Net.WebServiceProxy.invoke = function Sys$Net$WebServiceProxy$invoke(
  ...
  request.set_url(
    Sys.Net.WebRequest._createUrl(servicePath + "/" + methodName, urlParams),
  );
...
Sys.Net.WebServiceProxy._generateTypedConstructor =
  function Sys$Net$WebServiceProxy$_generateTypedConstructor(type) {
...
Sys.Net.WebServiceError = function Sys$Net$WebServiceError(
  timedOut,
  message,
  stackTrace,
  exceptionType,
...
Sys.Services._AuthenticationService =
  function Sys$Services$_AuthenticationService() {
    if (arguments.length !== 0) throw Error.parameterCount();
...
Sys.Serialization.JavaScriptSerializer =
  function Sys$Serialization$JavaScriptSerializer() {
    if (arguments.length !== 0) throw Error.parameterCount();
  };
...
Sys.Serialization.JavaScriptSerializer._serializeWithBuilder =
  function Sys$Serialization$JavaScriptSerializer$_serializeWithBuilder(
    object,
    stringBuilder,
    sort,
  ) {
...
Sys.UI.DomElement.addCssClass = function Sys$UI$DomElement$addCssClass(
  element,
  className,
) {
  /// <param name="element" domElement="true"></param>
...
Sys.UI.DomElement.containsCssClass =
  function Sys$UI$DomElement$containsCssClass(element, className) {
    /// <param name="element" domElement="true"></param>
    /// <param name="className" type="String"></param>
    /// <returns type="Boolean"></returns>
    var e = Function._validateParams(arguments, [
...
var $get = (Sys.UI.DomElement.getElementById =
...
switch (Sys.Browser.agent) {
  case Sys.Browser.InternetExplorer:
    Sys.UI.DomElement.getLocation = function Sys$UI$DomElement$getLocation(
      element,
    ) {
      /// <param name="element" domElement="true"></param>
  ...
  case Sys.Browser.Opera:
    Sys.UI.DomElement.getLocation = function Sys$UI$DomElement$getLocation(
      ...
      for (
        ...
        elementPositioned =
          elementPositioned || (parentPosition && parentPosition !== "static");
      }
...
Sys.UI.DomElement.removeCssClass = function Sys$UI$DomElement$removeCssClass(
  element,
  className,
) {
  /// <param name="element" domElement="true"></param>
...
Sys.UI.DomElement.setLocation = function Sys$UI$DomElement$setLocation(
  element,
  x,
  y,
) {
...
Sys.UI.DomElement.toggleCssClass = function Sys$UI$DomElement$toggleCssClass(
  element,
  className,
) {
  /// <param name="element" domElement="true"></param>
...
Sys.UI.DomElement._getCurrentStyle =
  function Sys$UI$DomElement$_getCurrentStyle(element) {
    var w = (
      element.ownerDocument ? element.ownerDocument : element.documentElement
    ).defaultView;
    return w && element !== w && w.getComputedStyle
...
Sys.UI.Behavior.getBehaviorByName = function Sys$UI$Behavior$getBehaviorByName(
  element,
  name,
) {
  /// <param name="element" domElement="true"></param>
...
Sys.Res = {
  ...
  cantSetIdAfterInit:
    "The id property can\u0027t be set on this object after initialization.",
  ...
  behaviorDuplicateName:
    "A behavior with name \u0027{0}\u0027 already exists or it is the name of an existing property on the target element.",
  ...
  enumReservedName:
    "\u0027{0}\u0027 is a reserved name that can\u0027t be used as an enum value name.",
  ...
  cantSetNameAfterInit:
    "The name property can\u0027t be set on this object after initialization.",
  appDuplicateComponent:
    "Two components with the same id \u0027{0}\u0027 can\u0027t be added to the application.",
  appComponentMustBeInitialized:
    "Components must be initialized before they are added to the Application object.",
  baseNotAClass: "Value is not a class.",
  methodNotFound: "No method found with name \u0027{0}\u0027.",
  arrayParseBadFormat:
    "Value must be a valid string representation for an array. It must start with a \u0027[\u0027 and end with a \u0027]\u0027.",
  cantSetId: "The id property can\u0027t be set on this object.",
  stringFormatBraceMismatch:
    "The format string contains an unmatched opening or closing brace.",
  enumValueNotInteger:
    "An enumeration definition can only contain integer values.",
  propertyNullOrUndefined:
    "Cannot set the properties of \u0027{0}\u0027 because it returned a null value.",
  componentCantSetIdTwice:
    "The id property of a component can\u0027t be set more than once.",
  createComponentOnDom:
    "Value must be null for Components that are not Controls or Behaviors.",
