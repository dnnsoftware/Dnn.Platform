((function (n) {
    ...
    var r = /[^\w\-\.:]/.test(n)
      ? new Function(
          ...
          "var _e=tmpl.encode" +
            t.helper +
            ",_s='" +
            n.replace(t.regexp, t.func) +
            "';return _s;",
        )
      : (t.cache[n] = t.cache[n] || t(t.load(n)));
    return i
      ? r(i, t)
      : function (n) {
          return r(n, t);
  ...
  t.encode = function (n) {
    return (n == null ? "" : "" + n).replace(t.encReg, function (n) {
      return t.encMap[n] || "";
    });
  };
  t.arg = "o";
          ...
          b < 0
            ...
            : b > 0 &&
              ...
              i.left === undefined &&
                i.right === undefined &&
                (c = (a - o) / 2)))
        : ((i.contain || i.cover) && ((y = f = f || y), (p = e = e || p)),
          i.cover ? (d(), k()) : (k(), d())),
      w)
        ? ((h.width = r),
          (h.height = u),
          t.transformCoordinates(h, i),
          t.renderImageToCanvas(h, n, c, l, o, s, 0, 0, r, u))
        : ((n.width = r), (n.height = u), n);
    };
  ...
  (function (n) {
    ...
    if (
      ...
      n.detectSubsampling = function (n) {
        var t, i;
        return n.width * n.height > 1048576
          ? ((t = document.createElement("canvas")),
            (t.width = t.height = 1),
            (i = t.getContext("2d")),
            i.drawImage(n, -n.width + 1, 0),
            i.getImageData(0, 0, 1, 1).data[3] === 0)
          : !1;
      };
      ...
      n.renderImageToCanvas = function (i, r, u, f, e, o, s, h, c, l) {
        if (r._type === "image/jpeg") {
          ...
          if (
            ...
            (v.height = a),
            k.save(),
            (y = n.detectSubsampling(r)),
            y && ((u /= 2), (f /= 2), (e /= 2), (o /= 2)),
            (p = n.detectVerticalSquash(r, y)),
            y || p !== 1)
          ) {
            for (
              f *= p,
              ...
              for (s = 0, w = 0; w < e; )
                (d.clearRect(0, 0, a, a),
                  d.drawImage(r, u, f, e, o, -w, -b, e, o),
                  k.drawImage(v, 0, 0, a, a, s, h, c, l),
                  (w += a),
                  (s += c));
              b += a;
              h += l;
  ...
  (function (n) {
    ...
    n.parseExifTags = function (n, t, i, r, u) {
      ...
      if (
        ((e = n.getUint16(i, r)), (o = i + 2 + 12 * e), o + 4 > n.byteLength)
      ) {
...
(!(function (n) {
  var t = n.HTMLCanvasElement && n.HTMLCanvasElement.prototype,
    r =
      n.Blob &&
      (function () {
        try {
    ...
    i =
      ...
      function (n) {
        ...
        return (
          ...
          r
            ? new Blob([f ? o : e], { type: s })
            : ((h = new u()), h.append(e), h.getBlob(s))
        );
      };
  n.HTMLCanvasElement &&
    !t.toBlob &&
    (t.mozGetAsFile
      ? (t.toBlob = function (n, r, u) {
          u && t.toDataURL && i
            ? n(i(this.toDataURL(r, u)))
            : n(this.mozGetAsFile("blob", r));
        })
      : t.toDataURL &&
        i &&
        (t.toBlob = function (n, t, r) {
          n(i(this.toDataURL(t, r)));
        }));
    ...
    n.widget("blueimp.fileupload", {
      ...
      _onSend: function (t, i) {
        ...
        this.options.sequentialUploads ||
          ...
          ? (this.options.limitConcurrentUploads > 1
              ? ((e = n.Deferred()), this._slots.push(e), (h = e.pipe(o)))
              : ((this._sequence = this._sequence.pipe(o, o)),
                (h = this._sequence)),
            (h.abort = function () {
              return ((s = [undefined, "abort", "abort"]), !f)
                ? (e && e.rejectWith(u.context, s), o())
                : f.abort();
            }),
      ...
      _onAdd: function (t, i) {
        var a = this,
          ...
          y = 0;
        if (
          (c && (!v || u[0].size === undefined) && (c = undefined),
        ...
        return (
          ...
          n.each(h || u, function (r, u) {
            ...
            return (
              ...
              (p = a._trigger("add", n.Event("add", { delegatedEvent: t }), f))
            );
          }),
          p
        );
      ...
      _initDataAttributes: function () {
        ...
        n.each(i.data(), function (n, u) {
          ...
          i.attr(f) &&
            (t._isRegExpOption(n, u) && (u = t._getRegExp(u)), (r[n] = u));
        });
      },
      _create: function () {
  ...
  (function (n) {
    typeof define == "function" && define.amd
      ...
      : n(window.jQuery, window.tmpl);
  })(function (n, t) {
    n.blueimp.fileupload.prototype._specialOptions.push(
      "filesContainer",
      "uploadTemplateId",
      "downloadTemplateId",
    );
    n.widget("blueimp.fileupload", n.blueimp.fileupload, {
      options: {
        ...
        getFilesFromResponse: function (t) {
          return t.result && n.isArray(t.result.files) ? t.result.files : [];
        },
        add: function (t, i) {
          if (t.isDefaultPrevented()) return !1;
          var u = n(this),
            r = u.data("blueimp-fileupload") || u.data("fileupload"),
            f = r.options;
          i.context = r
            ._renderUpload(i.files)
            .data("data", i)
            .addClass("processing");
          f.filesContainer[f.prependFiles ? "prepend" : "append"](i.context);
          r._forceReflow(i.context);
          r._transition(i.context);
          i.process(function () {
            return u.fileupload("process", i);
          })
            .always(function () {
              i.context
                .each(function (t) {
            ...
            .fail(function () {
              i.files.error &&
                i.context.each(function (t) {
                  var r = i.files[t].error;
                  r && n(this).find(".error").text(r);
                });
            });
        },
        send: function (t, i) {
          if (t.isDefaultPrevented()) return !1;
          var r =
            n(this).data("blueimp-fileupload") || n(this).data("fileupload");
          return (
            i.context &&
              i.dataType &&
              i.dataType.substr(0, 6) === "iframe" &&
              i.context
                .find(".progress")
                .addClass(!n.support.transition && "progress-animated")
          ...
          var r =
              n(this).data("blueimp-fileupload") || n(this).data("fileupload"),
            o = i.getFilesFromResponse || r.options.getFilesFromResponse,
            e = o(i),
            u,
            f;
          i.context
            ? i.context.each(function (o) {
                var s = e[o] || { error: "Empty file upload result" };
                f = r._addFinishedDeferreds();
                r._transition(n(this)).done(function () {
                  var e = n(this);
                  u = r._renderDownload([s]).replaceAll(e);
                  r._forceReflow(u);
                  r._transition(u).done(function () {
                    i.context = n(this);
                    r._trigger("completed", t, i);
                    r._trigger("finished", t, i);
                    f.resolve();
                  });
                });
              })
            : ((u = r
                ._renderDownload(e)
                [
                  r.options.prependFiles ? "prependTo" : "appendTo"
                ](r.options.filesContainer)),
              r._forceReflow(u),
              (f = r._addFinishedDeferreds()),
              r._transition(u).done(function () {
                i.context = n(this);
        ...
        fail: function (t, i) {
          ...
          var r =
            ...
            u;
          i.context
            ? i.context.each(function (e) {
                if (i.errorThrown !== "abort") {
                  var o = i.files[e];
                  o.error = o.error || i.errorThrown || i.i18n("unknownError");
                  u = r._addFinishedDeferreds();
                  r._transition(n(this)).done(function () {
                    var e = n(this);
                    f = r._renderDownload([o]).replaceAll(e);
                    r._forceReflow(f);
                    r._transition(f).done(function () {
                      i.context = n(this);
            ...
            : i.errorThrown !== "abort"
              ? ((i.context = r
                ...
                r._forceReflow(i.context),
                (u = r._addFinishedDeferreds()),
                r._transition(i.context).done(function () {
                  i.context = n(this);
                  r._trigger("failed", t, i);
                  r._trigger("finished", t, i);
                  u.resolve();
        ...
        progress: function (t, i) {
          if (t.isDefaultPrevented()) return !1;
          var r = Math.floor((i.loaded / i.total) * 100);
          i.context &&
        ...
        progressall: function (t, i) {
          if (t.isDefaultPrevented()) return !1;
          var r = n(this),
            u = Math.floor((i.loaded / i.total) * 100),
            f = r.find(".fileupload-progress"),
            e = f.find(".progress-extended");
          e.length &&
            e.html(
              (
                r.data("blueimp-fileupload") || r.data("fileupload")
              )._renderExtendedProgress(i),
            );
          f.find(".progress")
            .attr("aria-valuenow", u)
            .children()
            .first()
            .css("width", u + "%");
        },
        start: function (t) {
          ...
          i._transition(n(this).find(".fileupload-progress")).done(function () {
        ...
        stop: function (t) {
          ...
          var i =
              n(this).data("blueimp-fileupload") || n(this).data("fileupload"),
            r = i._addFinishedDeferreds();
          n.when.apply(n, i._getFinishedDeferreds()).done(function () {
          ...
          i._transition(n(this).find(".fileupload-progress")).done(function () {
            n(this)
              ...
              .first()
              .css("width", "0%");
            n(this).find(".progress-extended").html("&nbsp;");
            r.resolve();
          });
        },
        processstart: function (t) {
          if (t.isDefaultPrevented()) return !1;
          n(this).addClass("fileupload-processing");
        },
        processstop: function (t) {
          if (t.isDefaultPrevented()) return !1;
          n(this).removeClass("fileupload-processing");
        },
        destroy: function (t, i) {
          ...
          var r =
            ...
            u = function () {
              r._transition(i.context).done(function () {
                n(this).remove();
                r._trigger("destroyed", t, i);
              });
            };
          i.url
            ? ((i.dataType = i.dataType || r.options.dataType),
              n
                .ajax(i)
                .done(u)
                .fail(function () {
                  r._trigger("destroyfailed", t, i);
                }))
            : u();
        },
      },
      ...
      _addFinishedDeferreds: function (t) {
        return (t || (t = n.Deferred()), this._finishedUploads.push(t), t);
      },
      ...
      _formatBitrate: function (n) {
        return typeof n != "number"
          ? ""
          : n >= 1e9
            ? (n / 1e9).toFixed(2) + " Gbit/s"
            : n >= 1e6
              ? (n / 1e6).toFixed(2) + " Mbit/s"
              : n >= 1e3
                ? (n / 1e3).toFixed(2) + " kbit/s"
                : n.toFixed(2) + " bit/s";
      },
      _formatTime: function (n) {
        ...
        return (
          ...
          t +
            ...
            ":" +
            ("0" + i.getUTCSeconds()).slice(-2)
        );
      },
      _formatPercentage: function (n) {
        return (n * 100).toFixed(2) + " %";
      },
      _renderExtendedProgress: function (n) {
        return (
          this._formatBitrate(n.bitrate) +
          " | " +
          this._formatTime(((n.total - n.loaded) * 8) / n.bitrate) +
          " | " +
          this._formatPercentage(n.loaded / n.total) +
          " | " +
          this._formatFileSize(n.loaded) +
          " / " +
          this._formatFileSize(n.total)
        );
      },
      _renderTemplate: function (t, i) {
        ...
        return r instanceof n
          ? r
          : n(this.options.templatesContainer).html(r).children();
      },
      _renderPreviews: function (t) {
        t.context.find(".preview").each(function (i, r) {
          n(r).append(t.files[i].preview);
        });
      },
      ...
      _renderDownload: function (n) {
        return this._renderTemplate(this.options.downloadTemplate, n)
          .find("a[download]")
      ...
      _cancelHandler: function (t) {
        t.preventDefault();
        var r = n(t.currentTarget).closest(
            ".template-upload,.template-download",
          ),
          i = r.data("data") || {};
        i.context = i.context || r;
        i.abort
          ? i.abort()
          : ((i.errorThrown = "abort"), this._trigger("fail", t, i));
      },
      ...
      _forceReflow: function (t) {
        return n.support.transition && t.length && t[0].offsetWidth;
      },
      _transition: function (t) {
        var i = n.Deferred();
        return (
          n.support.transition && t.hasClass("fade") && t.is(":visible")
            ? t
                .bind(n.support.transition.end, function (r) {
                  r.target === t[0] &&
                    (t.unbind(n.support.transition.end), i.resolveWith(t));
                })
                .toggleClass("in")
      ...
      _initTemplates: function () {
        var n = this.options;
        n.templatesContainer = this.document[0].createElement(
          n.filesContainer.prop("nodeName"),
        );
        t &&
          (n.uploadTemplateId && (n.uploadTemplate = t(n.uploadTemplateId)),
          n.downloadTemplateId &&
            (n.downloadTemplate = t(n.downloadTemplateId)));
      },
      _initFilesContainer: function () {
        var t = this.options;
        t.filesContainer === undefined
          ? (t.filesContainer = this.element.find(".files"))
          : t.filesContainer instanceof n ||
            (t.filesContainer = n(t.filesContainer));
      },
      _initSpecialOptions: function () {
        this._super();
      ...
      _create: function () {
        ...
        n.support.fileInput || this._disableFileInputButton();
      },
      enable: function () {
        var n = !1;
        this.options.disabled && (n = !0);
        this._super();
        n &&
  ...
  (function (n) {
    typeof define == "function" && define.amd
      ? define(["jquery", "./jquery.fileupload-ui"], n)
      : n(window.jQuery);
  })(function (n) {
    n.widget("blueimp.fileupload", n.blueimp.fileupload, {
      options: {
        processdone: function (n, t) {
        ...
        progressall: function (t, i) {
          var r = n(this);
          r.find(".fileupload-progress")
            .find(".progress")
            .progressbar(
              "option",
              "value",
              parseInt((i.loaded / i.total) * 100, 10),
            )
            .end()
      ...
      _renderUpload: function (t, i) {
        var r = this._super(t, i),
          u = n(window).width() > 480;
        return (
          r.find(".progress").empty().progressbar(),
          r
            .find(".start")
            .button({ icons: { primary: "ui-icon-circle-arrow-e" }, text: u }),
          r
            .find(".cancel")
            .button({ icons: { primary: "ui-icon-cancel" }, text: u }),
          r.hasClass("fade") && r.hide(),
          r
        );
      },
      _renderDownload: function (t, i) {
        var r = this._super(t, i),
          u = n(window).width() > 480;
        return (
          r
            .find(".delete")
            .button({ icons: { primary: "ui-icon-trash" }, text: u }),
          r.hasClass("fade") && r.hide(),
          r
        );
      },
      _startHandler: function (t) {
        n(t.currentTarget).button("disable");
        this._super(t);
      },
      _transition: function (t) {
        var i = n.Deferred();
      ...
      _create: function () {
        ...
        this.element
          ...
          .each(function () {
            var t = n(this).find("input:file").detach();
            n(this)
      ...
      _destroy: function () {
        this.element
          ...
          .each(function () {
            var t = n(this).find("input:file").detach();
            n(this).button("destroy").append(t);
          })
          .end()
          .find(".start")
          .button("destroy")
