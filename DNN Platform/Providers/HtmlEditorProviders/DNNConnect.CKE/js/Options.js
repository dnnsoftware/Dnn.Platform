(function ($, win) {
  ...
  win.pageLoad = function () {
    ...
    $("#addRowBreak").click(function () {
      $(".groups").append(
        '<li class="groupItem rowBreakItem">' +
          '<span class="ui-icon ui-icon-cancel" title="' +
          win.deleteGroup +
          '"></span><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>' +
    ...
    $("#ExportDialog").dialog({
      ...
      buttons: {
        ...
        "Export Now": function () {
          window.location = $(".ExportHidden").attr("href");
          $(this).dialog("close");
        },
      },
      open: function () {
    ...
    $("#ImportDialog").dialog({
      ...
      buttons: {
        ...
        "Import Now": function () {
          window.location = $(".ImportHidden").attr("href");
          $(this).dialog("close");
        },
      },
      open: function () {
  ...
  win.EnableSorting = function () {
    ...
    $(".availableButtons").sortable({
      ...
      remove: function (e, ui) {
        ...
        ui.item.prepend(
          '<span class="ui-icon ui-icon-cancel" title="Delete this Toolbar"></span>',
        );
        EnableSorting();
        $('[id*="Options_ToolbarSet"]').val($(".groups").SerializeToolbars());
      },
    ...
    $(".groupItem .saveGroupName")
      .not(".rowBreakItem .saveGroupName")
      .click(function () {
        var input = $(this).prev();
        var a = input.prev();
    ...
    $(".groups .ui-icon-cancel").click(function () {
      $(this)
        ...
        .each(function (e) {
          ...
          if (
            $item.attr("class").indexOf("separator") == -1 &&
      ...
      while (
        (i =
          _token !== undefined
            ? str
                .toLowerCase()
                .indexOf(_token, i >= 0 ? i + newToken.length : 0)
