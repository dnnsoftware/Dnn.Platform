...
(function () {
    ...
    parseLinkAttributes: function (editor, element) {
      ...
      if (!retval.type) {
        ...
        // urlRegex matches empty strings, so need to check for href as well.
          ...
          if (
            (editor.config.defaultLinkType &&
              editor.config.defaultLinkType === "url") ||
            editor.config.defaultLinkType === "localPage" ||
            editor.config.defaultLinkType === "anchor" ||
            editor.config.defaultLinkType === "email"
          ) {
  ...
  CKEDITOR.on("dialogDefinition", function (ev) {
    ...
    if (dialogName == "link") {
      ...
      var urlTitle = editor.config.filebrowserBrowseUrl
        ? editor.lang.dnnpages.portalUrl
        : editor.lang.common.url;
  ...
  function InjectQuickUploadFileSizeCheck(evt) {
    var maxFileSize = evt.editor.config.maxFileSize
        ? evt.editor.config.maxFileSize
        : null,
