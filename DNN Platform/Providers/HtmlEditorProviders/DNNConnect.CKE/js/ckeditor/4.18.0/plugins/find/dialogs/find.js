...
(function () {
  ...
  CKEDITOR.dialog.add("find", function (d) {
    ...
    function z(a) {
      ...
      return (9 <= b && 13 >= b) || (8192 <= b && 8202 >= b) || F.test(a);
    }
    function r(a) {
    ...
    u.prototype = {
      ...
      removeHighlight: function () {
        if (this._.highlightRange) {
          ...
          A.removeFromRange(this._.highlightRange, d);
    ...
    B.prototype = {
      feedCharacter: function (a) {
        for (this._.ignoreCase && (a = a.toLowerCase()); ; ) {
          ...
          a == c ? (b = !0) : ((b = C.test(a)), (c = C.test(c)), (b = b && c));
          if (b)
            return (
              this._.state++,
    ...
    var F = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/,
      ...
      f = {
        ...
        find: function (a, b, c, e, E, t) {
          ...
          for (var h = new B(a, !b), k = 0, l = "%"; null !== l; ) {
            for (
