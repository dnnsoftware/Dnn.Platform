    ...
    public class Tabs : PortalModuleBase, IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
                    ...
                    portalId, -1, false, null, true, false, true, true, true))
            {
                ...
                {
                    pagesArray.AppendFormat("new Array('| ' + {0},{1}),", HttpUtility.JavaScriptStringEncode(tabName, addDoubleQuotes: true), HttpUtility.JavaScriptStringEncode(tabUrl, addDoubleQuotes: true));
                }
                else
                {
                    ...
                    pagesArray.AppendFormat(
                        "new Array('|' + {0} + ' ' + {1},{2}),",
                        HttpUtility.JavaScriptStringEncode(separator.ToString(), addDoubleQuotes: true),
                        HttpUtility.JavaScriptStringEncode(tabName, addDoubleQuotes: true),
                        HttpUtility.JavaScriptStringEncode(tabUrl, addDoubleQuotes: true));
                }
            }
