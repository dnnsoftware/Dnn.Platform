...
/// <summary>Google SMTP OAuth constants.</summary>
internal class Constants
{
    /// <summary>The provider name.</summary>
    public const string Name = "GoogleMail";

    /// <summary>The client id setting name.</summary>
