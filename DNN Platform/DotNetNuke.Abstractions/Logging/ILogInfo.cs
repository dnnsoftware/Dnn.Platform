...
namespace DotNetNuke.Abstractions.Logging
{
    ...
    public interface ILogInfo
    {
        ...
        /// <summary>
        /// Gets or sets the log create date.
        /// </summary>
        DateTime LogCreateDate { get; set; }

        /// <summary>
        /// Gets or sets the log create date number.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether or not the log can bypass the buffer.
        /// </summary>
        bool BypassBuffering { get; set; }

        /// <summary>
        /// Gets or sets the log server name.
        /// </summary>
