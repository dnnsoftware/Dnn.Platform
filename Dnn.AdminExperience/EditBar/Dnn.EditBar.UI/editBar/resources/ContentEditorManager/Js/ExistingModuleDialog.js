...
(function ($) {
  ...
  var dnnExistingModuleDialog = (dnn.dnnExistingModuleDialog = function (
    options,
  ) {
  ...
  dnnExistingModuleDialog.prototype = {
    ...
    getDefaultPane: function () {
      return this.getModuleDialog().getDefaultPane.apply(
    ...
    getPaneById: function () {
      return this.getModuleDialog().getPaneById.apply(
        this.getModuleDialog(),
        arguments,
      );
    },
    ...
    refreshPane: function () {
      return this.getModuleDialog().refreshPane.apply(
        this.getModuleDialog(),
        arguments,
      );
    },
    ...
    addModule: function (moduleId, callback, callbackBeforeRefresh) {
      ...
      var params = {
        ...
        CopyModule: this._dialogLayout
          .find("input.copy-module")
          .prop("checked"),
        Sort: -1,
      };
      ...
      this.getModuleDialog()
        ._getService()
        .request("AddModule", "POST", params, function (data) {
    ...
    _createPagesDropdown: function (portalId) {
      ...
      var pagePickerOptions = {
        ...
        itemList: {
          ...
          unsortedOrderButtonTooltip:
            resx.pagePicker_unsortedOrderButtonTooltip,
          sortAscendingButtonTooltip:
            resx.pagePicker_sortAscendingButtonTooltip,
          sortDescendingButtonTooltip:
            resx.pagePicker_sortDescendingButtonTooltip,
          selectedItemExpandTooltip: resx.pagePicker_selectedItemExpandTooltip,
          selectedItemCollapseTooltip:
            resx.pagePicker_selectedItemCollapseTooltip,
      ...
      handler._createDropdown(
        $("#AddExistingModule_Pages")[0],
        pagePickerOptions,
      );
    },
    ...
    _generateLayout: function () {
      var layout = (this._dialogLayout = $(
        "" +
          ...
          '<span class="title">' +
          dnn.ContentEditorManagerResources.addExistingModule +
          "</span>" +
          "</div>" +
          ...
          '<li class="sites">' +
          "<label>" +
          dnn.ContentEditorManagerResources.site +
          "</label>" +
          ...
          "<li>" +
          "<label>" +
          dnn.ContentEditorManagerResources.page +
          "</label>" +
          ...
          "</li>" +
          "<li>" +
          '<input type="checkbox" class="copy-module" checked="true" aria-label="Copy" /><label>' +
          dnn.ContentEditorManagerResources.makeCopy +
          "</label>" +
          "</li>" +
          '<div class="clear"></div>' +
          "</ul>" +
    ...
    _loadSiteList: function () {
      if (!this.getModuleDialog()._getItemListService().isLoading()) {
        this.getModuleDialog()._getItemListService().request(
          "GetPortalsInGroup",
          "GET",
          {
            sortOrder: 0,
    ...
    _loadModuleList: function () {
      ...
      if (!this._selectedPageId) {
        var container = this._dialogLayout.find(
          ".dnnModuleList .listContainer.listAll ul",
        );
      ...
      if (!this.getModuleDialog()._getService().isLoading()) {
        this.getModuleDialog()._getService().request(
          "GetTabModules",
          "GET",
          {
    ...
    _cloneItem: function () {
      return this.getModuleDialog()._cloneItem.apply(
        this.getModuleDialog(),
        arguments,
      );
    },
    ...
    _replaceAll: function () {
      return this.getModuleDialog()._replaceAll.apply(
        this.getModuleDialog(),
        arguments,
      );
    },
