...
(function ($) {
  ...
  var getModuleDialog = (dnn.ContentEditorManager.getModuleDialog =
    function () {
  ...
  var getExsitingModuleDialog =
    (dnn.ContentEditorManager.getExsitingModuleDialog = function () {
  ...
  dnnModuleManager.prototype = {
    ...
    getExistingModuleHandler: function () {
      this._existingModuleHandler = this.getPane().find(
        "> .addExistingModuleHandler",
      );
    ...
    _generateLayout: function () {
      return $(
        '<a href="#" class="addModuleHandler" aria-label="Add Module"><span></span></a><a href="#" class="addExistingModuleHandler" aria-label="Add Existing Module"><span></span></a>',
      );
    },
    ...
    _injectVisualEffects: function () {
      ...
      this.container.find("div.DnnModule").each(function () {
        ...
        module.mouseover(function () {
          ...
          if (
            !module.hasClass("active-module") &&
            !module.hasClass("floating")
          ) {
            module
              .parent()
              .find("> div.DnnModule")
      ...
      this.container
        ...
        .mouseout(function (e) {
          ...
          if (
            target.parents(".active-pane").length > 0 ||
            target.hasClass("actionMenu") ||
            target.parents(".actionMenu").length > 0
          ) {
            if (target.hasClass("actionMenu") && !target.hasClass("floating")) {
              ...
              target.parents(".actionMenu").length > 0 &&
              !target.parents(".actionMenu").hasClass("floating")
            ) {
              $(".actionMenu:visible").stop(true, true).css({ opacity: 0.5 });
              target
                .parents(".actionMenu")
      ...
      $(document).mouseover(function (e) {
        ...
        if (
          $(e.target).parents(".actionMenu").length > 0 ||
          $(".actionMenu:visible").length == 0
        ) {
          return;
        }
    ...
    _handleEvents: function () {
      ...
      this.getExistingModuleHandler().click(
        $.proxy(this._addExisingModuleHandlerClick, this),
      );
    },
