  ...
  output: {
    ...
    distPath: {
      root: useWebsitePath
        ? path.join(
            websitePath,
            "DesktopModules/Admin/Dnn.PersonaBar/Modules/Dnn.SiteSettings/"
          )
        : "../../Dnn.PersonaBar.Extensions/admin/personaBar/Dnn.SiteSettings/",
      js: "scripts/bundles/",
      css: "css/",
      html: "",
    },
    filename: {
      js: "site-settings-bundle.js",
      css: "SiteSettings.css",
    },
    legalComments: "none",
  },
  performance: {
