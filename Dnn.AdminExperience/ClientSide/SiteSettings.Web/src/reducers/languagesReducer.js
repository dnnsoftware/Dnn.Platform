...
export default function languages(state = {}, action) {
  switch (action.type) {
    case ActionTypes.RETRIEVED_SITESETTINGS_LANGUAGE_SETTINGS:
      return {
        ...
        languageSettingsClientModified:
          action.data.languageSettingsClientModified,
      };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_LANGUAGES:
      return { ...state, languageList: action.data.languageList };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_ALL_LANGUAGES:
      return { ...state, fullLanguageList: action.data.fullLanguageList };
    ...
    case ActionTypes.VERIFIED_SITESETTINGS_LANGUAGE_RESOURCE_FILES:
      return { ...state, verificationResults: action.data.verificationResults };
    case ActionTypes.RETRIEVED_SITESETTINGS_LANGUAGE_PACK_MODULE_LIST:
      return { ...state, modules: action.data.modules };
    case ActionTypes.RETRIEVED_SITESETTINGS_LANGUAGE_ROLE_GROUPS:
      return { ...state, roleGroups: action.data.roleGroups };
    case ActionTypes.RETRIEVED_SITESETTINGS_LANGUAGE_ROLES:
      return { ...state, rolesList: action.data.rolesList };
