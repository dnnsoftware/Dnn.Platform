...
export default function search(state = {}, action) {
  switch (action.type) {
    ...
    case ActionTypes.SITESETTINGS_BASIC_SEARCH_SETTINS_CLIENT_MODIFIED:
      return {
        ...
        basicSearchSettingsClientModified:
          action.data.basicSearchSettingsClientModified,
      };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_SYNONYMS_GROUPS:
      return { ...state, synonymsGroups: action.data.synonymsGroups };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_IGNORE_WORDS:
      return { ...state, ignoreWords: action.data.ignoreWords };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_SEARCH_CULTURE_LIST:
      return { ...state, cultures: action.data.cultures };
    default:
      return state;
  }
}
