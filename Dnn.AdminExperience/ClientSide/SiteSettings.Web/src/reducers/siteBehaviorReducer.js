...
export default function siteBehavior(state = {}, action) {
  switch (action.type) {
    case ActionTypes.RETRIEVED_SITESETTINGS_DEFAULT_PAGES_SETTINGS:
      return {
        ...
        defaultPagesSettingsClientModified:
          action.data.defaultPagesSettingsClientModified,
      };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_MESSAGING_SETTINGS:
      return {
        ...
        messagingSettingsClientModified:
          action.data.messagingSettingsClientModified,
      };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_PROFILE_SETTINGS:
      return {
        ...
        profileSettingsClientModified:
          action.data.profileSettingsClientModified,
      };
    ...
    case ActionTypes.UPDATED_SITESETTINGS_PROFILE_PROPERTY_ORDER:
      return { ...state, profileProperties: action.data.profileProperties };
    case ActionTypes.RETRIEVED_SITESETTINGS_PROFILE_PROPERTY:
      return {
        ...
        profilePropertyClientModified:
          action.data.profilePropertyClientModified,
      };
    ...
    case ActionTypes.SITESETTINGS_PROFILE_PROPERTY_LOCALIZATION_CLIENT_MODIFIED:
      return {
        ...
        propertyLocalizationClientModified:
          action.data.propertyLocalizationClientModified,
      };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_PORTAL_ALIAS_SETTINGS:
      return {
        ...
        urlMappingSettingsClientModified:
          action.data.urlMappingSettingsClientModified,
      };
    case ActionTypes.RETRIEVED_SITESETTINGS_PORTAL_ALIASES:
      return { ...state, siteAliases: action.data.siteAliases };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_PORTAL_ALIAS:
      return { ...state, aliasDetail: action.data.aliasDetail };
    ...
    case ActionTypes.DELETED_SITESETTINGS_LIST_ENTRY:
      return { ...state, entries: action.data.entries };
    ...
    case ActionTypes.RETRIEVED_SITESETTINGS_PRIVACY_SETTINGS:
      return {
        ...
        privacySettingsClientModified:
          action.data.privacySettingsClientModified,
      };
