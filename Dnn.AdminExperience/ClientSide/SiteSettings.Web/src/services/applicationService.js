...
class ApplicationService {
  ...
  getDefaultPagesSettings(portalId, cultureCode, callback) {
    const sf = this.getServiceFramework("SiteSettings");
    sf.get(
      "GetDefaultPagesSettings?portalId=" +
        portalId +
        "&cultureCode=" +
        (cultureCode ? cultureCode : ""),
      {},
  ...
  getProfileProperty(propertyId, portalId, callback) {
    const sf = this.getServiceFramework("SiteSettings");
    sf.get(
      "GetProfileProperty?propertyId=" + propertyId + "&portalId=" + portalId,
      {},
      callback,
    );
  }
  ...
  getProfilePropertyLocalization(
    ...
    const sf = this.getServiceFramework("SiteSettings");
    sf.get(
      "GetProfilePropertyLocalization?portalId=" +
        portalId +
        "&propertyName=" +
        propertyName +
        "&propertyCategory=" +
  ...
  deleteProfileProperty(propertyId, callback, failureCallback) {
    const sf = this.getServiceFramework("SiteSettings");
    sf.post(
      "DeleteProfileProperty?propertyId=" + propertyId + "&portalId=",
      {},
      callback,
      failureCallback,
    );
  ...
  deleteSiteAlias(aliasId, callback, failureCallback) {
    const sf = this.getServiceFramework("SiteSettings");
    sf.post(
      "DeleteSiteAlias?portalAliasId=" + aliasId,
      {},
      callback,
      failureCallback,
    );
  ...
  portalSearchReindex(portalId, callback, failureCallback) {
    const sf = this.getServiceFramework("SiteSettings");
    sf.post(
      "PortalSearchReindex?portalId=" + portalId,
      {},
      callback,
      failureCallback,
    );
  ...
  getLanguage(portalId, languageId, callback) {
    const sf = this.getServiceFramework("SiteSettings");
    sf.get(
      "GetLanguage?portalId=" + portalId + "&languageId=" + languageId,
      {},
      callback,
    );
  }
  ...
  activateLanguage(payload, callback, failureCallback) {
    ...
    sf.post(
      "ActivateLanguage?" + serializeQueryStringParameters(payload),
      {},
      callback,
      failureCallback,
    );
  ...
  markAllPagesAsTranslated(payload, callback, failureCallback) {
    const sf = this.getServiceFramework("Languages");
    sf.post(
      "MarkAllPagesTranslated?" + serializeQueryStringParameters(payload),
      {},
      callback,
      failureCallback,
    );
  ...
  getListInfo(listName, portalId, callback) {
    const sf = this.getServiceFramework("SiteSettings");
    sf.get(
      "GetListInfo?portalId=" + portalId + "&listName=" + listName,
      {},
      callback,
    );
  }
  ...
  deleteListEntry(entryId, portalId, callback, failureCallback) {
    const sf = this.getServiceFramework("SiteSettings");
    sf.post(
      "DeleteListEntry?entryId=" + entryId + "&portalId=" + portalId,
      {},
      callback,
      failureCallback,
    );
