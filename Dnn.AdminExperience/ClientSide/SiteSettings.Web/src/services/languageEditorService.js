...
class ApplicationService {
  ...
  getRootResourcesFolder(portalId, mode, callback) {
    ...
    sf.get(
      "GetRootResourcesFolders?portalId=" + portalId + "&mode=" + mode,
      {},
      callback,
    );
  }
  ...
  getResxEntries(parameters, callback) {
    const sf = this.getServiceFramework("Languages");
    sf.get(
      "GetResxEntries?" + serializeQueryStringParameters(parameters),
      {},
      callback,
    );
  }
  ...
  enableLocalizedContent(parameters, callback, failureCallback) {
    const sf = this.getServiceFramework("Languages");
    sf.post(
      "EnableLocalizedContent?" + serializeQueryStringParameters(parameters),
      {},
      callback,
      failureCallback,
    );
  ...
  disableLocalizedContent(portalId, callback, failureCallback) {
    const sf = this.getServiceFramework("Languages");
    sf.post(
      "DisableLocalizedContent?portalId=" + portalId,
      {},
      callback,
      failureCallback,
    );
  ...
  localizeContent(parameters, callback, failureCallback) {
    const sf = this.getServiceFramework("Languages");
    sf.post(
      "LocalizedContent?" + serializeQueryStringParameters(parameters),
      {},
      callback,
      failureCallback,
    );
  ...
  getPageList(payload, callback) {
    const sf = this.getServiceFramework("Languages");
    sf.getsilence(
      "GetTabsForTranslation?" + serializeQueryStringParameters(payload),
      {},
      callback,
    );
  }
  ...
  deleteLanguagePages(payload, callback) {
    const sf = this.getServiceFramework("Languages");
    sf.post(
      `DeleteLanguagePages?${serializeQueryStringParameters(payload)}`,
      {},
      callback,
    );
  }
  ...
  publishAllPages(payload, callback) {
    const sf = this.getServiceFramework("Languages");
    sf.post(
      `PublishAllPages?${serializeQueryStringParameters(payload)}`,
      {},
      callback,
    );
  }
