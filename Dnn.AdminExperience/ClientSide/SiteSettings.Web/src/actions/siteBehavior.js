...
const siteBehaviorActions = {
  getDefaultPagesSettings(portalId, cultureCode, callback) {
    return (dispatch) => {
      ApplicationService.getDefaultPagesSettings(
        portalId,
        cultureCode,
        (data) => {
          dispatch({
  ...
  updateDefaultPagesSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateDefaultPagesSettings(
        payload,
        (data) => {
          dispatch({
  ...
  updateMessagingSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateMessagingSettings(
        payload,
        (data) => {
          dispatch({
  ...
  updateProfileSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateProfileSettings(
        payload,
        (data) => {
          dispatch({
  ...
  getProfilePropertyLocalization(
    portalId,
    propertyName,
    propertyCategory,
    cultureCode,
    ...
    return (dispatch) => {
      ApplicationService.getProfilePropertyLocalization(
        portalId,
        propertyName,
        propertyCategory,
        cultureCode,
  ...
  updateProfileProperty(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateProfileProperty(
        payload,
        (data) => {
          dispatch({
  ...
  addProfileProperty(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.addProfileProperty(
        payload,
        (data) => {
          dispatch({
  ...
  deleteProfileProperty(propertyId, object, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.deleteProfileProperty(
        propertyId,
        (data) => {
          dispatch({
  ...
  updateProfilePropertyLocalization(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateProfilePropertyLocalization(
        payload,
        (data) => {
          dispatch({
  ...
  updateUrlMappingSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateUrlMappingSettings(
        payload,
        (data) => {
          dispatch({
  ...
  addSiteAlias(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.addSiteAlias(
        payload,
        (data) => {
          dispatch({
  ...
  updateSiteAlias(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateSiteAlias(
        payload,
        (data) => {
          dispatch({
  ...
  deleteSiteAlias(aliasId, aliases, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.deleteSiteAlias(
        aliasId,
        (data) => {
          dispatch({
  ...
  updatePrivacySettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updatePrivacySettings(
        payload,
        (data) => {
          dispatch({
  ...
  resetTermsAgreement(payload, callback, failureCallback) {
    ApplicationService.resetTermsAgreement(
      payload,
      (data) => {
        if (callback) {
          callback(data);
  ...
  updateOtherSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateOtherSettings(
        payload,
        (data) => {
          dispatch({
  ...
  updateProfilePropertyOrders(payload, object, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateProfilePropertyOrders(
        payload,
        (data) => {
          dispatch({
  ...
  updateListEntry(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateListEntry(
        payload,
        (data) => {
          dispatch({
  ...
  deleteListEntry(entryId, portalId, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.deleteListEntry(
        entryId,
        portalId,
        (data) => {
          dispatch({
  ...
  updateListEntryOrders(payload, object, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateListEntryOrders(
        payload,
        (data) => {
          dispatch({
