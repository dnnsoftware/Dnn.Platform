...
const languagesActions = {
  ...
  updateLanguageSettings(payload, languageList, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateLanguageSettings(
        payload,
        (data) => {
          dispatch({
  ...
  addLanguage(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.addLanguage(
        payload,
        (data) => {
          dispatch({
  ...
  updateLanguage(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateLanguage(
        payload,
        (data) => {
          dispatch({
  ...
  updateLanguageRoles(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateLanguageRoles(
        payload,
        (data) => {
          dispatch({
  ...
  createLanguagePack(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.createLanguagePack(
        payload,
        (data) => {
          dispatch({
  ...
  publishAllPages(payload, callback, failureCallback) {
    return (dispatch) => {
      LanguageEditorService.publishAllPages(
        payload,
        (data) => {
          dispatch({
  ...
  enableLocalizedContent(payload, callback, failureCallback) {
    return (dispatch) => {
      LanguageEditorService.enableLocalizedContent(
        payload,
        (data) => {
          dispatch({
  ...
  localizeContent(payload, callback, failureCallback) {
    return (dispatch) => {
      LanguageEditorService.localizeContent(
        payload,
        (data) => {
          dispatch({
            type: ActionTypes.ENABLED_LOCALIZED_CONTENT,
