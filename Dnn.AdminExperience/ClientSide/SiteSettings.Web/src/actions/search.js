...
const searchActions = {
  ...
  updateBasicSearchSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateBasicSearchSettings(
        payload,
        (data) => {
          dispatch({
  ...
  compactSearchIndex(callback, failureCallback) {
    return () => {
      ApplicationService.compactSearchIndex(
        (data) => {
          if (callback) {
            callback(data);
          }
  ...
  hostSearchReindex(callback, failureCallback) {
    return () => {
      ApplicationService.hostSearchReindex(
        (data) => {
          if (callback) {
            callback(data);
          }
  ...
  portalSearchReindex(portalId, callback, failureCallback) {
    return () => {
      ApplicationService.portalSearchReindex(
        portalId,
        (data) => {
          if (callback) {
            callback(data);
  ...
  addSynonymsGroup(payload, groups, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.addSynonymsGroup(
        payload,
        (data) => {
          ...
          updatedGroups.unshift({
            SynonymsGroupId: data.Id,
            SynonymsTags: payload.SynonymsTags,
          });
  ...
  updateSynonymsGroup(payload, groups, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateSynonymsGroup(
        payload,
        (data) => {
          dispatch({
  ...
  deleteSynonymsGroup(groupId, object, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.deleteSynonymsGroup(
        groupId,
        (data) => {
          dispatch({
  ...
  addIgnoreWords(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.addIgnoreWords(
        payload,
        (data) => {
  ...
  updateIgnoreWords(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateIgnoreWords(
        payload,
        (data) => {
          dispatch({
  ...
  deleteIgnoreWords(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.deleteIgnoreWords(
        payload,
        (data) => {
          let updated = Object.assign({}, payload);
