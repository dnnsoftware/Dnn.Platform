...
function mapChildFolders(
  ...
  return folders.map((folder, i) => {
    ...
    return (
      <Folder
        onClick={
          !isResxFile ? getChildFolders.bind(this) : getResxEntries.bind(this)
        }
        folder={folder}
    ...
    return (
      <div ref={this.node}>
        <GridCell columnSize={100} className="resource-file-tree-container">
          ...
          <div
            className="resource-file-dropdown"
            onClick={this.onToggleTree.bind(this)}
            style={{ width: "50%" }}
          >
          ...
          <Collapsible
            isOpened={this.state.treeOpened}
