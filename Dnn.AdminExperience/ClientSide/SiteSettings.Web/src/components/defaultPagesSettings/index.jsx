...
class DefaultPagesSettingsPanelBody extends Component {
  ...
  componentDidUpdate() {
    ...
    if (props.defaultPagesSettings) {
      ...
      if (
        ...
        props.defaultPagesSettings.PortalId === props.portalId
      ) {
      ...
      if (
        ...
        props.defaultPagesSettings.CultureCode === props.cultureCode
      ) {
  ...
  loadData() {
    const { props } = this;
    props.dispatch(
      SiteBehaviorActions.getDefaultPagesSettings(
        props.portalId,
        props.cultureCode,
        (data) => {
          if (this._mounted) {
  ...
  onSettingChange(key, event, value) {
    ...
    props.dispatch(
      SiteBehaviorActions.defaultPagesSettingsClientModified(
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SiteBehaviorActions.updateDefaultPagesSettings(
        state.defaultPagesSettings,
        () => {
  ...
  render() {
    ...
    let TabParameters_2 = Object.assign(Object.assign({}, TabParameters), {
      disabledNotSelectable: true,
    });
    let TabParameters_Login = Object.assign(Object.assign({}, TabParameters), {
      disabledNotSelectable: false,
      validateTab: "Account Login",
    });
    let TabParameters_Search = Object.assign(Object.assign({}, TabParameters), {
      disabledNotSelectable: false,
      validateTab: "Search Results",
    });
    let TabParameters_Anonymous = Object.assign(
      Object.assign({}, TabParameters),
      { disabledNotSelectable: true, roles: "-1" },
    );
        ...
        <div key="column-one" className="left-column">
          <InputGroup>
            ...
            <PagePicker
              ...
              selectedTabId={
                state.defaultPagesSettings.HomeTabId
                  ? state.defaultPagesSettings.HomeTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "HomeTabId")}
              defaultLabel={
                state.defaultPagesSettings.HomeTabName
                  ? state.defaultPagesSettings.HomeTabName
                  : noneSpecifiedText
              }
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              selectedTabId={
                state.defaultPagesSettings.LoginTabId
                  ? state.defaultPagesSettings.LoginTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "LoginTabId")}
              defaultLabel={
                state.defaultPagesSettings.LoginTabName
                  ? state.defaultPagesSettings.LoginTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              selectedTabId={
                state.defaultPagesSettings.RegisterTabId
                  ? state.defaultPagesSettings.RegisterTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "RegisterTabId")}
              defaultLabel={
                state.defaultPagesSettings.RegisterTabName
                  ? state.defaultPagesSettings.RegisterTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              selectedTabId={
                state.defaultPagesSettings.UserTabId
                  ? state.defaultPagesSettings.UserTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "UserTabId")}
              defaultLabel={
                state.defaultPagesSettings.UserTabName
                  ? state.defaultPagesSettings.UserTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              selectedTabId={
                state.defaultPagesSettings.RedirectAfterLoginTabId
                  ? state.defaultPagesSettings.RedirectAfterLoginTabId
                  : -1
              }
              ...
              defaultLabel={
                state.defaultPagesSettings.RedirectAfterLoginTabName
                  ? state.defaultPagesSettings.RedirectAfterLoginTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              selectedTabId={
                state.defaultPagesSettings.RedirectAfterLogoutTabId
                  ? state.defaultPagesSettings.RedirectAfterLogoutTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(
              ...
              defaultLabel={
                state.defaultPagesSettings.RedirectAfterLogoutTabName
                  ? state.defaultPagesSettings.RedirectAfterLogoutTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              selectedTabId={
                state.defaultPagesSettings.RedirectAfterRegistrationTabId
                  ? state.defaultPagesSettings.RedirectAfterRegistrationTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(
              ...
              defaultLabel={
                state.defaultPagesSettings.RedirectAfterRegistrationTabName
                  ? state.defaultPagesSettings.RedirectAfterRegistrationTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
        ...
        <div key="column-two" className="right-column">
          <InputGroup>
            ...
            <PagePicker
              ...
              style={{ width: "100%", zIndex: 7 }}
              selectedTabId={
                state.defaultPagesSettings.SplashTabId
                  ? state.defaultPagesSettings.SplashTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "SplashTabId")}
              defaultLabel={
                state.defaultPagesSettings.SplashTabName
                  ? state.defaultPagesSettings.SplashTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              style={{ width: "100%", zIndex: 6 }}
              selectedTabId={
                state.defaultPagesSettings.SearchTabId
                  ? state.defaultPagesSettings.SearchTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "SearchTabId")}
              defaultLabel={
                state.defaultPagesSettings.SearchTabName
                  ? state.defaultPagesSettings.SearchTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              style={{ width: "100%", zIndex: 5 }}
              selectedTabId={
                state.defaultPagesSettings.Custom404TabId
                  ? state.defaultPagesSettings.Custom404TabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "Custom404TabId")}
              defaultLabel={
                state.defaultPagesSettings.Custom404TabName
                  ? state.defaultPagesSettings.Custom404TabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              style={{ width: "100%", zIndex: 4 }}
              selectedTabId={
                state.defaultPagesSettings.Custom500TabId
                  ? state.defaultPagesSettings.Custom500TabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "Custom500TabId")}
              defaultLabel={
                state.defaultPagesSettings.Custom500TabName
                  ? state.defaultPagesSettings.Custom500TabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              style={{ width: "100%", zIndex: 3 }}
              selectedTabId={
                state.defaultPagesSettings.TermsTabId
                  ? state.defaultPagesSettings.TermsTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "TermsTabId")}
              defaultLabel={
                state.defaultPagesSettings.TermsTabName
                  ? state.defaultPagesSettings.TermsTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
          ...
          <InputGroup>
            ...
            <PagePicker
              ...
              style={{ width: "100%", zIndex: 2 }}
              selectedTabId={
                state.defaultPagesSettings.PrivacyTabId
                  ? state.defaultPagesSettings.PrivacyTabId
                  : -1
              }
              OnSelect={this.onSettingChange.bind(this, "PrivacyTabId")}
              defaultLabel={
                state.defaultPagesSettings.PrivacyTabName
                  ? state.defaultPagesSettings.PrivacyTabName
                  : noneSpecifiedText
              }
              noneSpecifiedText={noneSpecifiedText}
...
function mapStateToProps(state) {
  return {
    ...
    defaultPagesSettingsClientModified:
      state.siteBehavior.defaultPagesSettingsClientModified,
  };
}
