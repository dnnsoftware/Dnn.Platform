...
class BasicSearchSettingsPanelBody extends Component {
  ...
  componentDidMount() {
    ...
    if (this.isHost()) {
      props.dispatch(
        SearchActions.getBasicSearchSettings((data) => {
          if (this._mounted) {
            this.setState({
  ...
  onSettingChange(key, event) {
    ...
    if (!re.test(basicSearchSettings[key]) && key === "MaxResultPerPage") {
      ...
      re.test(basicSearchSettings[key]) &&
      key === "MaxResultPerPage"
    ) {
    ...
    if (
      key === "MaxWordLength" &&
      (!re.test(basicSearchSettings[key]) ||
        parseInt(basicSearchSettings["MinWordLength"]) >=
          parseInt(basicSearchSettings["MaxWordLength"]))
    ) {
    ...
    props.dispatch(
      SearchActions.basicSearchSettingsClientModified(basicSearchSettings),
    );
  }
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SearchActions.updateBasicSearchSettings(
        state.basicSearchSettings,
        () => {
  ...
  onReindexContent() {
    const { props } = this;
    util.utilities.confirm(
      resx.get("ReIndexConfirmationMessage"),
      resx.get("Yes"),
      resx.get("No"),
      () => {
  ...
  onCompactIndex() {
    const { props } = this;
    util.utilities.confirm(
      resx.get("CompactIndexConfirmationMessage"),
      resx.get("Yes"),
      resx.get("No"),
      () => {
  ...
  render() {
    ...
    if (this.isHost()) {
      if (state.basicSearchSettings) {
        const columnOne = (
          <div className="left-column" key="columnOneSearchSettingsPanel">
            <InputGroup>
              <Label
            ...
            <InputGroup>
              ...
              <SingleLineInputWithError
                ...
                errorMessage={resx.get("valMaxResultPerPageRequired.Error")}
                value={state.basicSearchSettings.MaxResultPerPage}
                onChange={this.onSettingChange.bind(this, "MaxResultPerPage")}
                style={{ width: "100%" }}
              />
            </InputGroup>
          </div>
        ...
        const columnTwo = (
          <div className="right-column" key="columnTwoSearchSettingsPanel">
            <DropdownWithError
              style={{ maxWidth: "100%" }}
          ...
          <div className={styles.basicSearchSettings}>
            ...
            <div className="searchIndexWrapper">
              <div className="searchIndexWrapper-left">
                <div className="searchReIndexWarning">
                  {resx.get("MessageReIndexWarning")}
                </div>
                <div className="searchCompactIndexWarning">
                  {resx.get("MessageCompactIndexWarning")}
                </div>
                <InputGroup>
                  <Label
                    labelType="inline"
                ...
                <InputGroup>
                  <Label
                    ...
                    tooltipMessage={resx.get(
                      "lblSearchIndexActiveDocuments.Help",
                    )}
                  ...
                  <Label
                    labelType="inline"
                    label={
                      state.basicSearchSettings.SearchIndexTotalActiveDocuments
                    }
                  />
                </InputGroup>
                <InputGroup>
                  <Label
                    labelType="inline"
                    tooltipMessage={resx.get(
                      "lblSearchIndexDeletedDocuments.Help",
                    )}
                  ...
                  <Label
                    labelType="inline"
                    label={
                      state.basicSearchSettings.SearchIndexTotalDeletedDocuments
                    }
                  />
                </InputGroup>
                <InputGroup>
                  <Label
                    labelType="inline"
                    tooltipMessage={resx.get(
                      "lblSearchIndexLastModifiedOn.Help",
                    )}
                  ...
                  <Label
                    labelType="inline"
                    label={
                      state.basicSearchSettings.SearchIndexLastModifiedOn || "-"
                    }
                  />
                </InputGroup>
                <div className="searchIndexWarning">
                  {resx.get("MessageIndexWarning")}
                </div>
              </div>
...
function mapStateToProps(state) {
  return {
    ...
    basicSearchSettingsClientModified:
      state.search.basicSearchSettingsClientModified,
  };
}
