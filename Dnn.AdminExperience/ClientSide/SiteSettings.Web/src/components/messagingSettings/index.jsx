...
class MessagingSettingsPanelBody extends Component {
  ...
  loadData() {
    ...
    props.dispatch(
      SiteBehaviorActions.getMessagingSettings(props.portalId, (data) => {
        this.setState({
  ...
  onSettingChange(key, event) {
    ...
    props.dispatch(
      SiteBehaviorActions.messagingSettingsClientModified(messagingSettings),
    );
  }
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SiteBehaviorActions.updateMessagingSettings(
...
function mapStateToProps(state) {
  return {
    ...
    messagingSettingsClientModified:
      state.siteBehavior.messagingSettingsClientModified,
  };
}
