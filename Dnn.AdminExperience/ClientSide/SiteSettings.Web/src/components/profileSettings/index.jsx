...
class ProfileSettingsPanelBody extends Component {
  ...
  componentDidUpdate() {
    ...
    if (props.profileSettings) {
      if (
        ...
        props.profileSettings.PortalId === props.portalId
      ) {
        return;
      } else {
        this.loadData();
  ...
  loadData() {
    const { props } = this;
    props.dispatch(
      SiteBehaviorActions.getProfileSettings(props.portalId, (data) => {
        this.setState({
  ...
  onSettingChange(key, event) {
    ...
    props.dispatch(
      SiteBehaviorActions.profileSettingsClientModified(profileSettings),
    );
  }
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SiteBehaviorActions.updateProfileSettings(
      ...
      const columnTwo = (
        <div key="column-two" className="right-column">
          <InputGroup>
            ...
            />
            <div className="VanityUrlPrefix">
              /{resx.get("VanityUrlExample")}
            </div>
          </InputGroup>
          <InputGroup>
            <div className="profileSettings-row_switch">
...
function mapStateToProps(state) {
  return {
    ...
    profileSettingsClientModified:
      state.siteBehavior.profileSettingsClientModified,
  };
}
