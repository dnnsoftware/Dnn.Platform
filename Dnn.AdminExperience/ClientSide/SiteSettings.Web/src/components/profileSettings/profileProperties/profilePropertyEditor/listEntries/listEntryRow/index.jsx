...
class ListEntryRow extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          "collapsible-component-entry" + (opened ? " row-opened" : "")
        }
      >
        <div className={"collapsible-entry " + !opened}>
          <div className={"row"}>
            ...
            <div className="list-item item-row-value">{props.value}</div>
        ...
        <Collapsible
          isOpened={opened}
          className={
            "collapsible-entry-body " +
            (props.enableSortOrder ? "with-sort-order" : "")
          }
        >
