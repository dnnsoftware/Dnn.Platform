...
class ListEntriesPanel extends Component {
  ...
  componentDidMount() {
    ...
    props.dispatch(
      SiteBehaviorActions.getListInfo(props.listName, props.portalId),
    );
  }
  ...
  onUpdateEntry(entryDetail) {
    ...
    props.dispatch(
      SiteBehaviorActions.updateListEntry(
        entry,
        () => {
          util.utilities.notify(
            entry.EntryId
              ? resx.get("ListEntryUpdateSuccess")
              : resx.get("ListEntryCreateSuccess"),
          );
          this.collapse();
          props.dispatch(
            SiteBehaviorActions.getListInfo(props.listName, props.portalId),
  ...
  onDeleteEntry(entryId) {
    ...
    util.utilities.confirm(
      resx.get("ListEntryDeletedWarning"),
      resx.get("Yes"),
      resx.get("No"),
      () => {
        props.dispatch(
          SiteBehaviorActions.deleteListEntry(
            entryId,
            props.portalId,
            () => {
  ...
  onSort(items) {
    const { props } = this;
    props.dispatch(
      SiteBehaviorActions.updateListEntryOrders(
        {
      ...
      <div>
        <div className="list-items">
          <div className="AddItemRow">
            <div className="sectionTitle">{resx.get("ListEntries")}</div>
            <div
