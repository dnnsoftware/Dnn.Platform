...
import { visiblePanel as VisiblePanelActions, siteInfo } from "../actions";
...
class App extends Component {
  constructor() {
    ...
    this.state = {
      ...
      backToReferrerFunc: this.backToReferrer.bind(
        this,
        utilities.settings.backToReferrerFunc,
      ),
      bodyShowing: true,
    };
    ...
    return (
      <div className="siteSettings-app">
        ...
        <PersonaBarPage isOpen={props.selectedPage === 0}>
          <PersonaBarPageHeader
            title={resx.get("nav_SiteSettings")}
          ></PersonaBarPageHeader>
          <Body
            portalId={state.portalId}
            ...
            referrerText={state.referrerText}
            backToReferrerFunc={state.backToReferrerFunc}
            openLanguagePack={this.openPersonaBarPage.bind(
              this,
              Pages.LanguagePack,
            )}
            openLanguageVerifier={this.openPersonaBarPage.bind(
              this,
              Pages.LanguageVerifier,
            )}
            openHtmlEditorManager={this.openPersonaBarPage.bind(
              this,
              Pages.HtmlEditorManager,
            )}
            openLocalizedContent={this.openPersonaBarPage.bind(
              this,
              Pages.LocalizedContent,
            )}
            cultureCode={state.cultureCode}
          />
        </PersonaBarPage>
        ...
        <PersonaBarPage isOpen={props.selectedPage === Pages.HtmlEditorManager}>
          ...
          {props.selectedPage === Pages.HtmlEditorManager && (
            <HtmlEditorManager
              portalId={state.portalId}
              closeHtmlEditorManager={this.closePersonaBarPage.bind(this)}
            />
          )}
        </PersonaBarPage>
        ...
        <PersonaBarPage isOpen={props.selectedPage === Pages.LanguageVerifier}>
          <PersonaBarPageHeader
            title={resx.get("ResourceFileVerifier")}
          ></PersonaBarPageHeader>
          <LanguageVerifier
            portalId={state.portalId}
            closeLanguageVerifier={this.closePersonaBarPage.bind(this)}
          />
        </PersonaBarPage>

        {props.selectedPage === Pages.LanguageEditor && (
          <PersonaBarPage isOpen={props.selectedPage === Pages.LanguageEditor}>
            <PersonaBarPageHeader title={resx.get("LanguageEditor.Header")} />
            <EditLanguagePanel
              portalId={state.portalId}
              backToSiteSettings={this.closePersonaBarPage.bind(this)}
            />
          </PersonaBarPage>
        )}
        ...
        <PersonaBarPage isOpen={props.selectedPage === Pages.LanguagePack}>
          ...
          <LanguagePack
            closeLanguagePack={this.closePersonaBarPage.bind(this)}
          />
        </PersonaBarPage>
        ...
        <PersonaBarPage isOpen={props.selectedPage === Pages.LocalizedContent}>
          ...
          <LocalizedContent
            portalId={state.portalId}
            closePersonaBarPage={this.closePersonaBarPage.bind(this)}
            isOpen={props.selectedPage === Pages.LocalizedContent}
          />
        </PersonaBarPage>

        <PersonaBarPage
          isOpen={props.selectedPage === Pages.TranslatePageContent}
        >
