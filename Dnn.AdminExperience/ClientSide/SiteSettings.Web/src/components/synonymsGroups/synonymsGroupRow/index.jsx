...
class SynonymsGroupRow extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          "collapsible-component-synonyms" +
          (opened ? " row-opened" : "") +
          (this.props.id === "add" ? " row-new-item" : "")
        }
      >
        {props.visible && (
          <div className={"collapsible-header-synonyms " + !opened}>
            <div className={"row"}>
              <div className="synonyms-item item-row-tags">{props.tags}</div>
        ...
        <Collapsible className="synonyms-editor-wrapper" isOpened={opened}>
