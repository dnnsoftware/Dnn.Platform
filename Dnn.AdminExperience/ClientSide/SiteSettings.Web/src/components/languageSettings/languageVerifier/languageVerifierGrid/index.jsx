      ...
      <div>
        <div className="verifier-grid">
          <div className="language-flag">
            <img
              src={props.icon}
              alt={props.language + (props.isDefault ? "**" : "")}
            />
          </div>
          <div className="language-name">
            {props.language + (props.isDefault ? "**" : "")}
          </div>
          {props.isDefault && (
            <div className="default-language">
              {resx.get("systemDefaultLabel")}
            </div>
          )}
        </div>
          ...
          <div className="verifier-grid-body">
            {props.missingFiles.length > 0 && (
              <LanguageVerifierRow
                ...
                id={"MissingFiles"}
              >
                <div className="resx-files">
                  {this.renderBody(props.missingFiles)}
                </div>
              </LanguageVerifierRow>
            )}
            {props.filesWithDuplicateEntries.length > 0 && (
              <LanguageVerifierRow
                text={
                  resx.get("DuplicateEntries") +
                  props.filesWithDuplicateEntries.length
                }
                closeOnClick={true}
                openId={this.state.openId}
                OpenCollapse={this.toggle.bind(this)}
              ...
              >
                <div className="resx-files">
                  {this.renderBody(props.filesWithDuplicateEntries)}
                </div>
              </LanguageVerifierRow>
            )}
            {props.filesWithDuplicateEntries.length > 0 && (
              <LanguageVerifierRow
                text={
                  resx.get("MissingEntries") +
                  props.filesWithMissingEntries.length
                }
                closeOnClick={true}
                openId={this.state.openId}
                OpenCollapse={this.toggle.bind(this)}
              ...
              >
                <div className="resx-files">
                  {this.renderBody(props.filesWithMissingEntries)}
                </div>
              </LanguageVerifierRow>
            )}
            {props.filesWithObsoleteEntries.length > 0 && (
              <LanguageVerifierRow
                text={
                  resx.get("ObsoleteEntries") +
                  props.filesWithObsoleteEntries.length
                }
                closeOnClick={true}
                openId={this.state.openId}
                OpenCollapse={this.toggle.bind(this)}
              ...
              >
                <div className="resx-files">
                  {this.renderBody(props.filesWithObsoleteEntries)}
                </div>
              </LanguageVerifierRow>
            )}
            {props.oldFiles.length > 0 && (
              ...
              >
                <div className="resx-files">
                  {this.renderBody(props.oldFiles)}
                </div>
              </LanguageVerifierRow>
            )}
            {props.malformedFiles.length > 0 && (
              ...
              >
                <div className="resx-files">
                  {this.renderBody(props.malformedFiles)}
                </div>
              </LanguageVerifierRow>
            )}
          </div>
    ...
    return (
      <div>
        <div className={styles.verifierItems}>
          <div className="verifier-items-grid">{this.renderedGrid()}</div>
        </div>
      </div>
    );
  }
