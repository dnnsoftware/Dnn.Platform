...
class LocalizedContent extends Component {
  ...
  onEnable() {
    ...
    props.dispatch(
      LanguagesActions.enableLocalizedContent(
        {
          portalId: props.portalId,
          translatePages: state.allPagesTranslatable,
        },
        (data) => {
          this.setState(data);
  ...
  onUpdateSettings() {
    ...
    props.dispatch(
      LanguagesActions.getLanguageSettings(
        props.languageSettings.PortalId,
        props.languageSettings.CultureCode,
      ),
    );
  }
  ...
  getDefaultLanguage() {
    ...
    return languages.find(
      (l) => l.Code === languageSettings.SiteDefaultLanguage,
    );
  }

  onChange(event) {
    const allPagesTranslatable =
        ...
        <div className="languagePack-wrapper">
              ...
              <div className="language-flag">
                {!!defaultLanguage.Icon && (
                  <img
                    ...
                    alt={defaultLanguage.EnglishName}
                  />
                )}
              </div>
          ...
          {!state.showProgressBars && (
            <div className="buttons-box">
              ...
              <Button type="primary" onClick={this.onEnable.bind(this)}>
                {resx.get("EnableLocalizedContent")}
              </Button>
            </div>
          )}
          {this.state.showProgressBars && (
