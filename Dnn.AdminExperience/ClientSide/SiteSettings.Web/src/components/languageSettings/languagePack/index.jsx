...
class LanguagePackPanelBody extends Component {
  ...
  getTypeOptions() {
    let options = [
      { label: resx.get("Core.LangPackType"), value: "Core" },
  ...
  onCreate(event) {
    ...
    if (
      state.error.name &&
      (state.languagePack.PackType === "Core" ||
        state.languagePack.PackType === "Full")
    ) {
      return;
    }
    ...
    if (
      state.error.module &&
      (state.languagePack.PackType === "Module" ||
    ...
    props.dispatch(
      LanguagesActions.createLanguagePack(
        state.languagePack,
        (data) => {
        ...
        >
          <div className="languagePack-wrapper">
            ...
            {(state.languagePack.PackType === "Module" ||
              ...
              state.languagePack.PackType === "AuthSystem") && (
              <InputGroup>
                <Label label={resx.get("SelectModules")} />
