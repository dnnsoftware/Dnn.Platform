...
import { languages as LanguagesActions } from "../../actions";
...
class LanguageSettingsPanelBody extends Component {
  ...
  allowContentLocalization() {
    const { props } = this;
    return (
      props.languageSettings !== undefined &&
      props.languageSettings.AllowContentLocalization === true
    );
  }
  ...
  loadData() {
    const { props } = this;
    props.dispatch(
      LanguagesActions.getLanguageSettings(
        props.portalId,
        props.cultureCode,
        (data) => {
          this.setState({
  ...
  onSettingChange(key, event) {
    ...
    props.dispatch(
      LanguagesActions.languageSettingsClientModified(languageSettings),
    );
  }
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      LanguagesActions.updateLanguageSettings(
  ...
  disableLocalizedContent() {
    ...
    if (props.languageSettingsClientModified) {
      ...
      props.dispatch(
        LanguagesActions.disableLocalizedContent(props.portalId, () => {
          props.dispatch(
            LanguagesActions.getLanguageSettings(
              props.portalId,
              props.cultureCode,
  ...
  disableLocalizedContentButton() {
    ...
    if (
      this.allowContentLocalization() !==
      props.languageSettings.AllowContentLocalization
    ) {
      return true;
    } else {
      return false;
      ...
      <div className="default-language">
        <div className="language-container">
          <div style={{ float: "left", display: "flex" }}>
            <div className="language-flag">
              <img
                src={props.languageSettings.SystemDefaultLanguageIcon}
                alt={props.languageSettings.SystemDefaultLanguage}
              />
            </div>
            <div className="language-name">
              {props.languageSettings.SystemDefaultLanguage}
            </div>
          </div>
        </div>
      </div>
  ...
  render() {
    ...
    if (props.languageSettings) {
      const columnOne = (
        <div className="left-column" key="language-settings-left-column">
          <InputGroup>
            <Label
      ...
      const columnTwo = (
        <div className="right-column" key="language-settings-right-column">
          <InputGroup>
          ...
          <div
            className={
              "collapsible-button" +
              (this.allowContentLocalization() ||
              props.languageSettings.ContentLocalizationEnabled
                ? " open"
                : "")
            }
          >
      ...
      return (
        <div className={styles.languageSettings}>
          ...
          <div className={this.isHost() ? "buttons-box-alter" : "buttons-box"}>
            ...
            {this.isHost() && (
              <Button type="secondary" onClick={props.openLanguageVerifier}>
                {resx.get("VerifyLanguageResources")}
              </Button>
            )}
            {this.isHost() && (
              <Button type="secondary" onClick={props.openLanguagePack}>
...
function mapStateToProps(state) {
  return {
    ...
    languageSettingsClientModified:
      state.languages.languageSettingsClientModified,
