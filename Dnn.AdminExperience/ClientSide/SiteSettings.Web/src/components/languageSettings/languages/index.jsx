...
class LanguagesPanel extends Component {
  ...
  getHeaderColumns(contentLocalizationEnabled) {
    ...
    if (contentLocalizationEnabled) {
      ...
      tableFields.push({
        name: resx.get("Translated.Header"),
        id: "adv-Translated",
      });
  ...
  onUpdateLanguageRoles(roles) {
    const { props } = this;
    props.dispatch(
      LanguagesActions.updateLanguageRoles(
        roles,
        () => {
          util.utilities.notify(resx.get("LanguageUpdateSuccess"));
          this.collapse();
      ...
      return this.props.languageList.map((item, index) => {
        ...
        return (
          <LanguageRow
            ...
            name={
              this.props.languageDisplayMode === "NATIVE"
                ? item.NativeName
                : item.EnglishName
            }
            code={item.Code}
      ...
      <div>
        <div className="language-items">
          <div className="AddItemRow">
            ...
            {isHost && (
              <div
                ...
                onClick={this.toggle.bind(this, opened ? "" : "add", 1)}
              >
          ...
          <div className="language-items-grid">
            ...
            <Collapsible
              isOpened={opened}
              className={"language-items-grid-body" + (opened ? " opened" : "")}
            >
              <LanguageRow
                name={"-"}
                code={""}
                ...
                contentLocalizationEnabled={
                  this.props.contentLocalizationEnabled
                }
                isDefault={false}
                index={"add"}
