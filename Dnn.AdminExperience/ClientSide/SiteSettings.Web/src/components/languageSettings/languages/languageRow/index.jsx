  ...
  getPagesDisplay(pages, status) {
    if (this.props.id !== "add") {
      if (pages && this.props.isLocalized) {
        return this.props.isLocalized ? (
          <div className="pages-number-status">
      ...
      return (
        ...
        >
          <div className={"collapsible-header-language " + !opened}>
            <div className={"row"}>
              ...
              <div className="language-item item-row-actionButtons item-row-actionButtons-adv">
                {!props.isDefault && (
                  <div
                    className={this.getPageEditorBtnClassName()}
                    onClick={props.onOpenPageList}
                  >
                    <SvgIcons.LanguagesPageIcon />
                  </div>
                )}
                <div
                  className={this.getEditorBtnClassName()}
                ...
                {!props.isDefault && (
                  <div
                    className={this.getTranslatorBtnClassName()}
                ...
                <div
                  className={this.getEditBtnClassName()}
          ...
          {isAddMode && (
            <Collapsible
              autoScroll={true}
              className="collapsible-body-language"
              isOpened={opened}
            >
          ...
          {!isAddMode && (
            <Collapsible
              autoScroll={true}
              className="collapsible-body-language language-permission-grid"
              isOpened={opened}
            >
              {opened && props.children}
            </Collapsible>
