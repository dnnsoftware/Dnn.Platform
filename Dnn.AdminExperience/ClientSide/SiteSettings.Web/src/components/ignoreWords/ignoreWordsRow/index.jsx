...
class IgnoreWordsRow extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          "collapsible-component-ignore-words" + (opened ? " row-opened" : "")
        }
      >
        {props.visible && (
          <div className={"collapsible-header-ignore-words " + !opened}>
            <div className={"row"}>
              <div className="words-item item-row-tags">{props.tags}</div>
        ...
        <Collapsible className="words-editor-wrapper" isOpened={opened}>
