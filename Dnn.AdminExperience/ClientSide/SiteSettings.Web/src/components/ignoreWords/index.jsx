...
class IgnoreWordsPanel extends Component {
  ...
  onUpdateIgnoreWords(words) {
    ...
    if (words.StopWordsId) {
      props.dispatch(
        SearchActions.updateIgnoreWords(
          Object.assign({ PortalId: props.ignoreWords.PortalId }, words),
          () => {
  ...
  onDeleteIgnoreWords(words) {
    ...
    util.utilities.confirm(
      resx.get("IgnoreWordsDeletedWarning"),
      resx.get("Yes"),
      resx.get("No"),
      () => {
        props.dispatch(
          SearchActions.deleteIgnoreWords(
            Object.assign({ PortalId: props.ignoreWords.PortalId }, words),
            () => {
  ...
  onSelectCulture(event) {
    ...
    props.dispatch(
      SearchActions.getIgnoreWords(props.portalId, event.value, (data) => {
        this.setState({
