...
import { siteInfo as SiteInfoActions } from "../../actions";
import {
  InputGroup,
...
class BasicSettingsPanelBody extends Component {
  constructor() {
    ...
    canEdit =
      ...
      util.settings.permissions.SITE_INFO_EDIT;
  }
  ...
  componentDidUpdate() {
    ...
    if (props.basicSettings) {
      ...
      if (
        ...
        props.basicSettings.PortalId === props.portalId
      ) {
      ...
      if (
        ...
        props.basicSettings.CultureCode === props.cultureCode
      ) {
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SiteInfoActions.updatePortalSettings(
        state.basicSettings,
        () => {
  ...
  render() {
    ...
    if (state.basicSettings) {
      ...
      const columnThree = (
        <div key="column-three" className="left-column">
          <InputGroup>
            <Label
            ...
            <FileUpload
              ...
              folderName={
                state.basicSettings.LogoFile
                  ? state.basicSettings.LogoFile.FolderName
                  : null
              }
              ...
              searchFoldersPlaceHolderText={resx.get(
      ...
      const columnFour = (
        <div key="column-four" className="right-column">
          <InputGroup>
            <Label
            ...
            <FileUpload
              ...
              folderName={
                state.basicSettings.FavIcon
                  ? state.basicSettings.FavIcon.FolderName
                  : null
              }
              validationCode={state.basicSettings.ValidationCode}
      ...
      return (
        <div className={styles.basicSettings}>
          ...
          <InputGroup>
            <Label className={"sectionLabel"} label={resx.get("plLogoIcon")} />
          </InputGroup>
          {canEdit && (
