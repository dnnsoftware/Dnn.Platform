      ...
      <div className="links-wrapper">
        ...
        <div className="link-community-wrapper">
          <div
            ...
            title={resx.get("Community.Header")}
            onClick={this.onCommunityClick.bind(this)}
          >
            <div className="dnn-icon">
              <DnnIcon />
            </div>
            <div className="link-community-header">
        ...
        <div className="link-github-wrapper">
          <div
            ...
            title={resx.get("GitHub.Header")}
            onClick={this.onGitHubClick.bind(this)}
          >
            <div className="github-icon">
              <GithubIcon />
            </div>
            <div className="link-github-header">
    ...
    return (
      <div className={styles.licensingPlatform}>
        <div>
          {this.renderVersion()}
          <div className="intro">
            <div className="dnn-technology-editorial-icon">
