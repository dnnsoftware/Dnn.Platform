...
const rolesActions = {
  getRoleGroupsList(reload, callback) {
    return (dispatch) => {
      ApplicationService.getRoleGroups(
        reload,
        (data) => {
          dispatch({
  ...
  saveRoleGroup(group, callback) {
    return (dispatch) => {
      ApplicationService.saveRoleGroup(
        group,
        (data) => {
          dispatch({
  ...
  deleteRoleGroup(group, callback) {
    return (dispatch) => {
      ApplicationService.deleteRoleGroup(
        group,
        (data) => {
          dispatch({
