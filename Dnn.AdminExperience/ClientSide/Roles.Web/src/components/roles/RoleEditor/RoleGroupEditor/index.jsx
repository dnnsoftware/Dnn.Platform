...
class RoleGroupEditor extends Component {
  ...
  handleClick(event) {
    ...
    if (
      ...
      typeof event.target.firstChild.className === "string" &&
      event.target.firstChild.className.indexOf("do-not-close") === -1
    ) {
  ...
  onSave(e) {
    ...
    if (this.validateForm()) {
      props.dispatch(
        RolesActions.saveRoleGroup(state.group, (group) => {
            ...
            <div className="form-items">
              <div className="form-item">
                <SingleLineInputWithError
                  ...
                  label={resx.get("GroupName")}
                  tooltipMessage={resx.get("GroupName.Help")}
                  errorMessage={resx.get("GroupName.Help")}
                  autoComplete="off"
              ...
              <div className="form-item">
                <Label
                  label={resx.get("GroupDescription")}
                  tooltipMessage={resx.get("GroupDescription.Help")}
                  tooltipPlace={"top"}
                />
                <MultiLineInput
