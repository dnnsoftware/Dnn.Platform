...
import NoDataIcon from "./../SvgIcon/nodata.svg";
import "./style.less";
...
class ThemeList extends Component {
  ...
  render() {
    ...
    let siteThemes = props.dataSource.filter(
      (t) => t.level === 1 || t.level === 2,
    );
    return (
      <div className="theme-list-wrapper">
        {globalThemes.length === 0 && siteThemes.length === 0 && (
          <div className="empty-state">
            ...
            <div className="noThemesMessage">
              {Localization.get("NoThemesMessage")}
            </div>
            <div className="noThemesIcon">
              <NoDataIcon />
            </div>
          </div>
        )}
