  ...
  onThemeChanged(themeName) {
    ...
    this.setState(
      ...
      function () {
        ...
        props.dispatch(
          ThemeActions.getEditableThemeFiles(themeName, type, level),
        );
      },
    );
  }
  ...
  render() {
    ...
    return (
      <div className="edit-theme-attributes">
        <Button size="small" onClick={this.startEdit.bind(this)}>
          {Localization.get("EditThemeAttributes")}
        </Button>
        <Collapsible
          isOpened={state.openEditPopup}
          theme={{
            collapse: "edit-popup ReactCollapse--collapse",
          ...
          <div className="edit-popup-body">
            ...
            <GridCell>
              ...
              <GridCell columnSize={50} className="right-column">
                <RadioButtons
                  options={[
                    { value: "layout", label: Localization.get("Layout") },
                    {
                      value: "container",
