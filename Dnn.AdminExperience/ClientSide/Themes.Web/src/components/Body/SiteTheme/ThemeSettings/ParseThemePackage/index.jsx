...
class ParseThemePackage extends Component {
  ...
  parseLayout() {
    ...
    let self = this;
    props.dispatch(
      ThemeActions.parseTheme(themeName, parseType, function () {
  ...
  render() {
    ...
    return (
      <div className="parse-theme-package">
        ...
        >
          {Localization.get("ParseThemePackage")}
        </Button>
        <RadioButtons
          options={[
            { value: "localized", label: Localization.get("Localized") },
            { value: "portable", label: Localization.get("Portable") },
          ]}
