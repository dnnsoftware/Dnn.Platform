...
class ThemeFileList extends Component {
  ...
  parseProps(props) {
    ...
    let themeName =
      props.type == 0
        ? props.theme.SiteLayout.themeName
        : props.theme.SiteContainer.themeName;
    let path =
      props.type == 0
        ? props.theme.SiteLayout.path
        : props.theme.SiteContainer.path;
  ...
  getListWidth() {
    ...
    props.themeFiles[props.type].forEach((themeFile) => {
      width +=
        self.selectedAsSite(themeFile) || self.selectedAsEdit(themeFile)
          ? 108
          : 90;
    });
  ...
  loadThemeFiles() {
    ...
    props.dispatch(
      ThemeActions.getCurrentThemeFiles(
        state.themeName,
        props.type,
        state.level,
      ),
