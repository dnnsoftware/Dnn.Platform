...
export default function theme(
  ...
  switch (action.type) {
    case ActionTypes.RETRIEVED_CURRENT_THEMES:
      return { ...state, currentTheme: action.data.currentTheme };
    case ActionTypes.RETRIEVED_CURRENT_THEMEFILES: {
      ...
      return { ...state, currentThemeFiles: currentThemeFiles };
    }
    ...
    case ActionTypes.RETRIEVED_EDITABLE_THEMEFILES:
      return { ...state, editableThemeFiles: action.data.themeFiles };
    case ActionTypes.RETRIEVED_EDITABLE_TOKENS:
      return { ...state, editableTokens: action.data.tokens };
    case ActionTypes.RETRIEVED_EDITABLE_SETTINGS:
      return { ...state, editableSettings: action.data.settings };
    case ActionTypes.RETRIEVED_EDITABLE_VALUES:
      return { ...state, editableValue: action.data.values };
    ...
    case ActionTypes.DELETE_THEME: {
      ...
      return { ...state, themes: { layouts: layouts, containers: containers } };
    }
    default:
      return { ...state };
  }
