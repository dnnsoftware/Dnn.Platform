...
class GridCaption extends Component {
  ...
  render() {
    ...
    return (
      <GridCell className="grid-caption">
        <Label
          className="title"
          label={
            props.type === "role"
              ? props.localization.permissionsByRole
              : props.localization.permissionsByUser
          }
        ></Label>
        {props.type === "role" && (
        ...
        <GridCell columnSize="40" className="right">
          <Suggestion
            ...
            localization={{
              add:
                props.type === "role"
                  ? props.localization.addRole
                  : props.localization.addUser,
              placeHolder:
                props.type === "role"
                  ? props.localization.addRolePlaceHolder
                  : props.localization.addUserPlaceHolder,
            }}
