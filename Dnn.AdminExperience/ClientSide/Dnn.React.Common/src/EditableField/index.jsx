...
class EditableField extends Component {
  ...
  getEditableLabelClass() {
    ...
    let inputTypeClass =
      props.inputType === "textArea" ? " textArea" : " singleLine";
  ...
  getEditButton() {
    return (
      <div className="edit-button" onClick={this.toggleEditMode.bind(this)}>
        <EditIcon />
      </div>
    );
  }
  ...
  render() {
    ...
    return (
      <div className={editableLabelClass}>
        <label className="editable-label" htmlFor={refs.input}>
          {props.label}
        </label>
        ...
        <div className="editable-input">
          ...
          <span className="help-text">
            {props.helpText || "Press ENTER when done, or ESC to cancel"}
          </span>
        </div>
      </div>
    );
