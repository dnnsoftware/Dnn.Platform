...
export default class FolderPicker extends Component {
  ...
  render() {
    const selectedFolderText = this.props.selectedFolder
      ? this.props.selectedFolder.value
      ...
      <div className="drop-down" ref={(node) => (this.node = node)}>
        ...
        <div
          className={
            ...
            (this.state.showFolderPicker ? " show" : "")
          }
        >
          <div className="inner-box">
            <div className="search">
              <input
                ...
                placeholder={this.props.searchFoldersPlaceHolderText}
                aria-label="Search"
              />
