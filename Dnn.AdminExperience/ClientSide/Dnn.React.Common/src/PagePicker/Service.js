...
class Service {
  ...
  getPortalTabs(portalTabsParameters, callback, errorCallback) {
    sf.get(
      "GetPortalTabs?" + serializeQueryStringParameters(portalTabsParameters),
      {},
      callback,
      errorCallback,
    );
  ...
  getPortalTab(portalTabParameters, callback, errorCallback) {
    sf.get(
      "GetPortalTab?" + serializeQueryStringParameters(portalTabParameters),
      {},
      callback,
      errorCallback,
    );
  ...
  getTabsDescendants(portalTabsParameters, callback, errorCallback) {
    sf.get(
      "GetTabsDescendants?" +
        serializeQueryStringParameters(portalTabsParameters),
      {},
      callback,
      errorCallback,
    );
  ...
  searchPortalTabs(portalTabsSearchParameters, callback, errorCallback) {
    sf.get(
      "SearchPortalTabs?" +
        serializeQueryStringParameters(portalTabsSearchParameters),
      {},
      callback,
      errorCallback,
    );
