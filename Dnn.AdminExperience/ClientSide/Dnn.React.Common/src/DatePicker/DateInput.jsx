...
export default class DateInput extends Component {
  constructor(props) {
    ...
    const month = this.props.date
      ? this.addZero(this.props.date.getMonth() + 1)
      : "";
    ...
    const hours = this.props.date
      ? this.getHour(this.props.date.getHours())
      : "";
    const minutes = this.props.date
      ? this.addZero(this.props.date.getMinutes())
      : "";
    const period = this.props.date
      ? this.getPeriod(this.props.date.getHours())
  ...
  componentDidUpdate(prevProps) {
    ...
    if (props.date !== prevProps.date) {
      ...
      const period = props.date
        ? this.getPeriod(props.date.getHours())
        : this.getPeriod(false);
  ...
  updateValue(key, e) {
    ...
    if (
      ...
      (key !== "year" && e.target.value.length > 2)
    ) {
      return;
    }
  ...
  render() {
    const className =
      "date-input" + (this.props.hasTimePicker ? " with-time-picker" : "");
    return (
      <div className={className}>
        <input
          type="text"
          value={this.state.month}
          onBlur={this.setMonth.bind(this)}
          onChange={this.updateValue.bind(this, "month")}
          placeholder="MM"
          aria-label="Month"
        />
        <span>/</span>
        <input
          ...
          onBlur={this.setDay.bind(this)}
          onChange={this.updateValue.bind(this, "day")}
          placeholder="DD"
          aria-label="Day"
        />
        <span>/</span>
        <input
          ...
          onBlur={this.setYear.bind(this)}
          onChange={this.updateValue.bind(this, "year")}
          placeholder="YYYY"
          aria-label="Year"
        />
        {this.props.hasTimePicker && (
          <div>
            ...
            <input
              ...
              onBlur={this.setHours.bind(this)}
              onChange={this.updateValue.bind(this, "hours")}
              placeholder="hh"
              aria-label="Hour"
            />
            <span>: </span>
            <input
              ...
              onBlur={this.setMinutes.bind(this)}
              onChange={this.updateValue.bind(this, "minutes")}
              placeholder="mm"
              aria-label="Minute"
            />
            <span>&nbsp; </span>
            <div
              ...
              onClick={this.setPeriod.bind(this)}
            >
