...
storiesOf("Label", module).add("simple label", () => <Label label="Test" />);
...
storiesOf("Label", module).add("Reproduces issue", () => (
  <div style={{ paddingTop: 100, paddingLeft: 100 }}>
    <p>
      This case reproduces the issue identified in <br />
      <a href="https://github.com/dnnsoftware/Dnn.AdminExperience/pull/320">
        https://github.com/dnnsoftware/Dnn.AdminExperience/pull/320
      </a>
      <br /> and <br />
      <a href="https://github.com/romainberger/react-portal-tooltip/issues/84">
        https://github.com/romainberger/react-portal-tooltip/issues/84
      </a>
    </p>
    <Label
      label="Some field label:"
      ...
      tooltipMessage={[
        ...
        "it should show as a list",
        "and be on the bottom right",
      ]}
      tooltipPlace="top"
    />
  </div>
