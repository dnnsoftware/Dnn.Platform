...
class Tags extends Component {
  ...
  internalAddTag(newTagText) {
    ...
    if (
      !this.props.tags.find(
        (t) => t.toUpperCase().trim() === newTagText.toUpperCase().trim(),
      )
    ) {
  ...
  render() {
    ...
    if (typeof this.props.renderItem === "function") {
      Tags = this.props.tags.map((tag, index) => {
        return this.props.renderItem(
          tag,
          index,
          this.removeTagByName.bind(this, tag),
          this.props.enabled,
        );
      });
    } else {
      Tags = this.props.tags.map((tag, index) => {
        return (
          <Tag
            tag={tag}
            key={index}
            onRemove={this.removeTagByName.bind(this, tag)}
    ...
    const typingText = this.props.autoSuggest
      ? this.props.searchTagsPlaceholder
      : this.props.addTagsPlaceholder;
    return (
      <div
        className={className}
