...
export default class Checkbox extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          "dnn-checkbox-container " +
          (props.labelPlace ? "align-" + props.labelPlace : "") +
      ...
      >
        ...
        <div
          className={className}
          style={Object.assign(checkBoxStyle, props.style)}
        >
          <input
            type="checkbox"
            id={this.id}
          ...
          />
          <label htmlFor={this.id} onClick={this.onClick.bind(this)}>
            Check
          </label>
        </div>
