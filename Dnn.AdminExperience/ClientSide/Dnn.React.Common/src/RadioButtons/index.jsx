...
class RadioButtons extends Component {
  ...
  render() {
    ...
    const tooltipMessages =
      props.tooltipMessage instanceof Array
    ...
    const buttons = props.options.map((button) => {
      const uniqueKey =
        ...
        button.value;
      const checked =
        (button.value && button.value.toString()) ===
        (state.value && state.value.toString());
      const radioButtonClass =
        (props.disabled ? "disabled" : "") + (checked ? " checked" : "");
      return (
        <li
          key={uniqueKey}
        ...
        >
          ...
          <label htmlFor={uniqueKey} disabled={props.disabled}>
            {button.label}
          </label>
        </li>
      );
