...
export default function logSettings(
  ...
  switch (action.type) {
    case ActionTypes.RETRIEVED_KEEPMOSTRECENT_OPTIONS:
      return {
        ...state,
        keepMostRecentOptions: createKeepMostRecentOptions(
          action.data.keepMostRecent,
        ),
      };
    case ActionTypes.RETRIEVED_OCCURRENCE_OPTIONS: {
      ...
      return {
        ...
        notificationTimeTypesOptions:
          occurrenceOptions.notificationTimeTypesOptions,
      };
    }
    case ActionTypes.RETRIEVED_LOGSETTING_LIST:
      return { ...state, logSettingList: action.data.logSettingList };
    case ActionTypes.RETRIEVED_LOGSETTING_BY_ID:
      return { ...state, logSettingDetail: action.data.logSettingDetail };
    case ActionTypes.UPDATED_LOGSETTING: {
      let logSettingList = Object.assign([], state.logSettingList);
      return {
        ...state,
        logSettingList: updateLogSettingList(
          logSettingList,
          action.data.logSettingDetail,
        ),
      };
    }
    case ActionTypes.DELETED_LOGSETTING: {
      ...
      return {
        ...state,
        logSettingList: removeLogSetting(
          logSettingList,
          action.data.LogSettingId,
        ),
      };
    }
