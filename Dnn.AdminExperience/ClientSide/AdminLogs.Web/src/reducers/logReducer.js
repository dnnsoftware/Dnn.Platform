...
export default function logList(
  ...
  switch (action.type) {
    ...
    case ActionTypes.RETRIEVED_PORTAL_LIST:
      return { ...state, portalList: action.data.portalList };
    case ActionTypes.RETRIEVED_LOGTYPE_LIST:
      return { ...state, logTypeList: action.data.logTypeList };
    ...
    case ActionTypes.SELECTED_ROW:
      return {
        ...
        excludedRowIds: state.excludedRowIds.filter(
          (id) => id != action.data.rowId,
        ),
      };
