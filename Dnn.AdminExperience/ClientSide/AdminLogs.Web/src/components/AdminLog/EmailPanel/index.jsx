...
class EmailPanel extends Component {
  ...
  onSendEmail(event) {
    ...
    props.dispatch(
      LogActions.emailLogItems(state.emailRequest, (data) => {
  ...
  validateEmail(value) {
    ...
    return value
      .split(/[ ,;]+/)
      .every((v) => re.test(v) || v.trim().length === 0);
  }
  ...
  render() {
    ...
    return (
      <div className="collapsible-content-email">
        <Collapse className={props.className} isOpened={props.isOpened}>
          <div>
            <div
            ...
            >
              <div className="">
                ...
                <div className="action-buttons">
                  ...
                  <Button type="primary" onClick={this.onSendEmail.bind(this)}>
                    {Localization.get("btnSend")}
                  </Button>
                </div>
              </div>
            </div>
