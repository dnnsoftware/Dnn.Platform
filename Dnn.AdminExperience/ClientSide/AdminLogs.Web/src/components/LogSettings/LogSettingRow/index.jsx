      ...
      >
        {props.visible && (
          <div className={"collapsible-header-log " + !opened}>
            ...
            <GridCell columnSize={20}>{props.website}</GridCell>
            <GridCell columnSize={15}>{props.activeStatus}</GridCell>
            <GridCell columnSize={20}>{props.fileName}&nbsp; </GridCell>
            {!props.readOnly && (
        ...
        <Collapse isOpened={opened} className="collapsible-body-log">
