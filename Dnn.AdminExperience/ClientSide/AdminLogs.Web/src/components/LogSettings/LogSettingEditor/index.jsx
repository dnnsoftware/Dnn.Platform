...
import { logSettings as LogSettingActions } from "../../../actions";
...
class LogSettingEditor extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    if (props.logTypeSettingId !== "") {
      props.dispatch(
        LogSettingActions.getLogSettingById(
          {
  ...
  getValue(selectKey) {
    ...
    switch (selectKey) {
      case "LogType":
        return state.logSettingDetail.LogTypeKey !== undefined
          ? state.logSettingDetail.LogTypeKey.toString()
          : "*";
      case "Website":
        return state.logSettingDetail.LogTypePortalID !== "-1"
          ? state.logSettingDetail.LogTypePortalID.toString() == "*"
            ? "-1"
            : state.logSettingDetail.LogTypePortalID.toString()
          : this.props.portalList[0].value.toString();
      case "Recent":
        return state.logSettingDetail.KeepMostRecent !== undefined &&
          state.logSettingDetail.KeepMostRecent > 0
          ? state.logSettingDetail.KeepMostRecent.toString()
          : "*";
      case "Threshold":
        return state.logSettingDetail.NotificationThreshold !== undefined &&
          state.logSettingDetail.NotificationThreshold > 0
          ? state.logSettingDetail.NotificationThreshold.toString()
          : "1";
      case "ThresholdNotificationTime":
        return state.logSettingDetail.NotificationThresholdTime !== undefined &&
          state.logSettingDetail.NotificationThresholdTime > 0
          ? state.logSettingDetail.NotificationThresholdTime.toString()
          : "1";
      case "ThresholdNotificationTimeType":
        return state.logSettingDetail.NotificationThresholdTimeType !==
          undefined && state.logSettingDetail.NotificationThresholdTimeType > 0
          ? state.logSettingDetail.NotificationThresholdTimeType.toString()
          : "1";
      case "MailFromAddress":
        return state.logSettingDetail.MailFromAddress !== undefined
          ? state.logSettingDetail.MailFromAddress.toString()
          : "";
      case "MailToAddress":
        return state.logSettingDetail.MailToAddress !== undefined
          ? state.logSettingDetail.MailToAddress.toString()
          : "";
      default:
        break;
    }
  ...
  getEnabledStatus(key) {
    ...
    switch (key) {
      case "EmailNotification":
        return state.logSettingDetail.EmailNotificationIsActive !== undefined
          ? state.logSettingDetail.EmailNotificationIsActive
          : false;
      case "Logging":
        return state.logSettingDetail.LoggingIsActive !== undefined
          ? state.logSettingDetail.LoggingIsActive
          : false;
      default:
        break;
    }
  ...
  addUpdateLogSetting(event) {
    ...
    if (state.formModified) {
      ...
      if (props.logTypeSettingId !== "") {
        props.dispatch(
          LogSettingActions.updateLogSetting(
            logSettingDetail,
            () => {
        ...
        props.dispatch(
          LogSettingActions.addLogSetting(
            logSettingDetail,
            () => {
  ...
  deleteLogSetting(event) {
    ...
    if (props.logTypeSettingId !== "") {
      util.utilities.confirm(
        Localization.get("ConfigDeletedWarning"),
        Localization.get("yes"),
        Localization.get("no"),
        () => {
          props.dispatch(
            LogSettingActions.deleteLogSetting(
              { LogTypeConfigId: props.logTypeSettingId },
              () => {
  ...
  render() {
    const portalList =
      this.props.portalList !== undefined &&
      this.props.portalList.map((log) => {
        return {
          label: log.label,
    ...
    const columnOne = (
      <div className="editor-container left-column">
        <div className="title-row divider">{Localization.get("Settings")}</div>
        ...
        <div
          ...
          title={Localization.get("plLogTypeKey.Help")}
        >
        ...
        <div
          className="editor-row divider"
          title={Localization.get("plLogTypePortalID.Help")}
        >
    ...
    const columnTwo = (
      <div className="editor-container">
        ...
        <div className="status-row divider">
          <div
            className="left"
            title={Localization.get("plEmailNotificationStatus.Help")}
          >
        ...
        <div
          className="editor-row divider"
          title={Localization.get("plMailToAddress.Help")}
        >
      ...
      <div className="log-setting-editor">
        ...
        <div className="buttons-box">
          {this.props.logTypeSettingId !== "" && (
            <Button type="secondary" onClick={this.deleteLogSetting.bind(this)}>
              {Localization.get("ConfigBtnDelete")}
            </Button>
          )}
          <Button type="secondary" onClick={this.props.Collapse.bind(this)}>
            {Localization.get("ConfigBtnCancel")}
          </Button>
          <Button type="primary" onClick={this.addUpdateLogSetting.bind(this)}>
            {Localization.get("ConfigBtnSave")}
          </Button>
        </div>
      </div>
    );
