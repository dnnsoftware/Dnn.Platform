...
class ApplicationService {
  ...
  getTaskStatusList(searchParameters, callback) {
    ...
    sf.getsilence(
      "GetScheduleStatus?" + serializeQueryStringParameters(searchParameters),
      {},
      callback,
    );
  }
  ...
  getScheduleItemHistory(searchParameters, callback) {
    ...
    sf.get(
      "GetScheduleItemHistory?" +
        serializeQueryStringParameters(searchParameters),
      {},
      callback,
    );
  }
  ...
  getScheduleItems(searchParameters, callback) {
    ...
    sf.get(
      "GetScheduleItems?" + serializeQueryStringParameters(searchParameters),
      {},
      callback,
    );
  }
  ...
  getGetScheduleItem(searchParameters, callback) {
    ...
    sf.get(
      "GetScheduleItem?" + serializeQueryStringParameters(searchParameters),
      {},
      callback,
    );
  }
