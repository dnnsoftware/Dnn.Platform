...
class SchedulerRow extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          "collapsible-component-scheduler" + (opened ? " row-opened" : "")
        }
      >
          ...
          <div className={"row"}>
            ...
            {props.id !== "add" && (
              <div className="schedule-item item-row-historyButton">
                <div
                  className={
                    opened && props.panelIndex === 1
                      ? "history-icon-active"
                      : "history-icon"
                  }
                  title={resx.get("ControlTitle_history")}
            ...
            <div className="schedule-item item-row-editButton">
              <div
                className={
                  opened && props.panelIndex === 0
                    ? "edit-icon-active"
                    : "edit-icon"
                }
                title={resx.get("ControlTitle_edit")}
        ...
        <Collapsible
          autoScroll={true}
          isOpened={opened}
          className="collapsible-body-scheduler"
        >
