...
class ModePanel extends Component {
  ...
  onSave(event) {
    ...
    props.dispatch(
      TaskActions.updateSchedulerSettings(
        state.updateRequest,
        () => {
  ...
  onValueChange(key, event) {
    ...
    if (!re.test(updateRequest[key]) && key === "SchedulerdelayAtAppStart") {
      ...
      re.test(updateRequest[key]) &&
      key === "SchedulerdelayAtAppStart"
    ) {
  ...
  render() {
    ...
    return (
      ...
      >
        <Collapsible className={props.className} isOpened={props.isOpened}>
              ...
              <div className="">
                ...
                <div className="editor-row divider">
                  ...
                  <SingleLineInputWithError
                    ...
                    withLabel={false}
                    error={
                      this.state.error.schedulerDelay &&
