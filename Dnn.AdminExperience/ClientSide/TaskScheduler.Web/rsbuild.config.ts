  ...
  output: {
    ...
    distPath: {
      root: useWebsitePath
        ? path.join(
            websitePath,
            "DesktopModules/Admin/Dnn.PersonaBar/Modules/Dnn.TaskScheduler/"
          )
        : "../../Dnn.PersonaBar.Extensions/admin/personaBar/Dnn.TaskScheduler/",
      js: "scripts/bundles/",
      css: "css/",
      html: "",
    },
    filename: {
      js: "task-scheduler-bundle.js",
      css: "TaskScheduler.css",
    },
    legalComments: "none",
  },
  performance: {
