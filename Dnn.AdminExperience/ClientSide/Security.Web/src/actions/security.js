...
const securityActions = {
  ...
  deleteIpFilter(filterId, ipFilters, callback) {
    return (dispatch) => {
      ApplicationService.deleteIpFilter(
        filterId,
        (data) => {
          dispatch({
      ...
      ApplicationService.getRegistrationSettings((data) => {
        dispatch({
          ...
          data: {
            ...
            registrationFormTypeOptions:
              data.Results.RegistrationFormTypeOptions,
  ...
  updateRegistrationSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateRegistrationSettings(
        payload,
        (data) => {
          dispatch({
  ...
  updateSslSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateSslSettings(
        payload,
        (data) => {
          dispatch({
  ...
  setAllPagesSecure(callback, failureCallback) {
    ApplicationService.setAllPagesSecure(
      (data) => {
        if (callback) {
          callback(data);
        }
  ...
  getSecurityBulletins(callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.getSecurityBulletins(
        (data) => {
          dispatch({
  ...
  searchFileSystemAndDatabase(searchParameters, callback) {
    return (dispatch) => {
      ApplicationService.searchFileSystemAndDatabase(
        searchParameters,
        (data) => {
          dispatch({
