...
export default function securitySettings(state = {}, action) {
  switch (action.type) {
    ...
    case ActionTypes.DELETED_SECURITY_IP_FILTER:
      return { ...state, ipFilters: action.data.ipFilters };
    case ActionTypes.RETRIEVED_SECURITY_IP_FILTER:
      return { ...state, ipFilter: action.data.ipFilter };
    ...
    case ActionTypes.RETRIEVED_SECURITY_SUPERUSER_ACTIVITIES:
      return { ...state, activities: action.data.activities };
    case ActionTypes.RETRIEVED_SECURITY_AUDITCHECK_RESULTS:
      return { ...state, auditCheckResults: action.data.auditCheckResults };
    case ActionTypes.RETRIEVED_SECURITY_AUDITCHECK_RESULT: {
      let result = action.data.auditCheckResult;
      let curentResults = Object.assign(
        [],
        JSON.parse(JSON.stringify(state.auditCheckResults)),
      );
      ...
      return { ...state, auditCheckResults: curentResults };
    }
    ...
    case ActionTypes.SECURITY_BASIC_LOGIN_SETTINS_CLIENT_MODIFIED:
      return {
        ...
        basicLoginSettingsClientModified:
          action.data.basicLoginSettingsClientModified,
      };
    ...
    case ActionTypes.SECURITY_REGISTRATION_SETTINS_CLIENT_MODIFIED:
      return {
        ...
        registrationSettingsClientModified:
          action.data.registrationSettingsClientModified,
      };
