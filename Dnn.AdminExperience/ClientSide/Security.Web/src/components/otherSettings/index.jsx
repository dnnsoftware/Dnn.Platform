...
class OtherSettingsPanelBody extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    props.dispatch(
      SecurityActions.getOtherSettings((data) => {
  ...
  UNSAFE_componentWillReceiveProps(props) {
    ...
    let autoAccountUnlockDuration =
      props.otherSettings["AutoAccountUnlockDuration"];
    if (
      autoAccountUnlockDuration === "" ||
      !re.test(autoAccountUnlockDuration)
    ) {
  ...
  onSettingChange(key, event) {
    ...
    if (!re.test(otherSettings[key]) && key === "AutoAccountUnlockDuration") {
      ...
      re.test(otherSettings[key]) &&
      key === "AutoAccountUnlockDuration"
    ) {
      state.error["autoAccountUnlockDuration"] = false;
    }
    ...
    if (
      key === "MaxUploadSize" &&
      !this.isMaxUploadSizeValid(otherSettings[key])
    ) {
      state.error["maxUploadSize"] = true;
    } else if (
      key === "MaxUploadSize" &&
  ...
  onUpdate(event) {
    ...
    if (
      state.error.autoAccountUnlockDuration ||
      state.error.asyncTimeout ||
      state.error.maxUploadSize
    ) {
      return;
    }
    ...
    props.dispatch(
      SecurityActions.updateOtherSettings(
        parameters,
        () => {
  ...
  onCancel() {
    ...
    util.utilities.confirm(
      resx.get("OtherSettingsRestoreWarning"),
      resx.get("Yes"),
      resx.get("No"),
      () => {
        props.dispatch(
        ...
        <div className={styles.otherSettings}>
            ...
            <div className="otherSettings-row_switch">
              <Label
                ...
                tooltipMessage={resx.get(
                  "plAllowOverrideThemeViaQueryString.Help",
                )}
          ...
          <InputGroup>
            ...
            <SingleLineInputWithError
              withLabel={false}
              error={
                this.state.error.autoAccountUnlockDuration &&
          ...
          <InputGroup>
            ...
            <SingleLineInputWithError
              ...
              errorMessage={resx
                .get("maxUploadSize.Error")
                .replace("{0}", state.otherSettings.RangeUploadSize)}
          ...
          <InputGroup>
            <Label
              tooltipMessage={resx.get(
                "plDefaultEndUserExtensionWhitelist.Help",
              )}
