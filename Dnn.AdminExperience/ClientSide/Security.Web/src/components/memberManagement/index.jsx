...
class MemberManagementPanelBody extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    props.dispatch(
      SecurityActions.getMemberSettings((data) => {
  ...
  updateMemberSettings(memberSettings) {
    ...
    let { state } = this;
    let membershipResetLinkValidity =
      memberSettings["MembershipResetLinkValidity"];
    if (
      membershipResetLinkValidity === "" ||
      !re.test(membershipResetLinkValidity)
    ) {
    ...
    let adminMembershipResetLinkValidity =
      memberSettings["AdminMembershipResetLinkValidity"];
    if (
      adminMembershipResetLinkValidity === "" ||
      !re.test(adminMembershipResetLinkValidity)
    ) {
    ...
    if (
      ...
      !re2.test(membershipNumberPasswords)
    ) {
    ...
    let membershipDaysBeforePasswordReuse =
      memberSettings["MembershipDaysBeforePasswordReuse"];
    if (
      membershipDaysBeforePasswordReuse === "" ||
      !re2.test(membershipDaysBeforePasswordReuse)
    ) {
    ...
    if (passwordExpiryReminder === "" || !re2.test(passwordExpiryReminder)) {
      ...
      re2.test(passwordExpiryReminder)
    ) {
  ...
  onSettingChange(key, event) {
    ...
    props.dispatch(
      SecurityActions.memberSettingsClientModified(memberSettings),
    );
  }
  ...
  onUpdate(event) {
    ...
    if (
      state.error.membershipResetLinkValidity ||
    ...
    props.dispatch(
      SecurityActions.updateMemberSettings(
        parameters,
        () => {
  ...
  onCancel() {
    ...
    util.utilities.confirm(
      resx.get("MemberSettingsRestoreWarning"),
      resx.get("Yes"),
      resx.get("No"),
      () => {
        props.dispatch(
        ...
        <div className={styles.memberSettings}>
          <InputGroup>
            ...
            <SingleLineInputWithError
              withLabel={false}
              error={
                this.state.error.membershipResetLinkValidity &&
                this.state.triedToSubmit
              }
              errorMessage={resx.get(
                "MembershipResetLinkValidity.ErrorMessage",
              )}
          ...
          <InputGroup>
            ...
            <SingleLineInputWithError
              withLabel={false}
              error={
                this.state.error.adminMembershipResetLinkValidity &&
                this.state.triedToSubmit
              }
              errorMessage={resx.get(
                "AdminMembershipResetLinkValidity.ErrorMessage",
              )}
          ...
          <InputGroup>
            ...
            <SingleLineInputWithError
              withLabel={false}
              error={
                this.state.error.membershipNumberPasswords &&
                this.state.triedToSubmit
              }
          ...
          <InputGroup>
            ...
            <SingleLineInputWithError
              withLabel={false}
              error={
                this.state.error.membershipDaysBeforePasswordReuse &&
                this.state.triedToSubmit
              }
              errorMessage={resx.get(
                "MembershipDaysBeforePasswordReuse.ErrorMessage",
              )}
            ...
            >
              <Label
                ...
                tooltipMessage={resx.get(
                  "plForceLogOutAfterPasswordChanged.Help",
                )}
          ...
          <InputGroup>
            ...
            <SingleLineInputWithError
              withLabel={false}
              error={
                this.state.error.passwordExpiry && this.state.triedToSubmit
              }
          ...
          <InputGroup>
            <Label
              tooltipMessage={resx.get(
                "PasswordConfig_PasswordExpiryReminder.Help",
              )}
            ...
            <SingleLineInputWithError
              withLabel={false}
              error={
                this.state.error.passwordExpiryReminder &&
                this.state.triedToSubmit
              }
