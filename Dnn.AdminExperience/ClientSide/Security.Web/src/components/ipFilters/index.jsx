...
class IpFiltersPanelBody extends Component {
  ...
  onUpdateIpFilter(ipFilter) {
    ...
    props.dispatch(
      SecurityActions.updateIpFilter(
        ipFilter,
        () => {
  ...
  onDeleteIpFilter(ipFilterId) {
    ...
    util.utilities.confirm(
      resx.get("IpFilterDeletedWarning"),
      resx.get("Yes"),
      resx.get("No"),
      () => {
        const itemList = props.ipFilters.filter(
          (item) => item.IPFilterID !== ipFilterId,
        );
        props.dispatch(
          SecurityActions.deleteIpFilter(
            ipFilterId,
            itemList,
            () => {
