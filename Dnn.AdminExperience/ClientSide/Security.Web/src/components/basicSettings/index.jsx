...
class BasicSettingsPanelBody extends Component {
  constructor() {
    ...
    canEdit =
      ...
      util.settings.permissions.BASIC_LOGIN_SETTINGS_EDIT;
  }
  ...
  UNSAFE_componentWillMount() {
    ...
    props.dispatch(
      SecurityActions.getBasicLoginSettings(props.cultureCode, (data) => {
  ...
  onSettingChange(key, event) {
    ...
    if (
      key === "RedirectAfterLoginTabId" ||
      key === "RedirectAfterLogoutTabId"
    ) {
      ...
      key === "DefaultAuthProvider" ||
      key === "PrimaryAdministratorId"
    ) {
      basicLoginSettings[key] = event.value;
    } else {
      basicLoginSettings[key] =
    ...
    props.dispatch(
      SecurityActions.basicLoginSettingsClientModified(basicLoginSettings),
    );
  }
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SecurityActions.updateBasicLoginSettings(
        state.basicLoginSettings,
        () => {
  ...
  onCancel() {
    ...
    util.utilities.confirm(
      resx.get("LoginSettingsRestoreWarning"),
      resx.get("Yes"),
      resx.get("No"),
      () => {
        props.dispatch(
        ...
        <div className={styles.loginSettings}>
          ...
          <InputGroup style={{ marginBottom: "2rem" }}>
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              />
              <Tooltip messages={[resx.get("GlobalSetting")]} type="global" />
            </div>
            <SingleLineInput
            ...
            <div className="loginSettings-row_switch" style={{ margin: "0" }}>
              <Label
                ...
                tooltipMessage={resx.get(
                  "Security_RequireValidProfileAtLogin.Help",
                )}
          ...
          <InputGroup>
            <div className="loginSettings-row_switch">
              <Label
                labelType="inline"
                tooltipMessage={resx.get(
                  "Security_CaptchaRetrivePassword.Help",
                )}
...
function mapStateToProps(state) {
  return {
    ...
    basicLoginSettingsClientModified:
      state.security.basicLoginSettingsClientModified,
  };
}
