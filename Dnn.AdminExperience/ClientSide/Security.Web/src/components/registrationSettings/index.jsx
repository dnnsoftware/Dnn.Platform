...
class RegistrationSettingsPanelBody extends Component {
  constructor() {
    ...
    canEdit =
      ...
      util.settings.permissions.REGISTRATION_SETTINGS_EDIT;
  }
  ...
  UNSAFE_componentWillMount() {
    ...
    props.dispatch(
      SecurityActions.getRegistrationSettings((data) => {
  ...
  onSettingChange(key, event) {
    ...
    if (key === "UserRegistration" || key === "RegistrationFormType") {
      ...
      registrationSettings[key] =
        typeof event === "object" ? event.target.value : event;
    }
    if (key === "UserNameMinLength") {
      state.error.userNameMinLength = !reUserNameMinLength.test(
        registrationSettings[key],
      );
    }
    ...
    props.dispatch(
      SecurityActions.registrationSettingsClientModified(registrationSettings),
    );
  }
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SecurityActions.updateRegistrationSettings(
  ...
  onCancel() {
    ...
    util.utilities.confirm(
      resx.get("RegistrationSettingsRestoreWarning"),
      resx.get("Yes"),
      resx.get("No"),
      () => {
        props.dispatch(
  ...
  isCustomFormType() {
    const { state } = this;
    if (
      state.registrationSettings != undefined &&
      state.registrationSettings.RegistrationFormType === 1
    ) {
      return true;
    }
    return false;
      ...
      return (
        <div className={styles.registrationSettings}>
          <InputGroup>
            <div className="registrationSettings-row-options">
              ...
              <RadioButtons
                ...
                options={this.keyValuePairsToOptions(
                  props.userRegistrationOptions,
                )}
          ...
          <InputGroup style={{ marginBottom: "5px" }}>
            <div className="registrationSettings-row-options">
              ...
              <RadioButtons
                ...
                options={this.keyValuePairsToOptions(
                  props.registrationFormTypeOptions,
                )}
          ...
          {this.isCustomFormType() && (
            <InputGroup style={{ marginBottom: "30px" }}>
              <div className="registrationSettings-row-input">
                ...
                <SearchableTags
                  utils={util}
                  tags={this.getRegistrationFields(
                    state.registrationSettings.RegistrationFields,
                  )}
          ...
          <div style={{ paddingBottom: "15px", fontStyle: "italic" }}>
            {resx.get("RedirectionMovedToSiteSettings")}
          </div>
          <InputGroup>
            ...
            <div className="registrationSettings-row_switch">
              <Label
                ...
                tooltipMessage={resx.get(
                  "plEnableUnapprovedPasswordReminderNotification.Help",
                )}
                label={resx.get(
                  "plEnableUnapprovedPasswordReminderNotification",
                )}
              />
              <Switch
                onText={resx.get("SwitchOn")}
          ...
          <InputGroup>
            <div className="registrationSettings-row_switch">
              <Label
                labelType="inline"
                tooltipMessage={resx.get(
                  "Registration_UseProfanityFilter.Help",
                )}
            ...
            <InputGroup>
              <div className="registrationSettings-row_switch">
                <Label
                  labelType="inline"
                  tooltipMessage={resx.get(
                    "Registration_UseEmailAsUserName.Help",
                  )}
                ...
                <Switch
                  ...
                  readOnly={!canEdit}
                />
                {this.state.error.validationFields[
                  "request.UseEmailAsUsername"
                ] !== "" && (
                  <Tooltip
                    messages={[
                      this.state.error.validationFields[
          ...
          <InputGroup>
            <div className="registrationSettings-row_switch">
              <Label
                labelType="inline"
                tooltipMessage={resx.get(
                  "Registration_RequireUniqueDisplayName.Help",
                )}
            ...
            <InputGroup>
              <div className="registrationSettings-row_switch">
                <Label
                  labelType="inline"
                  tooltipMessage={resx.get(
                    "Registration_RequireConfirmPassword.Help",
                  )}
          ...
          <InputGroup>
            <div className="registrationSettings-row-static">
              <Label
                labelType="inline"
                tooltipMessage={resx.get(
                  "MinNonAlphanumericCharactersTitle.Help",
                )}
          ...
          <InputGroup>
            <div className="registrationSettings-row-static">
              <Label
                labelType="inline"
                tooltipMessage={resx.get(
                  "PasswordStrengthRegularExpressionTitle.Help",
                )}
          ...
          <InputGroup>
            <div className="registrationSettings-row-static">
              <Label
                labelType="inline"
                tooltipMessage={resx.get(
                  "MaxInvalidPasswordAttemptsTitle.Help",
                )}
...
function mapStateToProps(state) {
  return {
    ...
    registrationSettingsClientModified:
      state.security.registrationSettingsClientModified,
  };
}
