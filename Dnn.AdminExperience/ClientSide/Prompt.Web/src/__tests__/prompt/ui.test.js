...
describe("UI snapshots for state change", () => {
    ...
    const commands = [
      {
        ...
        Description:
          'Clears the Prompt console. <code>cls</code> is a shortcut for <a href="#clear-screen"><code>clear-screen</code></a>',
        Version: "1.5.0.0",
      },
      {
        Key: "LIST-COMMANDS",
  ...
  it("Should render DataTable according to mocked rows and columns", () => {
    ...
    const wrapper = render(
      <DataTable rows={rows} columns={columns} cssClass={cssClass} />,
    );
  ...
  it("Should render Command component according to mocked commandsList", () => {
    const commandsList = [
      ...
      },
      {
        Category: "General Commands",
        Description:
          "Sets the DNN View Mode. This has the same effect as clicking the appropriate options in the DNN Control Bar.",
        Key: "SET-MODE",
        Name: "set-mode",
        Version: "1.5.0.0",
      },
    ...
    const wrapper = render(
      <Command commandList={commandsList} IsPaging={jest.fn()} />,
    );
