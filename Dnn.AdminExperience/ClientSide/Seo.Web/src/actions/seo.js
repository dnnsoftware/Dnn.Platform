...
const siteInfoActions = {
  ...
  updateGeneralSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateGeneralSettings(
        payload,
        (data) => {
          dispatch({
  ...
  updateRegexSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateRegexSettings(
        payload,
        (data) => {
          dispatch({
  ...
  updateSitemapSettings(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateSitemapSettings(
        payload,
        (data) => {
          dispatch({
  ...
  updateSitemapProvider(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateSitemapProvider(
        payload,
        (data) => {
          dispatch({
  ...
  updateExtensionUrlProviderStatus(payload, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.updateExtensionUrlProviderStatus(
        payload,
        (data) => {
          dispatch({
  ...
  createVerification(verification, callback, failureCallback) {
    return (dispatch) => {
      ApplicationService.createVerification(
        verification,
        (data) => {
          dispatch({
