...
export default function seoSettings(state = {}, action) {
  switch (action.type) {
    ...
    case ActionTypes.UPDATED_SEO_GENERAL_SETTINGS:
      return { ...state, clientModified: action.data.clientModified };
    ...
    case ActionTypes.UPDATED_SEO_REGEX_SETTINGS:
      return { ...state, regexClientModified: action.data.regexClientModified };
    case ActionTypes.TESTED_SEO_PAGE_URL:
    case ActionTypes.CLEARED_SEO_TEST_PAGE_URL_RESULTS:
      return { ...state, urls: action.data.urls };
    ...
    case ActionTypes.RETRIEVED_SEO_SITEMAP_PROVIDERS:
      return { ...state, sitemapProviders: action.data.providers };
    case ActionTypes.RETRIEVED_SEO_EXTENSION_URL_PROVIDERS:
      return { ...state, extensionUrlProviders: action.data.providers };
    default:
      return { ...state };
  }
}
