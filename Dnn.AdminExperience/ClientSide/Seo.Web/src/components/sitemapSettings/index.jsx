...
class SitemapSettingsPanelBody extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    props.dispatch(
      SeoActions.getSitemapSettings((data) => {
        this.setState({
    ...
    props.dispatch(
      SeoActions.getSitemapProviders((data) => {
        this.setState({
  ...
  onSettingChange(key, event) {
    ...
    if (
      key === "SitemapExcludePriority" ||
      key === "SitemapCacheDays" ||
      key === "SitemapMinPriority"
    ) {
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SeoActions.updateSitemapSettings(
        state.sitemapSettings,
        () => {
  ...
  onUpdateProvider(settings) {
    ...
    props.dispatch(
      SeoActions.updateSitemapProvider(
        settings,
        () => {
          util.utilities.notify(resx.get("SettingsUpdateSuccess"));
          props.dispatch(
  ...
  onSearchEngineSubmit() {
    let { state, props } = this;
    let url = props.searchEngineUrls.filter(
      (item) => item.Key === state.searchEngine,
    )[0].Value;
  ...
  render() {
    ...
    if (state.sitemapSettings) {
      const columnOne = (
        <div className="left-column" key="columnOne">
          <InputGroup>
            <Label
      ...
      const columnTwo = (
        <div className="right-column" key="columnTwo">
          <InputGroup>
            <Label
      ...
      const columnThree = (
        <div className="left-column" key="columnThree">
          <InputGroup>
            <Label
      ...
      const columnFour = (
        <div className="right-column" key="columnFour">
          <InputGroup>
            <Label
            ...
            <div className="createVerification">
              <SingleLineInputWithError
                ...
                withLabel={false}
                error={
                  this.state.error.verificationValidity &&
                  this.state.triedToCreate
                }
