...
class TestUrlPanelBody extends Component {
  ...
  onTestPage() {
    ...
    props.dispatch(
      SeoActions.testUrl(
        state.test.PageToTest,
        state.test.QueryString,
        state.test.CustomPageName,
      ),
    );
  }
    ...
    const columnOne = (
      <div className="left-column">
        ...
        <div className="buttons-box">
          <Button
            disabled={
              !this.state.test.PageToTest || this.state.test.PageToTest === "-1"
            }
            type="secondary"
    ...
    const columnTwo = (
      <div className="right-column">
        <InputGroup>
          ...
          />
          <MultiLineInput value={props.urls} enabled={false} />
        </InputGroup>
      </div>
    );
