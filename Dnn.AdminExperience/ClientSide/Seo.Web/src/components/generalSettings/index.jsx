...
class GeneralSettingsPanelBody extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    props.dispatch(
      SeoActions.getGeneralSettings((data) => {
        this.setState({
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SeoActions.updateGeneralSettings(
          ...
          <InputGroup>
            ...
            <Dropdown
              options={this.keyValuePairsToOptions(
                props.replacementCharacterList,
              )}
          ...
          <InputGroup>
            <div className="generalSettings-row-options">
              ...
              <RadioButtons
                ...
                options={this.keyValuePairsToOptions(
                  props.deletedPageHandlingTypes,
                )}
