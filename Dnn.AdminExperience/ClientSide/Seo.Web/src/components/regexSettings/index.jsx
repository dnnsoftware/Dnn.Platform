...
class RegexSettingsPanelBody extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    props.dispatch(
      SeoActions.getRegexSettings((data) => {
        this.setState({
  ...
  onUpdate(event) {
    ...
    props.dispatch(
      SeoActions.updateRegexSettings(
        state.regexSettings,
        () => {
          ...
          <div className="groupWrapper">
            <InputGroup>
              ...
              <SingleLineInputWithError
                ...
                withLabel={false}
                error={
                  this.state.error.DoNotRewriteRegex && this.state.triedToSubmit
                }
          ...
          <div className="groupWrapper">
            <InputGroup>
              ...
              <SingleLineInputWithError
                ...
                withLabel={false}
                error={
                  this.state.error.UseSiteUrlsRegex && this.state.triedToSubmit
                }
          ...
          <div className="groupWrapper">
            <InputGroup>
              ...
              <SingleLineInputWithError
                ...
                withLabel={false}
                error={
                  this.state.error.DoNotRedirectRegex &&
            ...
            <InputGroup>
              <Label
                tooltipMessage={resx.get(
                  "doNotRedirectHttpsUrlRegExLabel.Help",
                )}
              ...
              <SingleLineInputWithError
                ...
                withLabel={false}
                error={
                  this.state.error.DoNotRedirectSecureRegex &&
                  this.state.triedToSubmit
                }
                errorMessage={resx.get(
                  "doNotRedirectHttpsUrlRegExInvalidPattern",
                )}
          ...
          <div className="groupWrapper">
            <InputGroup>
              ...
              <SingleLineInputWithError
                ...
                withLabel={false}
                error={
                  this.state.error.ForceLowerCaseRegex &&
                  this.state.triedToSubmit
                }
                errorMessage={resx.get(
                  "preventLowerCaseUrlRegExInvalidPattern",
                )}
          ...
          <div className="groupWrapper">
            <InputGroup>
              ...
              <SingleLineInputWithError
                ...
                withLabel={false}
                error={
                  this.state.error.NoFriendlyUrlRegex &&
                  this.state.triedToSubmit
                }
                errorMessage={resx.get(
                  "doNotUseFriendlyUrlsRegExInvalidPattern",
                )}
          ...
          <div className="groupWrapper">
            <InputGroup>
              ...
              <SingleLineInputWithError
                ...
                withLabel={false}
                error={
                  this.state.error.DoNotIncludeInPathRegex &&
                  this.state.triedToSubmit
                }
          ...
          <div className="groupWrapper">
            <InputGroup>
              ...
              <SingleLineInputWithError
                ...
                withLabel={false}
                error={
                  this.state.error.ValidExtensionlessUrlsRegex &&
                  this.state.triedToSubmit
                }
                errorMessage={resx.get(
                  "urlsWithNoExtensionRegExInvalidPattern",
                )}
