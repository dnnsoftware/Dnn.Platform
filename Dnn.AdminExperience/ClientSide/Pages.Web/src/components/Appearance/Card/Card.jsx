...
class Card extends Component {
  ...
  getImageComponent() {
    ...
    return (
      <span className={className} onClick={this.onClick.bind(this)}>
        ...
        {selected && (
          <span
            className={isSiteDefault ? "checkmark site-default" : "checkmark"}
          >
  ...
  render() {
    ...
    const className =
      styles.moduleContainer + (selected ? " selected" : "") + " " + size;
    ...
    return (
      <div className={className}>
        ...
        <TextOverflowWrapper
          ...
          maxWidth={maxWidth}
          className={isSiteDefault ? "card-title site-default" : "card-title"}
        />
        <TextOverflowWrapper
          text={isSiteDefault && localization.get("SiteDefault")}
          maxWidth={maxWidth}
          className="card-title-site-default"
        />
      </div>
    );
  }
