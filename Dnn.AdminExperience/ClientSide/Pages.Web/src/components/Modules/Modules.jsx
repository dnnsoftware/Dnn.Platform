...
class Modules extends Component {
  ...
  onDeleteModule(module) {
    ...
    utils.confirm(
      Localization.get("DeleteModuleConfirm").replace(
        "[MODULETITLE]",
        module.title,
      ),
  ...
  getModules() {
    ...
    if (modules.length === 0) {
      return (
        <GridCell className="no-modules" columnSize={100}>
      ...
      <div className={styles.moduleContainer}>
        ...
        <div className="module-table">
          <div className="header-row">
            {showCopySettings && <GridCell columnSize={10} />}
        ...
        <Modal
          ...
          header={
            state.editType === "content"
              ? Localization.get("EditContent")
              : Localization.get("ModuleSettings")
          }
