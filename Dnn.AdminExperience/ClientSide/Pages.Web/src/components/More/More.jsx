  ...
  render() {
    ...
    return (
      <div className={styles.moreContainer}>
        <div className="title">{Localization.get("Security")}</div>
        <GridSystem>
          ...
          <GridCell className="left-column">
            ...
            {page.cacheProvider && (
              <div className="clear-cache">
                <Label
                  labelType="block"
                  label={Localization.get("lblCachedItemCount").replace(
                    "{0}",
                    this.props.cachedPageCount,
                  )}
                />
                <Button
            ...
            <GridCell className="right-column">
              ...
              {!page.cacheIncludeExclude && (
                <SingleLineInputWithError
                  ...
                  tooltipMessage={Localization.get(
                    "IncludeParamsInCacheValidation_tooltip",
                  )}
              ...
              {page.cacheIncludeExclude && (
                <SingleLineInputWithError
                  ...
                  tooltipMessage={Localization.get(
                    "ExcludeParamsInCacheValidation_tooltip",
                  )}
