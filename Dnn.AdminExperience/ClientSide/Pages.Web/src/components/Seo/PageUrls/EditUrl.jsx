...
class EditUrl extends Component {
  ...
  getSiteAliasUsageOptions(hasParent) {
    let options = [
      {
        value: portalAliasUsageType.ChildPagesDoNotInherit,
        label: Localization.get(
          "Pages_Seo_SelectedAliasUsageOptionThisPageOnly",
        ),
      },
      {
        value: portalAliasUsageType.ChildPagesInherit,
        label: Localization.get(
          "Pages_Seo_SelectedAliasUsageOptionPageAndChildPages",
        ),
      },
    ];
    ...
    if (hasParent) {
      options.push({
        value: portalAliasUsageType.InheritedFromParent,
        label: Localization.get(
          "Pages_Seo_SelectedAliasUsageOptionSameAsParent",
        ),
      });
    }
        ...
        <div className="editUrl-body">
              ...
              <GridCell columnSize={100}>
                <Label
                  ...
                  tooltipMessage={Localization.get(
                    "Pages_Seo_SelectedAliasUsage.Help",
                  )}
          ...
          <GridCell>
            <GridCell columnSize={50} className="left-column">
              ...
              />
              <Dropdown
                options={this.getUrlTypeOptions()}
          ...
          <div
            ...
            style={{ float: "left", margin: "0 0 20px 0" }}
          >
            ...
            <Button
              type="primary"
              onClick={onSave}
              disabled={!this.state.hasChanges || saving}
            >
