  ...
  render() {
    ...
    return (
      <div className={styles.urlRow + (opened ? " row-opened" : "")}>
        ...
        <GridCell columnSize={20}>{url.statusCode.Value}</GridCell>
        <GridCell columnSize={20}>{generatedBy}</GridCell>
        <GridCell columnSize={10}>
          {(!url.autoGenerated || url.statusCode.Key !== 200) &&
            url.id !== -1 && (
              <div
          ...
          {!url.autoGenerated && (
            <div
              className={"extension-action" + (opened ? " active" : "")}
