...
class PageHierarchy extends Component {
  componentDidMount() {
    ...
    pageHierarchyManager.setCurrentTabIdAndSiteRoot(
      utils.getCurrentPageId(),
      utils.getSiteRoot(),
    );
    pageHierarchyManager.selectedPagePathChanged = (p) =>
      this.props.onSelectedPagePathChanged([...p]);
  }

  componentDidUpdate(prevProps) {
    const { itemTemplate, dragItemTemplate, searchKeyword, selectedPage } =
      prevProps;
