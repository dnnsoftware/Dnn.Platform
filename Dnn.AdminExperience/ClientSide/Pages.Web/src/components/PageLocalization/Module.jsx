...
class Module extends Component {
  ...
  render() {
    ...
    if (module.Exist) {
      ...
      const toolTip = [
        module.IsShared
          ? Localization.get("SharedModule")
          : Localization.get("IsNotSharedModule"),
        module.ModuleInfoHelp,
      ].join("<br>");
      return (
        <div className={className}>
          ...
          <input
            ...
            onChange={this.onUpdateModules.bind(this, "ModuleTitle")}
            aria-label="Title"
          />
          {module.IsDeleted && (
            <div className="icons-container">
              <span
                className="icon"
                onClick={this.onDeleteModule.bind(this, module.TabModuleId)}
              >
                <SvgIcons.TrashIcon />
              </span>
              <span
                className="icon"
                onClick={this.onRestoreModule.bind(this, module.TabModuleId)}
              >
                <SvgIcons.CycleIcon />
              </span>
            </div>
          ...
          {!module.IsDeleted && !isDefault && (
            <div className="icons-container">
              <span
                ...
                title={
                  module.IsShared
                    ? Localization.get("LocalizedSharedModule_tooltip")
                    : module.IsLocalized
                      ? Localization.get("ClickToDeLocalizeModule_tooltip")
                      : Localization.get("ClickToLocalizeModule_tooltip")
                }
              ...
              {module.TranslatedVisible && (
                <div
                  title={
                    module.IsTranslated
                      ? Localization.get("UnCheckTranslatedModule_tooltip")
                      : Localization.get("CheckToTranslateModule_tooltip")
                  }
