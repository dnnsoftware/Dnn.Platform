...
class PageLanguage extends Component {
  ...
  render() {
    const iconSrc =
      this.props.local && this.props.local.Icon ? this.props.local.Icon : "";
    const cultureCode =
      this.props.local && this.props.local.CultureCode
        ? this.props.local.CultureCode
        : "";
    ...
    return (
      <div className="page-language">
        <div className="page-language-row">
          ...
          {!this.props.isDefault && !isSpecialPage && (
            <a
              className="icon"
        ...
        <div className="page-language-row">
          <input
            type="text"
            value={page.TabName}
            onChange={this.onUpdatePages.bind(this, "TabName")}
            aria-label="Name"
          />
          <input
            type="text"
            value={page.Title}
            onChange={this.onUpdatePages.bind(this, "Title")}
            aria-label="Title"
          />
          <textarea
            value={page.Description}
            onChange={this.onUpdatePages.bind(this, "Description")}
        ...
        <div className="page-language-row">
          <div className="page-language-row-header">
            ...
            {!this.props.isDefault && (
              <div className="icons-container">
                <span
                  title={
                    this.state.allModulesLinked
                      ? Localization.get("ClickToDeLocalizeAllModules_tooltip")
                      : Localization.get("ClickToLocalizeAllModules_tooltip")
                  }
                ...
                <div
                  title={
                    this.state.allModulesSelected
                      ? Localization.get("UnCheckAllTranslatedModules_tooltip")
                      : Localization.get("CheckToTranslateAllModules_tooltip")
                  }
          ...
          <div className="module-row footer">
            <div
              title={
                page.IsTranslated
                  ? Localization.get("UnCheckTransaledPage_tooltip")
                  : Localization.get("CheckToTransalePage_tooltip")
              }
          ...
          <div className="module-row footer">
            <div
              title={
                page.IsPublished
                  ? Localization.get("UnCheckPublishedPage_tooltip")
                  : Localization.get("CheckToPublishPage_tooltip")
              }
              style={{ float: "right", display: "inline-block" }}
            >
              <Checkbox
