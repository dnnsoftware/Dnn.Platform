...
class PageTypeSelector extends Component {
  ...
  _getHierarchyLabel() {
    ...
    if (
      page.hierarchy === null ||
      page.hierarchy === "" ||
      page.hierarchy === Localization.get("NoneSpecified")
    ) {
  ...
  componentDidMount() {
    ...
    if (
      pageSelectorDOM.querySelector("#parentPageValue").offsetWidth >
      MAX_PAGE_PARENT_SIZE_TOOGLE
    ) {
      pageSelectorDOM.querySelector("#pageParent").className =
        "page-info-item page-parent-info-style-large";
      pageSelectorDOM.querySelector("#pageParentLabel").className =
        "page-info-item-label parent-page-style-label-large";
      pageSelectorDOM.querySelector("#pageParentContent").className =
        "page-info-item-value parent-page-name parent-page-style-content-large";
    }
  }

  _calculateParentPageSize(parentPageRef) {
    if (parentPageRef !== null) {
      this.pageParentLarge =
        parentPageRef.offsetWidth > MAX_PAGE_PARENT_SIZE_TOOGLE;
    }
  }

  _defineVisibleOrHidden(includeInMenu) {
    return includeInMenu
      ? Localization.get("Status_Visible")
      : Localization.get("Status_Hidden");
  }
  ...
  render() {
    ...
    return (
      <div
        className={styles.pageTypeSelector}
        ref={(node) => (this.node = node)}
      >
        <div>{components}</div>
        <div>
          <div className="page-info-row page-name">{page.name}</div>
          <div className="page-info-row">
            <div className="page-info-item">
              <span className="page-info-item-label">
                {Localization.get("Created") + ": "}
              </span>
              <span className="page-info-item-value">{createdDate}</span>
            </div>
            <div
              id="pageParent"
              className={
            ...
            >
              ...
              <span
                id="pageParentContent"
                className={
                  this.pageParentLarge
                    ? "page-info-item-value parent-page-name parent-page-style-content-large"
                    : "page-info-item-value parent-page-name"
                }
              >
                <span
                  id="parentPageValue"
            ...
            <div className="page-info-item">
              ...
              <span className="page-info-item-value">{page.tabId}</span>
            </div>
          </div>
          <div className="page-info-row">
            <div className="page-info-item page-type">
              ...
              <span className="page-info-item-value">
                <RadioButtons
                  options={[
                    { value: "normal", label: Localization.get("Standard") },
