          ...
          >
            <p>
              {searchResult.TotalResults === 0
                ? Localization.get("NoPageFound").toUpperCase()
                ...
                {searchList.map((item, index) => {
                  return (
                    <SearchResultCard
                      ...
                      updateFilterByPageStatusOptions={
                        this.props.updateFilterByPageStatusOptions
                      }
                      updateFilterByPageTypeOptions={
                        this.props.updateFilterByPageTypeOptions
                      }
                      updateFilterByWorkflowOptions={
                        this.props.updateFilterByWorkflowOptions
                      }
                      updateFilterStartEndDate={
                        this.props.updateFilterStartEndDate
                      }
                      ...
                      updateSearchAdvancedTags={
                        this.props.updateSearchAdvancedTags
                      }
