...
class SearchAdvancedDetails extends Component {
  ...
  getDateLabel() {
    let filterByDateText = utils.isPlatform()
      ? "FilterByModifiedDateText"
      : "FilterByPublishDateText";
  ...
  getPageStatusLabel() {
    return this.props.filterByPublishStatus
      ? this.props
      ...
      <div className="search-more-flyout" ref={(node) => (this.node = node)}>
          ...
          <GridCell columnSize={100}>
            <GridCell columnSize={50} style={{ padding: "5px" }}>
              <Dropdown
                ...
                label={
                  this.props.filterByPageType
                    ? this.props
                        .getFilterByPageTypeOptions()
                        .find(
                          (x) =>
                            x.value ===
                            this.props.filterByPageType.toLowerCase(),
                        ).label
                    : Localization.get("FilterbyPageTypeText")
                }
                value={
                  this.props.filterByPageType !== "" &&
                  this.props.filterByPageType
                ...
                onSelect={(data) => {
                  this.props.updateFilterByPageTypeOptions(data);
                }}
                withBorder={true}
              />
            </GridCell>
            <GridCell columnSize={50} style={{ padding: "5px 5px 5px 15px" }}>
              <Dropdown
                ...
                onSelect={(data) =>
                  this.props.updateFilterByPageStatusOptions(data)
                }
                withBorder={true}
              />
            </GridCell>
            ...
            {!utils.isPlatform() && (
              <GridCell columnSize={50} style={{ padding: "5px 5px 5px 15px" }}>
                <Dropdown
                  ...
                  label={
                    this.props.filterByWorkflow
                      ? this.props
                          .getFilterByWorkflowOptions()
                          .find((x) => x.value === this.props.filterByWorkflow)
                          .label
                      : Localization.get("FilterbyWorkflowText")
                  }
                  value={
                    this.props.filterByWorkflow !== "" &&
                    this.props.filterByWorkflow
                  ...
                  onSelect={(data) =>
                    this.props.updateFilterByWorkflowOptions(data)
                  }
                  withBorder={true}
                />
              </GridCell>
        ...
        >
          <div onClick={this.onTagClick.bind(this)}>
            <Tags
              style={{ minHeight: "82px", width: "100%" }}
