...
describe("Breadcrumbs", () => {
  ...
  it("Breadcrumbs renders", () => {
    let breadcrumbs = shallow(
      <Breadcrumbs items={[]} onSelectedItem={onSelectedItem} />,
    );
  ...
  it("Breadcrumbs renders empty when no itens passed", () => {
    ...
    expect(breadcrumbs.find(".breadcrumbs-container").children().length).toBe(
      0,
    );
  });
  ...
  it("Breadcrumb render one item", () => {
    let breadcrumbs = shallow(
      <Breadcrumbs items={[item]} onSelectedItem={onSelectedItem} />,
    );
  ...
  it("Breadcrumb render two items", () => {
    let breadcrumbs = shallow(
      <Breadcrumbs items={items} onSelectedItem={onSelectedItem} />,
    );
  ...
  it("Add six items to breadccrumb", () => {
    let breadcrumbs = shallow(
      <Breadcrumbs items={itemsMax} onSelectedItem={onSelectedItem} />,
    );

    const countChildren = breadcrumbs
