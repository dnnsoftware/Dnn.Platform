...
const application = {
    init(initCallback) {
        ...
        if (window.dnn.pages.itemTemplate) {
            application.dispatch(
                PageHierarchyActions.setItemTemplate(window.dnn.pages.itemTemplate),
            );
        }
    },
    load(options) {
    ...
    registerInContextMenuComponent(component) {
        application.dispatch(
            ExtensionsActions.registerInContextMenuComponent(component),
        );
    },
    registerPageSettingsComponent(component) {
        application.dispatch(
            ExtensionsActions.registerPageSettingsComponent(component),
        );
    },
    registerPageDetailFooterComponent(component) {
        application.dispatch(
            ExtensionsActions.registerPageDetailFooterComponent(component),
        );
    },
    registerMultiplePagesComponent(component) {
        application.dispatch(
            ExtensionsActions.registerMultiplePagesComponent(component),
        );
    },
    registerSettingsButtonComponent(component) {
        application.dispatch(
            ExtensionsActions.registerSettingsButtonComponent(component),
        );
    },
    registerPageTypeSelectorComponent(component) {
        application.dispatch(
            ExtensionsActions.registerPageTypeSelectorComponent(component),
        );
    },
    isSuperUserForPages() {
