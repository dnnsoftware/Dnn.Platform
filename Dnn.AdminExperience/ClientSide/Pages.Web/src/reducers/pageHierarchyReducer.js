...
export default function pageHierarchyReducer(
    state = {
    ...
    switch (action.type) {
        ...
        case ActionTypes.SET_ITEM_TEMPLATE:
            return { ...state, itemTemplate: action.itemTemplate };

        case ActionTypes.SET_DRAG_ITEM_TEMPLATE:
            return { ...state, dragItemTemplate: action.itemTemplate };

        case ContentActionTypes.SAVED_PAGE:
            return { ...state, createdPage: action.data.createdPage };

        case ActionTypes.CHANGE_SELECTED_PAGE_PATH:
            return { ...state, selectedPagePath: action.path };
