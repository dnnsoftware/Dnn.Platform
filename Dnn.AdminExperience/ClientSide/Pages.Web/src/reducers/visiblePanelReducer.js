...
export default function visiblePanel(
    ...
    switch (action.type) {
        ...
        case VisiblePanelActionTypes.HIDE_PANEL:
            return { ...state, selectedPage: panels.MAIN_PANEL };

        case AddPagesActionTypes.LOAD_ADD_MULTIPLE_PAGES:
            return { ...state, selectedPage: panels.ADD_MULTIPLE_PAGES_PANEL };

        case TemplateActionTypes.LOAD_SAVE_AS_TEMPLATE:
            return { ...state, selectedPage: panels.SAVE_AS_TEMPLATE_PANEL };
        ...
        case TemplateActionTypes.SAVED_TEMPLATE:
            return { ...state, selectedPage: panels.PAGE_SETTINGS_PANEL };

        case VisiblePanelActionTypes.SHOW_PANEL:
            return { ...state, selectedPage: action.data.panelId };
