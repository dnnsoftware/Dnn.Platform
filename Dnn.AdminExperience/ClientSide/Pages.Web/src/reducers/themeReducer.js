...
export default function themeReducer(
    ...
    switch (action.type) {
        case ActionTypes.RETRIEVING_THEMES:
            return { ...state, retrievingThemes: true };
        ...
        case ActionTypes.ERROR_RETRIEVING_THEMES:
            return { ...state, retrievingThemes: false };

        case ActionTypes.RETRIEVING_THEME_FILES:
            return { ...state, retrievingThemeFiles: true };
        ...
        case ActionTypes.ERROR_RETRIEVING_THEME_FILES:
            return { ...state, retrievingThemeFiles: false };

        case PagesActionTypes.LOAD_PAGE:
            return { ...state, layouts: [], containers: [] };
