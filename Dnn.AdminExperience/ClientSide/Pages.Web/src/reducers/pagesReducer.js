...
export default function pagesReducer(
    ...
    switch (action.type) {
        ...
        case ActionTypes.LOAD_PAGE:
            return { ...state, selectedPage: null, editingSettingModuleId: null };
        ...
        case ActionTypes.FETCHED_CACHE_PROVIDER_LIST:
            return { ...state, cacheProviderList: action.data.cacheProviderList };
        ...
        case ActionTypes.EDITING_PAGE_MODULE: {
            ...
            return { ...state, editingSettingModuleId };
        }
        ...
        case ActionTypes.DELETED_PAGE_MODULE: {
            const modules = [
                ...state.selectedPage.modules.filter(
                    (f) => f.id !== action.data.module.id,
                ),
            ];
            return {
                ...state,
        ...
        case ActionTypes.UPDATED_PAGE_MODULE_COPY: {
            const modules = changeModuleCopy(
                action.data.id,
                action.data.key,
                action.data.event,
            );
        ...
        case ActionTypes.RETRIEVED_CACHED_PAGE_COUNT:
            return { ...state, cachedPageCount: action.data.cachedPageCount };

        case ActionTypes.CLEARED_CACHED_PAGE:
            return { ...state, cachedPageCount: 0 };
