...
class UserMenu extends Component {
  ...
  handleClick(event) {
    if (
      !(this.rootElement && this.rootElement.contains(event.target)) &&
      (typeof event.target.className !== "string" ||
        (typeof event.target.className === "string" &&
          event.target.className.indexOf("menu-item") === -1))
    ) {
      this.props.onClose();
    }
  }
  ...
  componentDidUpdate() {
    if (
      ...
      this.props.userDetails.userId !== this.props.userId
    ) {
      this.showMenu = false;
  ...
  getUserDetails(props) {
    props.dispatch(
      CommonUsersActions.getUserDetails({ userId: props.userId }, (data) => {
  ...
  onSendPasswordLink() {
    this.props.dispatch(
      CommonUsersActions.sendPasswordResetLink(
  ...
  deleteUser() {
    utilities.confirm(
      Localization.get("DeleteUser.Confirm"),
      Localization.get("Delete"),
      Localization.get("Cancel"),
      () => {
        this.props.dispatch(
          CommonUsersActions.deleteUser(
  ...
  hardDeleteUser() {
    utilities.confirm(
      Localization.get("RemoveUser.Confirm"),
      Localization.get("Delete"),
      Localization.get("Cancel"),
      () => {
        this.props.dispatch(
          CommonUsersActions.eraseUser({ userId: this.props.userId }),
        );
      },
    );
  }
  restoreUser() {
    this.props.dispatch(
      CommonUsersActions.restoreUser(
        { userDetails: this.props.userDetails },
        this.props.filter,
        () => {
  ...
  forcePasswordChange() {
    this.props.dispatch(
      CommonUsersActions.forceChangePassword(
        { userId: this.props.userId },
        () => {
          utilities.notify(
            Localization.get("UserPasswordUpdateChanged"),
            10000,
          );
          this.reload();
        },
  ...
  updateAuthorizeStatus(authorized) {
    this.props.dispatch(
      CommonUsersActions.updateAuthorizeStatus(
        { userDetails: this.props.userDetails },
        authorized,
        this.props.filter,
        () => {
          utilities.notify(
            authorized
              ? Localization.get("UserAuthorized")
              : Localization.get("UserUnAuthorized"),
            3000,
          );
          this.reload();
        },
  ...
  updateSuperUserStatus(setSuperUser) {
    this.props.dispatch(
      CommonUsersActions.updateSuperUserStatus(
        { userId: this.props.userId, setSuperUser: setSuperUser },
        this.props.filter,
        () => {
          this.reload();
        },
  ...
  render() {
    let visibleMenus = [
      { key: "ViewProfile", title: Localization.get("ViewProfile"), index: 10 },
    ];

    if (
      canPromoteDemote(
        this.props.appSettings.applicationSettings.settings,
        ...
        visibleMenus = [
          {
            ...
            title: Localization.get("PromoteToSuperUser"),
            index: 80,
          },
        ].concat(visibleMenus);
        ...
        visibleMenus = [
          {
            ...
            title: Localization.get("DemoteToRegularUser"),
            index: 80,
          },
        ].concat(visibleMenus);
      }
    ...
    if (
      ...
      visibleMenus = [
        {
          key: "ResetPassword",
          title: Localization.get("ResetPassword"),
          index: 40,
        },
      ].concat(visibleMenus);
      visibleMenus = [
        {
          key: "ChangePassword",
          title: Localization.get("ChangePassword"),
          index: 30,
        },
      ].concat(visibleMenus);
        ...
        visibleMenus = [
          {
            ...
            title: Localization.get("ForceChangePassword"),
            index: 40,
          },
        ].concat(visibleMenus);
      }
    ...
    if (
      ...
      if (this.state.userDetails.isDeleted) {
        visibleMenus = [
          {
            key: "RestoreUser",
            title: Localization.get("RestoreUser"),
            index: 70,
          },
        ].concat(visibleMenus);
        visibleMenus = [
          {
            key: "RemoveUser",
            title: Localization.get("RemoveUser"),
            index: 60,
          },
        ].concat(visibleMenus);
      } else {
        visibleMenus = [
          {
            key: "DeleteUser",
            title: Localization.get("DeleteUser"),
            index: 60,
          },
        ].concat(visibleMenus);
      }
    ...
    if (
      ...
      if (this.state.userDetails.authorized) {
        visibleMenus = [
          {
            key: "cmdUnAuthorize",
            title: Localization.get("cmdUnAuthorize"),
            index: 50,
          },
        ].concat(visibleMenus);
      } else {
        visibleMenus = [
          {
            key: "cmdAuthorize",
            title: Localization.get("cmdAuthorize"),
            index: 50,
          },
        ].concat(visibleMenus);
      }
      if (this.state.userDetails.isLocked) {
        visibleMenus = [
          {
            key: "cmdUnLock",
            title: Localization.get("cmUnlockUser"),
            index: 100,
          },
        ].concat(visibleMenus);
      }
    ...
    visibleMenus = visibleMenus.concat(
      (this.props.getUserMenu &&
        this.props.getUserMenu(this.state.userDetails)) ||
        [],
    );
                ...
                {visibleMenus.map((menu, index) => {
                  return (
                    <MenuItem
                      ...
                      onMenuAction={this.onItemClick.bind(this, menu.key)}
                    >
                      {menu.title}
                    </MenuItem>
                  );
