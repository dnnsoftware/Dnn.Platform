...
class CreateUserBox extends Component {
  ...
  validateForm() {
    ...
    let valid = true;
    let requiresQuestionAndAnswer =
      props.appSettings.applicationSettings.settings.requiresQuestionAndAnswer;
    let userNameMinLength =
    ...
    if (this.submitted) {
      ...
      if (
        ...
        UserDetails.userName.length < userNameMinLength
      ) {
      ...
      if (
        UserDetails.randomPassword === false &&
        ...
        UserDetails.randomPassword === false &&
        this.state.confirmPassword !== UserDetails.password
      ) {
        ...
        <GridCell className="new-user-box">
          <GridSystem className="with-right-border top-half">
            <div>
              ...
              <Switch
                ...
                label={Localization.get("Approved")}
                title={Localization.get("Approved.Help")}
            ...
            <div>
              ...
              <Switch
                ...
                title={Localization.get("Random.Help")}
          ...
          {!state.UserDetails.randomPassword && (
            <GridSystem>
              ...
              <SingleLineInputWithError
                label={Localization.get("Confirm")}
                error={
                ...
                errorMessage={
                  state.errors.confirmPassword
                    ? Localization.get("Confirm.Required")
                    : Localization.get("ConfirmMismatch.ErrorMessage")
                }
                style={inputStyle}
                type="password"
                autoComplete="off"
          ...
          {requiresQuestionAndAnswer && (
            <GridSystem>
              <div>
                <SingleLineInputWithError
                  label={Localization.get("Question")}
