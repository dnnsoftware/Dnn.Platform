...
class UserService {
  ...
  getUserDetails(userDetailsParameters, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.get(
      "GetUserDetail?" + serializeQueryStringParameters(userDetailsParameters),
      {},
      callback,
      errorCallback,
    );
  ...
  forceChangePassword(userDetails, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.post(
      "ForceChangePassword?" + serializeQueryStringParameters(userDetails),
      null,
      callback,
      errorCallback,
    );
  ...
  sendPasswordResetLink(userDetails, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.post(
      "SendPasswordResetLink?" + serializeQueryStringParameters(userDetails),
      null,
      callback,
      errorCallback,
    );
  ...
  deleteUser(userDetails, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.post(
      "SoftDeleteUser?" + serializeQueryStringParameters(userDetails),
      null,
      callback,
      errorCallback,
    );
  ...
  hardDeleteUser(userDetails, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.post(
      "HardDeleteUser?" + serializeQueryStringParameters(userDetails),
      null,
      callback,
      errorCallback,
    );
  ...
  restoreUser(userDetails, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.post(
      "RestoreDeletedUser?" + serializeQueryStringParameters(userDetails),
      null,
      callback,
      errorCallback,
    );
  ...
  updateSuperUserStatus(userDetails, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.post(
      "UpdateSuperUserStatus?" + serializeQueryStringParameters(userDetails),
      null,
      callback,
      errorCallback,
    );
  ...
  updateAuthorizeStatus(userDetails, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.post(
      "UpdateAuthorizeStatus?" + serializeQueryStringParameters(userDetails),
      null,
      callback,
      errorCallback,
    );
  ...
  unlockUser(userDetails, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.post(
      "UnlockUser?" + serializeQueryStringParameters(userDetails),
      null,
      callback,
      errorCallback,
    );
  ...
  getUserRoles(searchParameters, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.get(
      "GetUserRoles?" + serializeQueryStringParameters(searchParameters),
      {},
      callback,
      errorCallback,
    );
  ...
  getSuggestRoles(searchParameters, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.get(
      "GetSuggestRoles?" + serializeQueryStringParameters(searchParameters),
      {},
      callback,
      errorCallback,
    );
  ...
  saveUserRole(payload, notifyUser, isOwner, callback, errorCallback) {
    const sf = this.getServiceFramework("Users");
    sf.post(
      "SaveUserRole?notifyUser=" + notifyUser + "&isOwner=" + isOwner,
      payload,
      callback,
      errorCallback,
    );
