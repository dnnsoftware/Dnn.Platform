...
const userActions = {
  ...
  forceChangePassword(payload, callback) {
    return () => {
      UserService.forceChangePassword(
        payload,
        (data) => {
          if (callback) {
            callback(data);
  ...
  updateSuperUserStatus(payload, filter, callback) {
    return (dispatch) => {
      UserService.updateSuperUserStatus(
        payload,
        (data) => {
          dispatch({
  ...
  updateAuthorizeStatus(payload, authorized, filter, callback) {
    return (dispatch) => {
      ...
      UserService.updateAuthorizeStatus(
        { userId: payload.userDetails.userId, authorized: authorized },
        (data) => {
          dispatch({
