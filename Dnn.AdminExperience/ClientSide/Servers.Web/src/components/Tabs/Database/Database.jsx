      ...
      <GridCell>
        <GridCell className="dnn-servers-info-panel">
          <GridSystem>
            ...
            <GridCell>
              <InfoBlock
                label={Localization.get("DbInfo_SoftwarePlatform")}
        ...
        <GridCell className="dnn-servers-grid-panel">
          <Label
            ...
            label={Localization.get("plBackups")}
          />
