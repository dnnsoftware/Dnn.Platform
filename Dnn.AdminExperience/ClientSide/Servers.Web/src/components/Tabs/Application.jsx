      ...
      <div className="dnn-servers-info-panel">
        <GridSystem>
          <div>
            ...
            <InfoBlock
              label={Localization.get("plVersion")}
          ...
          <div>
            <InfoBlock
              label={Localization.get("HostInfo_FriendlyUrlProvider")}
              tooltip={Localization.get("HostInfo_FriendlyUrlProvider.Help")}
              text={
                props.applicationInfo.friendlyUrlProvider || defaultPlaceHolder
              }
            />

            <InfoBlock
              label={Localization.get("HostInfo_FriendlyUrlEnabled")}
              tooltip={Localization.get("HostInfo_FriendlyUrlEnabled.Help")}
              text={
                props.applicationInfo.friendlyUrlsEnabled || defaultPlaceHolder
              }
            />

            <InfoBlock
              label={Localization.get("HostInfo_FriendlyUrlType")}
            ...
            <div className="tooltipAdjustment">
              <InfoBlock
                label={Localization.get("HostInfo_SchedulerMode")}
