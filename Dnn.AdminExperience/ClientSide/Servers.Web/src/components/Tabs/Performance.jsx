...
class Performance extends Component {
    ...
    return [
      {
        label: localization.get(
          "PerformanceTab_GlobalClientResourcesManagementMode",
        ),
        value: "h",
      },
      {
  ...
  confirmHandler() {
    ...
    const isGlobalSettings =
      props.performanceSettings.clientResourcesManagementMode === "h";
    if (isGlobalSettings) {
      props.onIncrementVersion(
        props.performanceSettings.currentHostVersion,
        isGlobalSettings,
      );
    } else {
      props.onIncrementVersion(
        props.performanceSettings.currentPortalVersion,
        isGlobalSettings,
      );
    }
  }
  ...
  render() {
    ...
    return (
      <div className="dnn-servers-info-panel-big performanceSettingTab">
        ...
        <WarningBlock
          label={localization.get("PerformanceTab_MinifactionWarning")}
        />
        <GridSystem>
          <div className="leftPane">
            <InputGroup>
          ...
          <div className="rightPane borderSeparation">
            <RadioButtonBlock
              ...
              tooltip={localization.get(
                "PerformanceTab_ClientResourcesManagementMode.Help",
              )}
              onChange={this.onChangeField.bind(
                this,
            ...
            />
            <SwitchBlock
              label={localization.get("PerformanceTab_EnableCompositeFiles")}
              onText={localization.get("SwitchOn")}
              offText={localization.get("SwitchOff")}
              tooltip={localization.get(
                "PerformanceTab_EnableCompositeFiles.Help",
              )}
            ...
            />
            <SwitchBlock
              label={localization.get("PerformanceTab_MinifyCss")}
              onText={localization.get("SwitchOn")}
              offText={localization.get("SwitchOff")}
            ...
            />
            <SwitchBlock
              label={localization.get("PerformanceTab_MinifyJs")}
              onText={localization.get("SwitchOn")}
              offText={localization.get("SwitchOff")}
