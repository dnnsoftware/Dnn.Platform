...
export default function createPackage(
  ...
  switch (action.type) {
    ...
    case ActionTypes.CREATED_PACKAGE_MANIFEST:
      return { ...state, createdManifest: action.payload };
    case ActionTypes.CREATED_PACKAGE:
      return { ...state, createdPackage: action.payload.Logs };
    case ActionTypes.GO_TO_STEP:
      return { ...state, currentStep: action.payload };
    case ActionTypes.UPDATED_PACKAGE_MANIFEST:
      return { ...state, packageManifest: action.payload };
    case ActionTypes.UPDATED_PACKAGE_PAYLOAD:
      return { ...state, packagePayload: action.payload };
    case ActionTypes.RETRIEVED_GENERATED_MANIFEST:
      return {
        ...state,
        packagePayload: Object.assign(
          JSON.parse(JSON.stringify(state.packagePayload)),
    ...
    case ActionTypes.REFRESH_PACKAGE_FILES:
      return {
        ...state,
        packageManifest: Object.assign(
          JSON.parse(JSON.stringify(state.packageManifest)),
