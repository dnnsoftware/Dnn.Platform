import {
  installation as ActionTypes,
  extension as ExtensionActionTypes,
...
export default function installation(
  ...
  switch (action.type) {
    case ActionTypes.PARSED_INSTALLATION_PACKAGE:
      return { ...state, parsedInstallationPackage: action.payload };
    case ActionTypes.CLEAR_PARSED_INSTALLATION_PACKAGE:
      return { ...state, parsedInstallationPackage: null };
    case ActionTypes.GO_TO_WIZARD_STEP:
      return { ...state, installWizardStep: action.payload.wizardStep };
    case ActionTypes.INSTALLED_EXTENSION_LOGS:
      return { ...state, installationLogs: action.payload.logs };
    ...
    case ActionTypes.SET_FAILED_INSTALLATION_LOGS:
      return {
        ...state,
        installationLogs: [
          "Oops, something went wrong and the installation failed. Please try the installation again.",
        ],
      };
    case ActionTypes.TOGGLE_ACCEPT_LICENSE:
      return { ...state, licenseAccepted: action.payload };
    case ActionTypes.TOGGLE_VIEWING_LOG:
      return { ...state, viewingLog: action.payload };
    case ActionTypes.SET_IS_PORTAL_PACKAGE:
      return { ...state, isPortalPackage: action.payload };
    default:
      return state;
  }
}
