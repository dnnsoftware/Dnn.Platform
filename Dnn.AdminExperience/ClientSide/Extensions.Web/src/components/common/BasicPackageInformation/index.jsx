...
const BasicPackageInformation = ({
  ...
  <GridSystem
    className={styles.basicPackageInformation + " with-right-border top-half"}
  >
    <div>
      <DropdownWithError
        ...
        options={
          installedPackageTypes &&
          installedPackageTypes.map((_package) => {
            return {
              label: _package.Type.split("_")
                .join("")
                .split(/(?=[A-Z])/)
                .join(" "),
              value: _package.Type,
        ...
        value={
          !validationMapped
            ? extensionData.packageType
            : extensionData.packageType.value
        }
        style={inputStyle}
      />
      <SingleLineInputWithError
        ...
        value={
          !validationMapped ? extensionData.name : extensionData.name.value
        }
      />
      <SingleLineInputWithError
        label={
        ...
        value={
          !validationMapped
            ? extensionData.friendlyName
            : extensionData.friendlyName.value
        }
        style={inputStyle}
      ...
      <MultiLineInputWithError
        ...
        value={
          !validationMapped
            ...
            : extensionData.description.value
        }
        enabled={!disabled}
