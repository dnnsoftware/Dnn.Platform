      ...
      <div>
        ...
        >
          <GridCell columnSize={ColumnSizes[0]} style={{ padding: 0 }}>
            <img
              src={
                props._package.packageIcon &&
                props._package.packageIcon.replace("~", "")
              }
          ...
          <GridCell columnSize={ColumnSizes[1]} style={{ padding: "0 35px" }}>
            ...
            <p>
              <Html html={props._package.description} />
            </p>
          </GridCell>
          ...
          <GridCell columnSize={ColumnSizes[3]}>
            {this.getInUseDisplay(
              props._package.friendlyName,
              props._package.packageId,
            )}
          </GridCell>
          ...
          <GridCell columnSize={ColumnSizes[5]} style={{ paddingRight: 0 }}>
            {props._package.canDelete && props.isHost && (
              <div className="extension-action" onClick={props.onDelete}>
                <SvgIcons.TrashIcon />
              </div>
            )}
            <div
