...
const ExtensionDetailRow = ({
  ...
  >
    ...
    <GridCell columnSize={ColumnSizes[1]} style={{ padding: "0 35px" }}>
      ...
      <p>
        <Html html={_package.description} />
      </p>
    </GridCell>
    ...
    <GridCell columnSize={ColumnSizes[3]} style={{ paddingRight: 0 }}>
      {_package.fileName && (
        <form
          action={util.siteRoot + "API/PersonaBar/Extensions/DownloadPackage"}
          method="GET"
          target="_blank"
        >
      ...
      {!_package.fileName && (
        <form
          action={
            util.siteRoot + "API/PersonaBar/Extensions/DownloadLanguagePackage"
          }
          method="GET"
          target="_blank"
        >
      ...
      {!_package.fileName && (
        <Button
          ...
          onClick={onDeploy.bind(this, _package)}
        >
          <TextOverflowWrapper
      ...
      {_package.fileName && (
        <Button
          className="install-download-button"
          disabled={doingOperation}
          onClick={onInstall.bind(this, _package.fileName)}
        >
          <TextOverflowWrapper
