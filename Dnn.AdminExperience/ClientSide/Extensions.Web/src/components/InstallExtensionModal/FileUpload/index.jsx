    ...
    if (error && error.logs && !error.noManifest) {
      ...
      const errorText =
        typeof error === "string"
          ? error
          : errorCount > 0
            ? Localization.get("InstallExtension_UploadFailed") +
              errorCount +
              " " +
              Localization.get("Errors")
            : Localization.get("InstallExtension_UploadFailedUnknown");

      this.setState(
        { uploading: true, errorText, errorInPackage: true, noManifest: false },
        () => {},
      );
    } else {
      const errorText = Localization.get(
        "InstallExtension_UploadFailedUnknown",
      );
      this.setState({
        uploading: true,
        errorText,
    ...
    return (
      <div
        className={
          ...
          (this.props.alreadyInstalled ? " already-installed" : "") +
          (this.props.viewingLog ? " viewing-log" : "")
        }
      >
        {(!this.state.uploading || this.state.uploadComplete) &&
                ...
                <div className="buttons" style={buttonsStyle}>
                  <div
                    ...
                    onMouseEnter={this.onMouseEnter.bind(
                      this,
                      Localization.get("InstallExtension_UploadAFile"),
                    )}
        ...
        {this.props.viewingLog && (
          <LogDisplay
            logs={
              ...
              this.props.parsedInstallationPackage.logs
            }
          />
        )}
        {this.state.uploading && !this.props.viewingLog && (
          <UploadBar
            ...
            uploadCompleteText={Localization.get(
              "InstallExtension_UploadComplete",
            )}
        ...
        {this.state.noManifest && (
          <div
            ...
            style={{ width: "calc(100% + 26px)", height: "calc(100% + 26px)" }}
          >
