...
class FolderDropdown extends Component {
  ...
  onAddNewFolder() {
    ...
    props.onAddNewFolder(
      ...
      props.type,
      this.closeAddNewFolderBox.bind(this),
    );
  }
    ...
    return (
      <GridCell className={styles.folderDropdown} style={{ padding: 0 }}>
        <Collapsible
          ...
          theme={{
            collapse: "add-new-folder-box ReactCollapse--collapse",
            content: "ReactCollapse--content",
          }}
        >
          <GridCell style={{ padding: "20px 10px" }}>
            <GridCell>
              <h3 className="new-folder-title">
            ...
            <GridCell className="new-folder-buttons">
              ...
              <Button type="primary" onClick={this.onAddNewFolder.bind(this)}>
        ...
        <DropdownWithError
          ...
          label={props.label}
          className={
            "folder-dropdown" + (state.addNewFolderOpen ? " hidden" : "")
          }
