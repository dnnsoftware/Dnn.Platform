...
class FromControl extends Component {
  ...
  render() {
    ...
    return (
      <GridCell
        className={styles.fromControl + " extension-form"}
        style={{ padding: 0 }}
      >
        <GridSystem className="with-right-border top-half">
          <div style={{ paddingRight: 15 }}>
            <FolderDropdown
              ...
              tooltipMessage={Localization.get(
                "NewModule_OwnerFolder.HelpText",
              )}
            ...
            <FolderDropdown
              ...
              type="moduleFolder"
              tooltipMessage={Localization.get(
                "NewModule_ModuleFolder.HelpText",
              )}
          ...
          <div style={{ paddingLeft: 15 }}>
            ...
            <MultiLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "NewModule_Description.HelpText",
              )}
              style={inputStyle}
            ...
            <Switch
              ...
              tooltipMessage={Localization.get(
                "NewModule_AddTestPage.HelpText",
              )}
        ...
        <GridCell columnSize={100} className="modal-footer">
          ...
          <Button type="primary" onClick={this.onCreateNewModule.bind(this)}>
