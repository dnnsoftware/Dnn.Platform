...
class SkinObject extends Component {
  render() {
    ...
    return (
      <GridCell
        className={
          styles.editSkinObj + (props.className ? " " + props.className : "")
        }
      >
        <GridSystem className="with-right-border top-half">
          <div>
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditSkinObject_ControlKey.HelpText",
              )}
              style={inputStyle}
          ...
          <div>
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditSkinObject_ControlSrc.HelpText",
              )}
              style={inputStyle}
              enabled={!props.disabled}
            />
            <Switch
              label={Localization.get(
                "EditSkinObject_SupportsPartialRender.Label",
              )}
              ...
              tooltipMessage={Localization.get(
                "EditSkinObject_SupportsPartialRender.HelpText",
              )}
