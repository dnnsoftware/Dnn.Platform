...
class JavascriptLibrary extends Component {
  getNameVersionRows(list) {
    return list.map((item, i) => {
      return (
        <GridCell key={i} className="js-library-info-row">
  ...
  getNameVersionTable(list, label, labelTooltip) {
    return [
      <Label label={label} tooltipMessage={labelTooltip} key="first" />,
  ...
  render() {
    ...
    return (
      <GridCell
        className={
          styles.editJSLibrary + (props.className ? " " + props.className : "")
        }
      >
        <GridSystem className="with-right-border top-half">
          <div>
            <SingleLineInputWithError
              label={Localization.get(
                "EditJavascriptLibrary_LibraryName.Label",
              )}
              value={extensionBeingEdited.name.value}
              tooltipMessage={Localization.get(
                "EditJavascriptLibrary_LibraryName.HelpText",
              )}
              style={inputStyle}
              enabled={false}
            />
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditJavascriptLibrary_FileName.HelpText",
              )}
              style={inputStyle}
              enabled={false}
            />
            <SingleLineInputWithError
              label={Localization.get(
                "EditJavascriptLibrary_PreferredLocation.Label",
              )}
              value={extensionBeingEdited.location.value}
              tooltipMessage={Localization.get(
                "EditJavascriptLibrary_PreferredLocation.HelpText",
              )}
              style={inputStyle}
              enabled={false}
            />
          ...
          <div>
            <SingleLineInputWithError
              label={Localization.get(
                "EditJavascriptLibrary_LibraryVersion.Label",
              )}
              value={extensionBeingEdited.version.value}
              tooltipMessage={Localization.get(
                "EditJavascriptLibrary_LibraryVersion.HelpText",
              )}
              style={inputStyle}
              enabled={false}
            />
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditJavascriptLibrary_ObjectName.Label",
              )}
              style={inputStyle}
              enabled={false}
            />
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditJavascriptLibrary_DefaultCDN.HelpText",
              )}
              style={inputStyle}
              enabled={false}
            />
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditJavascriptLibrary_CustomCDN.HelpText",
              )}
        ...
        <GridSystem className="with-right-border top-half">
          <div>
            {this.getNameVersionTable(
              extensionBeingEdited.dependencies.value,
              Localization.get("EditJavascriptLibrary_DependsOn.Label"),
              Localization.get("EditJavascriptLibrary_DependsOn.HelpText"),
            )}
          </div>
          <div>
            {this.getNameVersionTable(
              extensionBeingEdited.usedBy.value,
              Localization.get("EditJavascriptLibrary_UsedBy.Label"),
              Localization.get("EditJavascriptLibrary_UsedBy.HelpText"),
            )}
          </div>
        </GridSystem>
