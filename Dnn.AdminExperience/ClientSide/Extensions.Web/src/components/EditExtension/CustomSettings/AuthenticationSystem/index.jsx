...
class AuthenticationSystem extends Component {
  render() {
    ...
    return (
      <GridCell
        className={
          styles.editAuthenticationSystem +
        ...
        <GridSystem className="with-right-border top-half">
          <div>
            ...
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditAuthSystem_LoginCtrlSource.Tooltip",
              )}
              style={inputStyle}
            />
          </div>
          <div>
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditAuthSystem_LogoffCtrlSource.Tooltip",
              )}
              style={inputStyle}
            />
            <SingleLineInputWithError
              label={Localization.get(
                "EditAuthSystem_SettingsCtrlSource.Label",
              )}
              value={extensionBeingEdited.settingsControlSource.value}
              onChange={props.onChange.bind(this, "settingsControlSource")}
              tooltipMessage={Localization.get(
                "EditAuthSystem_SettingsCtrlSource.Tooltip",
              )}
              style={inputStyle}
