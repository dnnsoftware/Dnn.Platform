...
class Module extends Component {
  onClickOnPortal(index, type) {
    const { props } = this;
    let _extensionBeingEdited = JSON.parse(
      JSON.stringify(props.extensionBeingEdited),
    );
    _extensionBeingEdited[type].value[index].selected =
      !_extensionBeingEdited[type].value[index].selected;
  ...
  moveItemsLeft() {
    const { props } = this;
    let assignedPortals = JSON.parse(
      JSON.stringify(props.extensionBeingEdited.assignedPortals.value),
    );
    let unassignedPortals = JSON.parse(
      JSON.stringify(props.extensionBeingEdited.unassignedPortals.value),
    );
    let itemsToStay = [],
      itemsToMove = [];
    let selectedCount = 0;
    ...
    if (selectedCount > 0) {
      props.onAssignedPortalsChange(
        "unassignedPortals",
        unassignedPortals.concat(itemsToMove),
        () => {
  ...
  moveItemsRight() {
    ...
    if (selectedCount > 0) {
      props.onAssignedPortalsChange(
        "assignedPortals",
        assignedPortals.concat(itemsToMove),
        () => {
  ...
  moveAll(direction) {
    ...
    switch (direction) {
      case "right":
        props.onAssignedPortalsChange(
          "assignedPortals",
          assignedPortals.concat(unassignedPortals),
          () => {
      ...
      default:
        props.onAssignedPortalsChange(
          "unassignedPortals",
          unassignedPortals.concat(assignedPortals),
          () => {
  ...
  render() {
    ...
    return (
      <GridCell
        className={
          styles.editModule + (props.className ? " " + props.className : "")
        }
      >
        <GridSystem className="with-right-border top-half">
          <div>
            {!props.isAddMode && (
              <SingleLineInputWithError
                ...
                tooltipMessage={Localization.get(
                  "EditModule_ModuleName.HelpText",
                )}
                style={inputStyle}
            ...
            <DropdownWithError
              ...
              tooltipMessage={Localization.get(
                "EditModule_ModuleCategory.HelpText",
              )}
            ...
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditModule_Dependencies.HelpText",
              )}
            ...
            {props.isAddMode && (
              <DropdownWithError
                ...
                tooltipMessage={Localization.get(
                  "EditModule_ModuleSharing.HelpText",
                )}
                options={[
                  {
                    label: Localization.get(
                      "EditModule_ModuleSharingUnknown.Label",
                    ),
                    value: 0,
                  },
                  {
                    label: Localization.get(
                      "EditModule_ModuleSharingUnsupported.Label",
                    ),
                    value: 1,
                  },
                  {
                    label: Localization.get(
                      "EditModule_ModuleSharingSupported.Label",
                    ),
                    value: 2,
                  },
                ]}
            ...
            <Switch
              ...
              tooltipMessage={Localization.get(
                "EditModule_IsPortable.HelpText",
              )}
            />
            <Switch
              ...
              offText={Localization.get("SwitchOff")}
              tooltipMessage={Localization.get(
                "EditModule_IsUpgradable.HelpText",
              )}
            />
          </div>
          <div>
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditModule_FolderName.HelpText",
              )}
            ...
            <SingleLineInputWithError
              label={Localization.get(
                "EditModule_BusinessControllerClass.Label",
              )}
              tooltipMessage={Localization.get(
                "EditModule_BusinessControllerClass.HelpText",
              )}
            ...
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "EditModule_Permissions.HelpText",
              )}
              style={inputStyle}
            />
            <Switch
              ...
              offText={Localization.get("SwitchOff")}
              tooltipMessage={Localization.get(
                "EditModule_IsSearchable.HelpText",
              )}
            />
            {props.isAddMode && (
              <Switch
                ...
                tooltipMessage={Localization.get(
                  "EditModule_IsPremiumModule.HelpText",
                )}
              />
            )}
            {!props.isAddMode && (
