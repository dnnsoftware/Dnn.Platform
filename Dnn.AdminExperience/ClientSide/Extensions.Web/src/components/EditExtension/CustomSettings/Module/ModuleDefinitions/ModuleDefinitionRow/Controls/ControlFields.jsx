      ...
      <GridCell className="edit-module-control-box">
          ...
          <div>
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "AddModuleControl_Title.HelpText",
              )}
              style={inputStyle}
        ...
        <GridCell>
          <DropdownWithError
            ...
            tooltipMessage={Localization.get(
              "AddModuleControl_SourceFolder.HelpText",
            )}
            style={inputStyle}
          ...
          <DropdownWithError
            ...
            tooltipMessage={Localization.get(
              "AddModuleControl_Source.HelpText",
            )}
            style={inputStyle}
        ...
        <GridSystem>
          <div>
            <DropdownWithError
              ...
              tooltipMessage={Localization.get(
                "AddModuleControl_Type.HelpText",
              )}
              style={inputStyle}
              options={[
                {
            ...
            <DropdownWithError
              ...
              tooltipMessage={Localization.get(
                "AddModuleControl_Icon.HelpText",
              )}
              style={inputStyle}
            ...
            <Switch
              ...
              tooltipMessage={Localization.get(
                "AddModuleControl_SupportsPopups.HelpText",
              )}
          ...
          <div>
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "AddModuleControl_ViewOrder.HelpText",
              )}
              style={inputStyle}
            ...
            <SingleLineInputWithError
              ...
              tooltipMessage={Localization.get(
                "AddModuleControl_HelpURL.HelpText",
              )}
              style={inputStyle}
            ...
            <Switch
              label={Localization.get(
                "AddModuleControl_SupportsPartialRendering.Label",
              )}
              onText={Localization.get("SwitchOn")}
              offText={Localization.get("SwitchOff")}
              tooltipMessage={Localization.get(
                "AddModuleControl_SupportsPartialRendering.HelpText",
              )}
