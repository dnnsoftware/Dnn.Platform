    ...
    return (
      <GridSystem>
        <div>
          <SingleLineInputWithError
            label={
              Localization.get("ModuleDefinitions_DefinitionName.Label") + "*"
            }
            tooltipMessage={Localization.get(
              "ModuleDefinitions_DefinitionName.HelpText",
            )}
          ...
          <SingleLineInputWithError
            ...
            tooltipMessage={Localization.get(
              "ModuleDefinitions_DefaultCacheTime.HelpText",
            )}
        ...
        <div>
          <SingleLineInputWithError
            label={
              Localization.get("ModuleDefinitions_FriendlyName.Label") + "*"
            }
            tooltipMessage={Localization.get(
              "ModuleDefinitions_FriendlyName.HelpText",
            )}
