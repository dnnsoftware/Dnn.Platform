        ...
        <GridCell className="auth-system-site-settings">
          <SingleLineInputWithError
            ...
            tooltipMessage={Localization.get(
              "AuthSystemSiteSettings_AppId.HelpText",
            )}
            style={inputStyle}
          />
          ...
          <SingleLineInputWithError
            ...
            tooltipMessage={Localization.get(
              "AuthSystemSiteSettings_AppSecret.HelpText",
            )}
            style={inputStyle}
          />
          <GridCell columnSize={50} style={{ padding: 0 }}>
            <Switch
              label={Localization.get(
                "AuthSystemSiteSettings_AppEnabled.Label",
              )}
              ...
              tooltipMessage={Localization.get(
                "AuthSystemSiteSettings_AppEnabled.HelpText",
              )}
            />
          </GridCell>
        </GridCell>
