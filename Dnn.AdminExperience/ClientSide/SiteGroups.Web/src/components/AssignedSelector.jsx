...
class AssignedSelector extends React.Component {
  ...
  render() {
    ...
    let leftSelected =
      this.props.unassignedPortals.find((p) => p.selected) !== null;
    let rightSelected =
      this.props.assignedPortals.find((p) => p.selected) !== null;
    return (
      <GridCell className={styles.assignedSelector}>
        ...
        <GridCell columnSize={10} className="selector-controls">
          <div
            href=""
            className={
              "move-item single-right" + (leftSelected ? " enabled" : "")
            }
          ...
          <div
            href=""
            className={
              "move-item single-left" + (rightSelected ? " enabled" : "")
            }
          ...
          <div
            href=""
            className={
              "move-item double-right" +
              (unassignedPortals.length > 0 ? " enabled" : "")
            }
          ...
          <div
            href=""
            className={
              "move-item double-left" +
              (assignedPortals.length > 0 ? " enabled" : "")
            }
