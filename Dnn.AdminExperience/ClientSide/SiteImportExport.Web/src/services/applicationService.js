...
class ApplicationService {
  ...
  getInitialPortalTabs(parameters, callback, errorCallback) {
    ...
    sf.get(
      "GetPortalTabs?" + serializeQueryStringParameters(parameters),
      {},
      callback,
      errorCallback,
    );
  ...
  getDescendantPortalTabs(parameters, parentIdObj, callback, errorCallback) {
    ...
    sf.get(
      `GetTabsDescendants?${serializedParams}`,
      {},
      callback,
      errorCallback,
    );
  ...
  getAllJobs(parameters, callback, errorCallback) {
    ...
    sf.getsilence(
      "AllJobs?" + serializeQueryStringParameters(parameters),
      {},
      callback,
      errorCallback,
    );
  ...
  getLastJobTime(parameters, callback, errorCallback) {
    const sf = this.getServiceFramework("SiteExportImport", "ExportImport");
    sf.get(
      "LastJobTime?" + serializeQueryStringParameters(parameters),
      {},
      callback,
      errorCallback,
    );
  ...
  getImportPackages(parameters, callback, errorCallback) {
    const sf = this.getServiceFramework("SiteExportImport", "ExportImport");
    sf.get(
      "GetImportPackages?" + serializeQueryStringParameters(parameters),
      {},
      callback,
      errorCallback,
    );
  ...
  verifyImportPackage(packageId, callback, errorCallback) {
    const sf = this.getServiceFramework("SiteExportImport", "ExportImport");
    sf.get(
      "VerifyImportPackage?packageId=" + packageId,
      {},
      callback,
      errorCallback,
    );
