...
const jobsActions = {
  getInitialPortalTabs(PortalTabsParameters, callback) {
    ApplicationService.getInitialPortalTabs(
  ...
  getDescendantPortalTabs(PortalTabsParameters, ParentTabId, callback) {
    ...
    ApplicationService.getDescendantPortalTabs(
      PortalTabsParameters,
      ParentTabIdObj,
      (response) => {
        if (callback) {
  ...
  getLastExportTime(parameters, callback, errorCallback) {
    return (dispatch) => {
      ApplicationService.getLastJobTime(
        parameters,
        (data) => {
          dispatch({
  ...
  getJobDetails(jobId, callback, errorCallback) {
    return (dispatch) => {
      ApplicationService.getJobDetails(
        jobId,
        (data) => {
          dispatch({
  ...
  getImportPackages(parameters, callback, errorCallback) {
    return (dispatch) => {
      ApplicationService.getImportPackages(
        parameters,
        (data) => {
          dispatch({
  ...
  verifyImportPackage(packageId, callback, errorCallback) {
    return (dispatch) => {
      setTimeout(() => {
        ApplicationService.verifyImportPackage(
          packageId,
          (data) => {
            dispatch({
