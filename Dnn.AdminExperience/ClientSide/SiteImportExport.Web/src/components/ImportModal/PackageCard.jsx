      ...
      <div className={props.className || "package-card"}>
        <div className="card-grid">
          ...
          <GridCell columnSize={17} className="card-column2">
            ...
            <div className="package-field">
              <Label labelType="inline" label={Localization.get("Website")} />
            </div>
          </GridCell>
          ...
          <GridCell columnSize={12} className="card-column4">
            <div className="package-field">
              <Label labelType="inline" label={Localization.get("Mode")} />
            </div>
            <div className="package-field">
              <Label labelType="inline" label={Localization.get("FileSize")} />
            </div>
          </GridCell>
          <GridCell columnSize={13} className="card-column5">
            <div className="package-field">
              <TextOverflowWrapper
                text={
                  props.selectedPackage.Summary.ExportMode
            ...
            <div className="package-field">
              <TextOverflowWrapper
                text={
                  ((props.selectedPackage.Summary || {}).ExportFileInfo || {})
                    .ExportSize
                }
                maxWidth={70}
              />
