...
class ImportSummary extends Component {
  getSummaryItem(category) {
    const { props } = this;
    let detail = props.importSummary.SummaryItems.find(
      ...
      <div style={{ float: "left", width: "100%" }}>
        {props.importSummary && props.selectedPackage && (
          <div className="import-summary">
            ...
            <GridCell className="import-site-container">
              <div className="left-column">
                ...
                <GridCell>
                  ...
                  />
                  <div className="import-summary-item">
                    {props.importSummary.IncludeContent
                ...
                <GridCell>
                  ...
                  />
                  <div className="import-summary-item">
                    {props.importSummary.IncludeProfileProperties
                      ? Localization.get("Yes")
                      : Localization.get("No")}
                  </div>
                </GridCell>
                <GridCell>
                  ...
                  />
                  <div className="import-summary-item">
                    {props.importSummary.IncludePermissions
                      ? Localization.get("Yes")
                      : Localization.get("No")}
                  </div>
                </GridCell>
                <GridCell>
                  ...
                  />
                  <div className="import-summary-item">
                    {props.importSummary.IncludeExtensions
                      ? Localization.get("Yes")
                      : Localization.get("No")}
                  </div>
                </GridCell>
                <GridCell>
                  ...
                  />
                  <div className="import-summary-item">
                    {props.importSummary.IncludeDeletions
                      ? Localization.get("Yes")
                      : Localization.get("No")}
                  </div>
                </GridCell>
              ...
              <div className="right-column">
                ...
                <GridCell>
                  ...
                  />
                  <div className="import-summary-item">
                    {props.importSummary.ExportMode === 1
            ...
            <div className="finish-importing">
              {Localization.get("FinishImporting")}
            </div>
          </div>
        )}
      </div>
