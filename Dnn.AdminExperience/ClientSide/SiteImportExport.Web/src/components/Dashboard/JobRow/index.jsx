...
class JobRow extends Component {
  ...
  componentDidMount() {
    let opened =
      this.props.openId !== "" && this.props.jobId === this.props.openId;
    this.setState({
      opened,
    });
  }
  ...
  getTypeIndicator() {
    ...
    return props.jobType.indexOf("Import") >= 0 ? (
      <div className="jobIndicator-import"></div>
    ) : (
      <div className="jobIndicator-export"></div>
    );
  }
      ...
      >
        <div className={"collapsible-jobdetail-header " + state.collapsed}>
          <div className="term-header">
            ...
            >
              <div className="jobIndicator">{this.getTypeIndicator()}</div>
            </div>
            <div
            ...
            >
              <div className="term-label-wrapper">
                <span
                  className={
                    "job-status" + (props.jobCancelled ? 4 : props.jobStatus)
                  }
                >
                  <TextOverflowWrapper
                    text={Localization.get(
                      "JobStatus" + (props.jobCancelled ? 4 : props.jobStatus),
                    )}
                    maxWidth={80}
                  />
        ...
        <Collapsible
          autoScroll={true}
          isOpened={opened}
          className="collapsible-jobdetail-body"
        >
