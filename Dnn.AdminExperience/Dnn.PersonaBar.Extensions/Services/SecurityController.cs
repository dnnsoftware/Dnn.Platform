...
/// <summary>
/// Provides REST APIs to manage security settings.
/// </summary>
...
public class SecurityController : PersonaBarApiController
{
    ...
    public SecurityController()
        : this(new Components.SecurityController())
    {
    }
    ...
    public HttpResponseMessage GetBasicLoginSettings(string cultureCode)
    {
        try
        {
            ...
            settings.userRequestIPHeader = HostController.Instance.GetString(UserRequestIPHeaderSettingName, string.Empty);
    ...
    public HttpResponseMessage UpdateBasicLoginSettings(UpdateBasicLoginSettingsRequest request)
    {
        ...
        try
        {
            ...
            var originalUserRequestIPHeader = HostController.Instance.GetString(UserRequestIPHeaderSettingName, string.Empty);
            if (request.UserRequestIPHeader != originalUserRequestIPHeader)
            {
                HostController.Instance.Update(UserRequestIPHeaderSettingName, request.UserRequestIPHeader, true);
            }
            ...
            var response = new
            {
                ...
                Results = new
                {
                    Settings = new
                    {
                        ...
                        Host.AllowOverrideThemeViaQueryString,
                        Host.AllowRichTextModuleTitle,
    ...
    public HttpResponseMessage UpdateOtherSettings(UpdateOtherSettingsRequest request)
    {
        try
        {
            ...
            HostController.Instance.Update("AllowOverrideThemeViaQueryString", request.AllowOverrideThemeViaQueryString ? "Y" : "N", false);
            HostController.Instance.Update("AllowRichTextModuleTitle", request.AllowRichTextModuleTitle ? "Y" : "N", false);
    ...
    /// <summary>Adds a portal alias.</summary>
