...
define([
  ...
  var init, load, initRecycleBin, viewRecycleBin;
  ...
  init = function (wrapper, util, params, callback) {
    ...
    dnnPageRecycleBin = new DnnPageRecycleBin(
      utility.resx.Recyclebin,
      utility.sf,
      utility,
      null,
      params.settings,
  ...
  viewRecycleBin = function () {
    if (
      typeof dnn.dnnPageHierarchy != "undefined" &&
      dnn.dnnPageHierarchy.hasPendingChanges()
    ) {
