...
define([
  ...
  var saveStyleSheet = function () {
    requestService(
      ...
      "UpdateStyleSheet",
      "",
      { portalId: curPortalId, styleSheetContent: cssContent.getValue() },
      function (data) {
  ...
  var restoreStyleSheet = function () {
    utility.confirm(
      utility.resx.CssEditor.ConfirmRestore,
      utility.resx.CssEditor.RestoreButton,
      utility.resx.CssEditor.CancelButton,
      function () {
        requestService(
          "post",
          "RestoreStyleSheet",
  ...
  var initCssEditor = function () {
    ...
    monacoEditorLoaderScript.src =
      "/Resources/Shared/components/MonacoEditor/loader.js";
    document.body.appendChild(monacoEditorLoaderScript);

    require.config({
      paths: { vs: "/Resources/Shared/components/MonacoEditor" },
    });
  ...
  var initMonacoEditor = function () {
    ...
    var monacoEditor = cssEditor.create(
