    ...
    init: function (config) {
        ...
        if (!initializedModules[template]) {
          ...
          window.require(requiredArray, function (module, html) {
            ...
            if (module.type === "Class") {
              initializedModules[template] = new module(
                wrapper,
                self,
                params,
                cb,
      ...
      setDialogClass = function (dialog) {
        if (
          dialog
            .parent()
            .find(".socialpanel:visible .dnn-persona-bar-page")
            .hasClass("full-width")
        ) {
      ...
      return {
        ...
        getResx: function (moduleName, key) {
          if (
            this.resx[moduleName] &&
            this.resx[moduleName].hasOwnProperty(key)
          ) {
            return this.resx[moduleName][key];
          }

          if (
            this.resx["SharedResources"] &&
            this.resx["SharedResources"].hasOwnProperty(key)
          ) {
        ...
        confirm: function (
          ...
          $("#confirmation-dialog a#confirmbtn")
            .html(DOMPurify.sanitize(confirmBtn))
            .unbind("click")
            .bind("click", function () {
              if (typeof confirmHandler === "function") confirmHandler.apply();
              $("#confirmation-dialog").fadeOut(200, "linear", function () {
                $("#mask").hide();
              });
            });
          ...
          if (cancelBtn != "") {
            ...
            $("#confirmation-dialog a#cancelbtn")
              .html(DOMPurify.sanitize(cancelBtn))
              .unbind("click")
              .bind("click", function () {
          ...
          $(window)
            .off("keydown.confirmDialog")
            .on("keydown.confirmDialog", function (evt) {
              if (evt.keyCode === 27) {
        ...
        notify: function (text, options) {
          ...
          var notificationMessageContainer = $(
          ...
          var timeout =
            typeof options === "number" ? options : options.timeout || 2000;
          var size = options.size || "";
          var clickToClose = options.clickToClose || false;
          var closeButtonText =
            options.closeButtonText ||
            (self.resx && self.resx.PersonaBar.btn_CloseDialog) ||
            "OK";
        ...
        getObjectCopy: function (object) {
          if (typeof object === "object") {
            ...
            throw new Error(
              "The object " + object + " passed in is not an object.",
            );
          }
        },
         ...
         * @return {String} path
         */
        getPathByModuleName: function getPathByModuleName(
          menuStructure,
          moduleName,
        ) {
          var path = null;
