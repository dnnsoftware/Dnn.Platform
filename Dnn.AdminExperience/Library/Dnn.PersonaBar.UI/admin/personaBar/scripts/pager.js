  ...
  return {
    init: function (
      ...
      viewModel.totalPages = ko.computed(function () {
        if (
          typeof viewModel.totalResults === "function" &&
          viewModel.totalResults()
        )
      ...
      viewModel.pagerItemsDescription = ko.computed(function () {
        ...
        if (viewModel.pagerVisible())
          return pagerFormat
            ...
            .replace(
              "{2}",
              utility.formatCommaSeparate(viewModel.totalResults()),
            );
        return nopagerFormat.replace(
          "{0}",
          utility.formatCommaSeparate(viewModel.totalResults()),
        );
      });
      ...
      viewModel.pagerDescription = ko.computed(function () {
        ...
        if (viewModel.pagerVisible())
          return pagerFormat
            ...
            .replace(
              "{1}",
              utility.formatCommaSeparate(viewModel.totalPages()),
            );
        return "";
      });
