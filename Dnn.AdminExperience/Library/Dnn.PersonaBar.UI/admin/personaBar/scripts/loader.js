define(["jquery"], function ($) {
  ...
  function loading(options) {
    ...
    progressbar
      .removeClass()
      .css({ width: 0, height: 5 })
      .stop(true, false)
      .animate({ width: 0.75 * width }, 300, "linear", function () {
        var pingDuration = 0;
        function checkloaded() {
          if (loaded) {
            ...
            if (!error) {
              progressbar
                .stop(true, false)
                .animate({ width: "100%" }, 100, "linear", hideLoadingBar);
            } else {
              loadingBarMessage
                .show()
                .html(
              ...
              progressbar
                .stop(true, false)
                .addClass("load-error")
                .animate({ width: "100%" }, 100, "linear")
                .animate({ height: 25 }, 100, "linear", function () {
