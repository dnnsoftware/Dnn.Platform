...
define(["jquery"], function ($) {
  return {
    init: function (cfg, sf) {
      ...
      var settings = null;
      var serviceFramework = sf.init(
        cfg.siteRoot,
        cfg.tabId,
        cfg.antiForgeryToken,
      );
        ...
        save: function (s, success, error) {
          ...
          serviceFramework.postsilence(
            ...
            function () {
              ...
              if (inIframe) {
                if (
                  window.parent["personaBarSettings"]["personaBarUserSettings"]
                ) {
                  $.extend(
                    window.parent["personaBarSettings"][
                      "personaBarUserSettings"
                    ],
                    settings,
                  );
                }
                ...
                if (window["personaBarSettings"]["personaBarUserSettings"]) {
                  $.extend(
                    window["personaBarSettings"]["personaBarUserSettings"],
                    settings,
                  );
                }
              }
