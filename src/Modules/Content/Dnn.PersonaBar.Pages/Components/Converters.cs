    ...
    public static class Converters
    {
        public static T ConvertToPageItem<T>(TabInfo tab, IEnumerable<TabInfo> portalTabs) where T : PageItem, new()
        {
            return new T
            {
                ...
                CanAddPage = TabPermissionController.CanAddPage(),
                CanAdminPage = TabPermissionController.CanAdminPage(),
                CanCopyPage = TabPermissionController.CanCopyPage(),
                CanDeletePage = TabPermissionController.CanDeletePage(),
                CanAddContentToPage = TabPermissionController.CanAddContentToPage(),
                CanNavigateToPage = TabPermissionController.CanNavigateToPage(),
