...
import {visiblePanel as VisiblePanelActions, extension as ExtensionActions } from "actions";
        ...
        return (
            <div className="extensions-app personaBar-mainContainer">
                ...
                <PersonaBarPage isOpen={props.selectedPage === 1}>
                    <NewModuleModal onCancel={this.selectPanel.bind(this, 0) }/>
                </PersonaBarPage>
                <PersonaBarPage isOpen={props.selectedPage === 2}>
                    <NewExtensionModal onCancel={this.selectPanel.bind(this, 0) }/>
                </PersonaBarPage>
                <PersonaBarPage isOpen={props.selectedPage === 3}>
                    <InstallExtensionModal onCancel={this.selectPanel.bind(this, 0) }/>
                </PersonaBarPage>
