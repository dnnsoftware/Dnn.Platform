...
namespace Dnn.PersonaBar.SiteSettings.Services
{
    ...
    public class SiteSettingsController : PersonaBarApiController
    {
        ...
        [HttpGet]
        [AdvancedPermission(MenuName = Components.Constants.Constants.MenuName, Permission = Components.Constants.Constants.SiteInfoView, ForceAdminPermission = true)]
        ...
        [AdvancedPermission(MenuName = Components.Constants.Constants.MenuName, Permission = Components.Constants.Constants.SiteInfoView + "&" + Components.Constants.Constants.SiteInfoEdit, ForceAdminPermission = true)]
