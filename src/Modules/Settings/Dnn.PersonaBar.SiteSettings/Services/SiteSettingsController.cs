...
namespace Dnn.PersonaBar.SiteSettings.Services
{
    ...
    public class SiteSettingsController : PersonaBarApiController
    {
        ...
        [HttpGet]
        [AdvancedPermission(MenuName = Components.Constants.Constants.MenuName, Permission = Components.Constants.Constants.SiteInfoView, AllowAdmin = true)]
        ...
        [AdvancedPermission(MenuName = Components.Constants.Constants.MenuName, Permission = Components.Constants.Constants.SiteInfoView + "&" + Components.Constants.Constants.SiteInfoEdit, AllowAdmin = true)]
