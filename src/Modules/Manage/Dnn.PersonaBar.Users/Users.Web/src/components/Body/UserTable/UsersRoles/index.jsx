...
class UserRoles extends Component {
    ...
    getRoles() {
        ...
        props.dispatch(UserActions.getUserRoles(parameter));
    }

    getSuggestRoles() {
        const {props, state} = this;
        let keyword = state.roleSelectState.roleId >= 0 ? "" : state.roleSelectState.keyword;
        props.dispatch(UserActions.getSuggestRoles({ keyword: keyword, count: 10 }));
    }
    ...
    saveRole(roleId, startTime, expiresTime) {
        ...
        props.dispatch(UserActions.saveUserRole(parameter, this.state.sendEmail, this.state.isOwner));
                    ...
                    <GridCell columnSize={50}>
                        <span>
                            <Combobox suggest={false}
                                ...
                                open={this.props.matchedRoles.length > 0 }
