...
var DnnPrompt = function () {
    function DnnPrompt(vsn, util, params) {
    ...
    _createClass(DnnPrompt, [{
        ...
        value: function runCmd() {
            ...
            if (cmd === "CONFIG") {
                self.configConsole(tokens);return;
            }
            ...
            if (cmd === "SET-MODE") {
                self.changeUserMode(tokens);return;
            }
