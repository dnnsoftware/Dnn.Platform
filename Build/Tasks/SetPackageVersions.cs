...
namespace DotNetNuke.Build.Tasks
{
    ...
    public sealed class SetPackageVersions : FrostingTask<Context>
    {
        ...
        public override void Run(Context context)
        {
            ...
            packages.Add(context.GetFiles("./DNN Platform/Dnn.ClientSide/package.json"));
            packages.Add(context.GetFiles("./DNN Platform/Dnn.ClientSide/types/dnn/package.json"));
