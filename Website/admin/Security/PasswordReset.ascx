    ...
    <asp:Panel id="divPassword" runat="server" class="dnnPasswordResetContent" DefaultButton="cmdChangePassword">
        ...
        <div class="dnnFormItem">
            <asp:Panel ID="passwordContainer" runat="server" CssClass="password-strength-container">
                <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" size="12" MaxLength="50" AutoCompleteType="Disabled" CssClass="password-strength" />
            </asp:Panel>
        ...
        <div class="dnnFormItem">
            <asp:TextBox ID="txtConfirmPassword" runat="server" MaxLength="50" TextMode="Password" CssClass="password-confirm" />
