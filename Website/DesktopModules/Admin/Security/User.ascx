    ...
    <div id="Password" runat="server" >
        ...
        <div class="dnnFormItem">
            ...
            <asp:Panel ID="passwordContainer" runat="server">
    			<asp:textbox id="txtPassword" runat="server" TextMode="Password" size="12" maxlength="50" AutoCompleteType="Disabled" />
            </asp:Panel>
        </div>
        <div class="dnnFormItem">
            <dnn:label id="plConfirm" runat="server" controlname="txtConfirm" text="Confirm Password:" cssclass="dnnFormRequired"  ></dnn:label>
			<asp:textbox id="txtConfirm" runat="server" textmode="Password" size="12" maxlength="50" CssClass="password-confirm" />
