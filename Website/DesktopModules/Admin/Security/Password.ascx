    ...
    <fieldset>
		...
		<asp:panel id="pnlChange" runat="server">
            ...
            <div id="oldPasswordRow" runat="server" class="dnnFormItem">
                ...
                <asp:textbox id="txtOldPassword" runat="server" textmode="Password" size="25" maxlength="50" />
            </div>
            <div class="dnnFormItem">
                ...
                <asp:Panel ID="passwordContainer" runat="server" ViewStateMode="Disabled">
                    <asp:textbox id="txtNewPassword" runat="server" textmode="Password" size="25" maxlength="50" />
                </asp:Panel>
            </div>
            <div class="dnnFormItem">
                <dnn:label id="plNewConfirm" runat="server" controlname="txtNewConfirm" />
                <asp:textbox id="txtNewConfirm" runat="server" textmode="Password" size="25" maxlength="50" CssClass="password-confirm" />
            </div>
