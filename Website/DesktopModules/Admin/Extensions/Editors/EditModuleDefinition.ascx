<%@ Control Language="C#" AutoEventWireup="false" Inherits="DotNetNuke.Modules.Admin.ModuleDefinitions.CreateModuleDefinition" Codebehind="EditModuleDefinition.ascx.cs" %>
        ...
        <div class="dnnFormItem">
           ...
           <%-- <asp:DropDownList ID="cboCreate" runat="server" AutoPostBack="True">
            ...
            <dnn:DnnComboBox  ID="cboCreate" runat="server" AutoPostBack="True">
                <Items>
                    <asp:ListItem Value="New" Text="New" ResourceKey="New" />
                    <asp:ListItem Value="Control" Text="Control" ResourceKey="Control" />
                    <asp:ListItem Value="Manifest" Text="Manifest" ResourceKey="Manifest" />
                </Items>
            </dnn:DnnComboBox>
        </div>
